...
if [ -r "$CATALINA_BASE/lib/tomcat-juli-9.0.71.jar" ] ; then
  CLASSPATH=$CLASSPATH:$CATALINA_BASE/lib/tomcat-juli-9.0.71.jar
else
  CLASSPATH=$CLASSPATH:$CATALINA_HOME/lib/tomcat-juli-9.0.71.jar
fi

...
<link rel="stylesheet" type="text/css" href="./css/apps.min.css?_dc=202101051028" />
<% if (lang.equals("ko_KR")) {%>
<link rel="stylesheet" type="text/css" href="./fonts/hangul_nanum.css?_dc=202101051028" />
<% } %>
<%
if (theme != null && theme.length() > 0)
{
	out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"./css/" + theme.toLowerCase() + ".css?_dc=202101051028\" />");
}
%>
<link rel="stylesheet" type="text/css" href="./css/custom.css?_dc=202101051028" />

<script type="text/javascript" src="./js/jquery-3.5.1.min.js"></script>    
<script type="text/javascript" src="../config.js?_dc=202101051028"></script>
<script type="text/javascript" src="../bootconfig<%=(is_debug ? "_debug" : "")%>.js?_dc=202101051028"></script>
<script type="text/javascript" src="./js/igca<%=(is_debug ? "" : ".min")%>.js?_dc=202101051028"></script>
...
<!-- start cuddler -->
<link rel="stylesheet" href="./css/igccud.min.css?_dc=202101051028"></link>
<script type="text/javascript">
var assist_message = [

...
<link rel="stylesheet" type="text/css" href="./css/apps.min.css?_dc=202101051114" />
...
{
	out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"./css/" + theme.toLowerCase() + ".css?_dc=202101051114\" />");
}
%>
...
<script type="text/javascript" src="../bootconfig<%=(is_debug ? "_debug" : "")%>.js?_dc=202101051114"></script>
<script type="text/javascript" src="./js/igca<%=(is_debug ? "" : ".min")%>.js?_dc=202101051114"></script>
...
<!-- start cuddler -->
<link rel="stylesheet" href="./css/igccud.min.css?_dc=202101051114"></link>
<script type="text/javascript">
var assist_message = [

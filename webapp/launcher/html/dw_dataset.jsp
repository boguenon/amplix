			                    ...
			                    <div class="ibox">
			                        <div class="ibox-content">
			                            ...
			                            <div class="input-group">
			                                <input type="text" placeholder="Search dataset " class="input form-control">
			                            ...
			                            <div class="clients-list">
				                            ...
				                            <ul class="nav nav-tabs" role="tablist">
				                                <li class="active"><a data-toggle="tab" href="#tab-1" aria-controls="tab-1" role="tab"><i class="fa fa-user"></i> Contacts</a></li>
				                                <li class=""><a data-toggle="tab" href="#tab-2" aria-controls="tab-2" role="tab"><i class="fa fa-briefcase"></i> Companies</a></li>
				                            </ul>

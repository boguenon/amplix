...
<link rel="stylesheet" type="text/css" href="./css/apps.min.css?_dc=202010200153" />
<% if (lang.equals("ko_KR")) {%>
<link rel="stylesheet" type="text/css" href="./fonts/hangul_nanum.css?_dc=202010200153" />
<% } %>
<%
if (theme != null && theme.length() > 0)
{
	out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"./css/" + theme.toLowerCase() + ".css?_dc=202010200153\" />");
}
%>
<link rel="stylesheet" type="text/css" href="./viewer/css/viewer.css?_dc=202010200153" />
<link rel="stylesheet" type="text/css" href="./css/custom.css?_dc=202010200153" />
...
<script type="text/javascript" src="../config.js?_dc=202010200153"></script>
<script type="text/javascript" src="../bootconfig<%=(is_debug ? "_debug" : "")%>.js?_dc=202010200153"></script>
<script type="text/javascript" src="./js/igca<%=(is_debug ? "" : ".min")%>.js?_dc=202010200153"></script>

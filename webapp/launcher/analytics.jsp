...
<link rel="stylesheet" type="text/css" href="./css/apps.min.css?_dc=202201261040" />
<%
if (theme != null && theme.length() > 0)
{
	out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"./css/" + theme.toLowerCase() + ".css?_dc=202201261040\" />");
}
%>
<% if (lang.equals("ko_KR")) {%>
<link rel="stylesheet" type="text/css" href="./fonts/hangul_nanum.css?_dc=202201261040" />
<% } %>
<link rel="stylesheet" type="text/css" href="./css/custom.css?_dc=202201261040" />
<script type="text/javascript" src="./js/jquery-3.5.1.min.js"></script>    
<script type="text/javascript" src="../config.js?_dc=202201261040"></script>
<script type="text/javascript" src="../bootconfig<%=(is_debug ? "_debug" : "")%>.js?_dc=202201261040"></script>
<script type="text/javascript" src="./js/igca<%=(is_debug ? "" : ".min")%>.js?_dc=202201261040"></script>
...
<!-- start cuddler -->
<link rel="stylesheet" href="./css/igccud.min.css?_dc=202201261040"></link>
<script type="text/javascript">
var assist_message = [

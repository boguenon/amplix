...
<link rel="stylesheet" type="text/css" href="./css/apps.min.css?_dc=202305110653" />
<%
if (theme != null && theme.length() > 0)
{
	out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"./css/" + theme.toLowerCase() + ".css?_dc=202305110653\" />");
}
%>
<link rel="stylesheet" type="text/css" href="./css/custom_lang_<%=lang.toLowerCase()%>.css?_dc=202305110653" />
<link rel="stylesheet" type="text/css" href="./css/custom.css?_dc=202305110653" />
<script type="text/javascript" src="./js/jquery-3.6.4.min.js"></script>    
<script type="text/javascript" src="../config.js?_dc=202305110653"></script>
<script type="text/javascript" src="../bootconfig<%=(is_debug ? "_debug" : "")%>.js?_dc=202305110653"></script>
<script type="text/javascript" src="./js/igca<%=(is_debug ? "" : ".min")%>.js?_dc=202305110653"></script>
...
<!-- start cuddler -->
<link rel="stylesheet" href="./css/igccud.min.css?_dc=202305110653"></link>
<script type="text/javascript">
var assist_message = [

...
IG$.sqlcube_wizard=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",closable:!1,resizable:!0,width:650,height:500,autoScroll:!1,bodyPadding:0,_confirm:function(){var e=this;e.getAllValues(e.sheetoption)||(e.callback&&e.callback.execute(e),e.close())},init:function(){new IG$._rpc$;this.setAllValues(this.sheetoption)},validateQuery:function(){var e,t=this,i=new IG$._rpc$;e={dbpool:t.sheetoption.dbpool},t.getAllValues(e)||(i.init(t,{ack:"olapservice",payload:{uid:t.sheetoption.uid,option:"sqlcubemeta"},mbody:e,meta_type:"inlineview"},t,(function(e){e&&1==e.length&&IG$.alertmsg(ig$.appname,IRm$.r1("M_VALIDATED")+"("+(e[0].columns?e[0].columns.length:"0")+" columns)",null,null,0,"success")}),null),i.send())},initComponent:function(){var e=this;e.title=IRm$.r1("I_SQLCUBE"),$s.apply(this,{items:[{xtype:"panel",name:"mainpanel",layout:{type:"vbox",align:"stretch"},flex:1,autoScroll:!1,items:[{xtype:"panel",border:0,layout:{type:"vbox",align:"stretch"},items:[{xtype:"textfield",fieldLabel:"View name",name:"name",required:!0},{xtype:"textarea",name:"sql",fieldLabel:"SQL Query",flex:1,required:!0}]}]}],buttons:[{text:IRm$.r1("B_VALIDATE"),handler:function(){this.validateQuery()},scope:this},"->",{text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{text:IRm$.r1("B_CLOSE"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this.init()}}}),IG$.sqlcube_wizard.superclass.initComponent.apply(this,arguments)}});

...
IG$.multiMeasure=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",padding:5,closable:!1,resizable:!1,width:400,height:560,callback:null,_fdata:[{name:"Distinct Count",value:"COUNT DISTINCT",metric:1},{name:"Count",value:"COUNT",metric:1},{name:"Sum",value:"SUM",metric:1},{name:"Average",value:"AVG",metric:1},{name:"Max",value:"MAX",metric:1},{name:"Min",value:"MIN",metric:1},{name:"Template",value:"TMPL",metric:0}],_confirm:function(){var e=this;if(e.callback){for(var t,a,l=[],i=this.down("[name=measureview]"),n=this.down("[name=clocation]"),s=0;s<i.store.data.items.length;s++)(t=i.store.data.items[s]).data.selected&&(a={nodepath:t.get("nodepath"),formula:t.get("formula"),type:t.get("type"),name:t.get("name"),uid:t.get("uid"),datatype:t.get("datatype"),measurename:t.get("measurename"),ctype:t.get("ctype"),clocation:t.get("clocation")},l.push(a));if(0==l.length)return void IG$.alertmsg(ig$.appname,IRm$.r1("B_SELECT_TARGET"),null,null,0,"");e.rs_reg_measures({items:l,clocation:n.getValue(),dialog:e,vmode:e.vmode,tmpl:e.tmpl})}e.close()},rs_reg_measures:function(e){var t,a,l,i,n,s,o,m,r,u,d,c=this,p=[],f={items:[]},h=(e.vmode,e.items),y=e.clocation,x=(e.dialog,c.nodepath),g=e.tmpl,b=f.items;for(c.mfolder=y,t=0;t<h.length;t++)if(i=h[t],o=e.vmode?i.clocation+"/":"{parent}"==y.substring(0,"{parent}".length)?i.nodepath.substring(0,i.nodepath.lastIndexOf("/"))+y.substring("{parent}".length)+"/":x+"/"+(y?y+"/":""),i.cloc=o,-1<(u=i.measurename).indexOf("/")&&(u=(u=u.split("/")).join("&#x2044;")),n={name:u,uid:o+u,type:i.ctype||"Measure",createstructure:"T"},c.mitem&&(n.pid=c.mitem.uid),p.push(n),d=c.mitem?c.mitem:i,"DateMetric"==i.ctype)s={cubeuid:c.uid,dateformat:"DATE",fieldid:i.uid,fieldname:u,dbtype:"auto",issql:!0,meta_type:"custom_dimension"},b.push(s);else{switch(i.formula){case"COUNT DISTINCT":case"COUNT_DISTINCT":l="COUNT(DISTINCT ["+i.name+"])";break;case"TMPL":break;default:l=i.formula+"(["+i.name+"])"}if("TMPL"==i.formula&&g){for(r=(l=g.expression).indexOf("[field]");-1<r;)r=(l=l.substring(0,r)+"["+i.name+"]"+l.substring(r+"[field]".length)).indexOf("[field]");for(s={meta_type:"measure",name:i.measurename,expression_type:g.expressiontype,calcmode:g.calcmode,expression:l,rel_items:[d]},a=0;a<g.fields.length;a++)g.fields[a].type=g.fields[a].type||g.fields[a].itemtype,s.items.push(g.fields[a]);b.push(s)}else s={meta_type:"measure",name:i.measurename,expression_type:i.formula,expression:l,rel_items:[d]},b.push(s)}(m=new IG$._rpc$).init(c,{ack:"batchcontent",payload:p,mbody:f},c,function(e){c.callback.execute()},null),m.send()},apply_template:function(){var e,t,a=this.down("[name=measureview]"),l=this.down("[name=t_format]").getValue(),i=a.getSelectionModel().selected,n=l?/(\[field\]|\[formula\])/.test(l):0;if(0==i.length&&(i=a.store.data),n){function s(e,t,a){var l;return a&&a.length&&(-1<(l=t.indexOf(e))&&(t=t.substring(0,l)+a+t.substring(l+e.length))),t}for(var o=0;o<i.length;o++){t=s("[field]",l,t=(e=i.items[o]).get("name"));var m=e.get("formula");switch(m){case"COUNT":m="count";break;case"COUNT DISTINCT":case"COUNT_DISTINCT":m="unique count";break;case"SUM":m="Total";break;case"Min":m="Min.";break;case"MAX":r="Max.";break;case"AVG":r="Avg."}t=s("[formula]",t,m),e.set("measurename",t)}}},initComponent:function(){this.title=IRm$.r1("T_M_MEASURE"),$s.apply(this,{items:[{xtype:"panel",layout:{type:"vbox",align:"stretch"},padding:5,items:[{xtype:"fieldset",title:"MultiMeasure",layout:{type:"vbox",align:"stretch"},flex:1,padding:5,items:[{xtype:"container",layout:{type:"vbox",align:"stretch"},items:[{xtype:"textfield",fieldLabel:"Location",hidden:1==this.vmode||2==this.vmode,name:"clocation"},{xtype:"fieldcontainer",layout:"hbox",fieldLabel:"Measure Name",items:[{xtype:"textfield",name:"t_format",value:"[formula] [field]"},{xtype:"button",text:"Apply",handler:function(){var e=this;e.down("[name=t_format]").getValue()&&(ig$.measure_naming=e.down("[name=t_format]").getValue()),e.apply_template()},scope:this},{xtype:"container",flex:1}]},{xtype:"container",layout:{type:"hbox",align:"stretch"},hidden:1==this.vmode||2==this.vmode,items:[{xtype:"displayfield",value:"Location ex: {parent}/measures"},{xtype:"container",flex:1}]},{xtype:"container",layout:{type:"hbox",align:"stretch"},items:[{xtype:"displayfield",value:"Name template ex: [formula] [field]"},{xtype:"container",flex:1}]}]},{xtype:"gridpanel",name:"measureview",collapsible:!1,stateful:!0,columnLines:!0,selType:"checkboxmodel",selModel:{checkSelector:".x-grid-cell"},store:{fields:["name","uid","nodepath","type","datatype","measurename","formula","ctype","clocation"]},flex:1,initialized:!1,layout:"fit",plugins:[{ptype:"cellediting",clicksToEdit:1}],columns:[{text:"Measure name",dataIndex:"measurename",flex:1,editor:{allowBlank:!1}},{text:"Fact name",dataIndex:"name",flex:1,editor:{allowBlank:!1}},{width:120,text:"Measure Type",dataIndex:"formula",editor:{xtype:"combobox",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,triggerAction:"all",selectOnTab:!0,store:{xtype:"store",fields:["name","value"],data:this._fdata},lazyRender:!0,listClass:"x-combo-list-small"}}],viewConfig:{stripeRows:!0},fbar:[{xtype:"toolbar",items:[{xtype:"button",text:"Remove Selected",handler:function(){for(var e=this.down("[name=measureview]"),t=e.store,a=e.getSelectionModel().selected,l=a.length-1;0<=l;l--)t.remove(a.items[l])},scope:this},"->",{xtype:"button",text:"Template",handler:function(){var e,l=this,t=new IG$.measureEditor({dmode:1,cubeuid:l.pcube.uid,clItem:l.tmpl||{},callback:new IG$.callBackObj(l,function(e){l.tmpl=e?e.citem:null;for(var t=l.down("[name=measureview]").getSelectionModel().selected,a=0;a<t.length;a++)t.items[a].set("formula","TMPL")})}),a=l.pcube,i=a?a.customstyle:null;if(t.clItem.cubeinfo.styles=[],i)for(e=0;e<i.length;e++)t.clItem.cubeinfo.styles.push(i[e]);t.clItem.expressiontype=t.clItem.expressiontype||"SUM([field])",t.clItem.expression=t.clItem.expression||"SUM([field])",t.show()},scope:this}]}]}]}]}],buttons:["->",{text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{text:IRm$.r1("B_CLOSE"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(){var e,t,a,l=this,i=l.down("[name=measureview]"),n=l.down("[name=clocation]"),s=l.mitem;if(l.down("[name=t_format]").setValue(ig$.measure_naming||"[formula] [field]"),2==l.vmode){for(e=[],t=0;t<l._fdata.length;t++)0<(a=l._fdata[t]).metric&&e.push({measurename:a.name,formula_desc:a.name,name:s.name,formula:a.value});i.store.loadData(e)}else n.setValue(null==l.mfolder?"{parent}/measures":l.mfolder),l.metaitems&&(i.store.loadData(l.metaitems),l.apply_template())}}}),IG$.multiMeasure.superclass.initComponent.apply(this,arguments)}});

...
IG$.cube_object_select=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",closable:!0,resizable:!0,width:770,height:500,_init:function(){var e=this;e.alias_map={},e._aliasLoaded=!1,e.curnode=null,e.cursop=null,e._getDB(e.targetdb||e.dbo.uid)},_getDB:function(e){var t=new IG$._rpc$,a={uid:e},n=this.dbo;t.init(this,{ack:"tablecontent",payload:a,mbody:{option:"standard"}},this,(function(e,t){var a,s,i=e,l=this.down("[name=fschema]"),o=[],r=n?n.username.toUpperCase():null,d="";if(i)for(a=0;a<e.schemas.length;a++)s=e.schemas[a],o.push(s),r&&s.name.toUpperCase()==r&&(d=s.name);l.store.loadData(o),l.setValue(d)}),!1),t.send()},_isValid:function(e){var t=this.down("[name=fschema]");return t.clearInvalid(),t.getValue()?1:(t.markInvalid("Select Item"),0)},_searchTb:function(){var e,t,a=this.down("[name=src_keyword]"),n=this.down("[name=fschema]"),s=n.getValue();if(this._isValid()){for(e=0;e<n.store.data.items.length;e++)if(n.store.data.items[e].get("name")==s){t=n.store.data.items[e];break}this._getTable(t,null,a.getValue())}},_getTable:function(e,t,a,n){var s,i=e.get("db_uid"),l=new IG$._rpc$,o={uid:i,option:t,schema:e.get("name"),search:a,product_code:e.get("product_code")};if(n)for(s in n)o[s]=n[s];l.init(this,{ack:"tablecontent",payload:o,mbody:o},this,this.rs__getTable,!1,[e,t]),l.send()},rs__getTable:function(e,t){var a,n,s=t[0],i=t[1],l=e.tables||(e.length?e[0].children:null),o=[],r=!!i,d=r?this.down("[name=grid_st]"):this.down("[name=grid_sc]");if(l)for(a=0;a<l.length;a++)(n=r?l[a].content:l[a]).uid=n.uid||""+a,n.product_code=s.get("product_code"),n.allow_insert=n.allow_insert,n.allow_insert_desc=n.allow_insert?"Yes":"",o.push(n);d.store.loadData(o)},_regTables:function(e){var t,a,n=this.down("[name=grid_sc]"),s=this.down("[name=grid_st]"),i=(this.alias_map,{});if(0!=(a=(e?s:n).getSelectionModel().selected).length||e){if(!e)for(t=0;t<s.store.data.items.length;t++)i[s.store.data.items[t].get("external_name")]=1;for(t=0;t<a.length;t++)e?s.store.remove(a.items[t]):i[a.items[t].get("external_name")]||s.store.add(a.items[t]);e||n.getSelectionModel().clear()}else IG$.alertmsg(ig$.appname,"Search and check table to register.",null,null,0,"error")},initComponent:function(){var e=this;e.title="Select object",$s.apply(this,{padding:5,defaults:{bodyStyle:"padding:10px"},items:[{xtype:"panel",layout:{type:"vbox",align:"stretch"},items:[{xtype:"combobox",queryMode:"local",fieldLabel:"Schema",name:"fschema",displayField:"name",valueField:"name",emptyText:"Select Item",typeAhead:!0,forceSelection:!1,autoSelect:!0,autoScroll:!0,store:{fields:["name","uid","db_uid","type"]}},{xtype:"panel",flex:1,layout:{type:"hbox",align:"stretch"},items:[{xtype:"gridpanel",name:"grid_sc",emptyText:IRm$.r1("M_S_S1"),selType:"checkboxmodel",selModel:{checkSelector:".x-grid-cell",mode:"MULTI"},store:{fields:["name","type","nodepath","uid","schemaname","dispname","checked"]},tbar:[{xtype:"textfield",name:"src_keyword",fieldLabel:"Search",labelWidth:60,width:160,enableKeyEvents:!0,listeners:{keyup:function(e,t,a){13==t.keyCode&&this._searchTb()},scope:this}},{xtype:"button",text:"..",handler:function(){this._searchTb()},scope:this},"->"],columns:[{text:IRm$.r1("B_TYPE"),width:60,sortable:!0,dataIndex:"object_type"},{text:IRm$.r1("B_NAME"),flex:1,sortable:!0,dataIndex:"name"},{text:IRm$.r1("B_OBJ_NAME"),flex:1,sortable:!0,dataIndex:"external_name"}],listeners:{itemdblclick:function(t,a,n,s,i){e._regTables()},scope:this}},{xtype:"container",layout:{type:"vbox",align:"stretch"},items:[{xtype:"container",flex:1},{xtype:"button",text:">",handler:function(){this._regTables()},scope:this},{xtype:"button",text:"<",handler:function(){this._regTables(1)},scope:this},{xtype:"container",flex:1}]},{xtype:"gridpanel",name:"grid_st",emptyText:IRm$.r1("M_S_S1"),selType:"checkboxmodel",selModel:{checkSelector:".x-grid-cell",mode:"MULTI"},tbar:[{xtype:"textfield",name:"src_keyword",fieldLabel:"Search",labelWidth:60,width:160,enableKeyEvents:!0,listeners:{keyup:function(e,t,a){13==t.keyCode&&this._searchTb()},scope:this}},{xtype:"button",text:"..",handler:function(){this._searchTb()},scope:this}],store:{fields:["name","type","nodepath","uid","schemaname","dispname","checked"]},columns:[{text:IRm$.r1("B_TYPE"),width:60,sortable:!0,dataIndex:"object_type"},{text:IRm$.r1("B_NAME"),flex:1,sortable:!0,dataIndex:"name"},{text:IRm$.r1("B_OBJ_NAME"),flex:1,sortable:!0,dataIndex:"external_name"}],listeners:{itemdblclick:function(t,a,n,s,i){e._regTables(1)},scope:this}}]}]}],buttons:[{text:IRm$.r1("B_CONFIRM"),handler:function(){var e,t=this.down("[name=grid_st]"),a=[];for(e=0;e<t.store.data.items.length;e++)a.push(t.store.data.items[e].data);a.length?(this.callback&&this.callback.execute(a),this.close()):IG$.alertmsg(ig$.appname,"Search and check table to register.",null,null,0,"error")},scope:this},{text:IRm$.r1("B_CLOSE"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this._init()}}}),IG$.cube_object_select.superclass.initComponent.apply(this,arguments)}});
IG$.securityFilter=$s.extend($s.window,{title:"Security Filter Management",modal:!1,layout:"fit",closable:!1,resizable:!1,width:400,height:500,bodyPadding:10,_key:0,_addFilter:function(){var e,t=this;e=new IG$.mgrUserDuty({modal:!1,callback:new IG$.callBackObj(t,(function(e){var i,n,a,l=[],r="",o=this.down("[name=gridduty]");for(i=0;i<e.length;i++){var s={sid:e[i].get("sid"),name:e[i].get("name")};l.push(s)}if(l.length>0){for((n=new IG$.clFilterGroup(null)).auth=[],i=0;i<l.length;i++)n.auth.push({name:l[i].name,sid:l[i].sid}),r+=(i>0?",":"")+l[i].name;n.active=!0,n.index=t._key++,t.securityfilter.push(n),a=o.store.add({authname:r,active:n.active,index:n.index}),t.authSet(a,"edit")}}))}),IG$.checkLogin(t,e)},_confirm:function(){if(this.callback){var e,t=this.down("[name=gridduty]"),i={};for(e=0;e<t.store.data.items.length;e++)i[t.store.data.items[e].get("index")]=!0;for(e=panel.securityfilter.length-1;e>=0;e--)i[panel.securityfilter[e].index]||panel.securityfilter.splice(e,1);this.callback.execute()}this.close()},loadSecurityFilter:function(){var e,t,i,n,a=[],l=this.down("[name=gridduty]");if(this.securityfilter)for(e=0;e<this.securityfilter.length;e++){for((n=this.securityfilter[e]).auth=n.auth||[],n.index=this._key++,i="",t=0;t<n.auth.length;t++)i+=(t>0?",":"")+n.auth[t].name;a.push({authname:i,active:n.active,index:n.index})}l.store.loadData(a)},authSet:function(e,t){var i,n,a,l,r,o=this,s=o.down("[name=gridduty]"),c=e.get("index");for(a=0;a<this.securityfilter.length;a++)if(o.securityfilter[a].index==c){r=o.securityfilter[a],l=a;break}if("remove"==t)i=s.store.indexOf(e),o.securityfilter.splice(i,1),s.store.remove(e);else if("auth"==t)n=new IG$.mgrUserDuty({modal:!1,sel:r.auth,callback:new IG$.callBackObj(o,(function(t){var i,n=[],a="";this.down("[name=gridduty]");for(i=0;i<t.length;i++){var l={sid:t[i].get("sid"),name:t[i].get("name")};n.push(l)}if(n.length>0){for(r.auth=[],i=0;i<n.length;i++)r.auth.push({name:n[i].name,sid:n[i].sid}),a+=(i>0?",":"")+n[i].name;e.set("authname",a)}}))}),IG$.checkLogin(o,n);else{var d=new IG$.filterEditorWindow({sheetoption:{model:{filter:r,cube_object:{uid:o.uid}}},reportoption:{cubeuid:o.uid},callback:new IG$.callBackObj(o,(function(e){this.securityfilter[l]=e.model.filter}))});IG$.checkLogin(o,d)}},initComponent:function(){var e=this,t=[{xtype:"form",layout:"anchor",defaults:{anchor:"100%"},border:0,items:[{xtype:"displayfield",value:"Select user duty from list"},{xtype:"gridpanel",name:"gridduty",flex:1,selType:"checkboxmodel",selModel:{checkSelector:".x-grid-cell",mode:"MULTI"},multiSelect:!0,store:{fields:["authname","active","index"]},columns:[{header:"Auth Name",dataIndex:"authname",flex:1,sortable:!1,hideable:!1},{xtype:"actioncolumn",width:70,items:[{iconCls:"icon-grid-add",tooltip:"Edit",handler:function(t,i,n){var a=t.store.getAt(i);e.authSet.call(e,a,"edit")}},{iconCls:"icon-grid-config",tooltip:"Edit",handler:function(t,i,n){var a=t.store.getAt(i);e.authSet.call(e,a,"auth")}},{iconCls:"icon-grid-delete",tooltip:"Remove Filtering",handler:function(t,i,n){var a=t.store.getAt(i);e.authSet.call(e,a,"remove")}}]}]}]}],i=[{text:IRm$.r1("L_ADD_FILTER"),handler:function(){this._addFilter()},scope:this},"->",{text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}];$s.apply(this,{items:t,buttons:i}),IG$.securityFilter.superclass.initComponent.apply(this,arguments)},listeners:{afterrender:function(e){this.loadSecurityFilter()}}});

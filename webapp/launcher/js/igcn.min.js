...
IG$.cube_object_select=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",closable:!0,resizable:!0,width:770,height:500,_init:function(){var e=this;e.alias_map={},e._aliasLoaded=!1,e.curnode=null,e.cursop=null,e._getDB(e.targetdb||e.dbo.uid)},_getDB:function(e){var t=this,a=new IG$._rpc$,n={uid:e},d=t.dbo;a.init(t,{ack:"tablecontent",payload:n,mbody:{option:"standard"}},t,function(e,t){var a,n,l=e,s=this.down("[name=fschema]"),i=[],o=d?d.username.toUpperCase():null,r="";if(l)for(a=0;a<e.schemas.length;a++)n=e.schemas[a],i.push(n),o&&n.name.toUpperCase()==o&&(r=n.name);s.store.loadData(i),s.setValue(r)},!1),a.send()},_isValid:function(e){var t=this.down("[name=fschema]");return t.clearInvalid(),t.getValue()?1:(t.markInvalid("Select Item"),0)},_searchTb:function(){var e,t,a=this,n=a.down("[name=src_keyword]"),l=a.down("[name=fschema]"),s=l.getValue();if(a._isValid()){for(e=0;e<l.store.data.items.length;e++)if(l.store.data.items[e].get("name")==s){t=l.store.data.items[e];break}a._getTable(t,null,n.getValue())}},_getTable:function(e,t,a,n){var l,s=this,i=e.get("db_uid"),o=new IG$._rpc$,r={uid:i,option:t,schema:e.get("name"),search:a,product_code:e.get("product_code")};if(n)for(l in n)r[l]=n[l];o.init(s,{ack:"tablecontent",payload:r,mbody:r},s,s.rs__getTable,!1,[e,t]),o.send()},rs__getTable:function(e,t){var a,n,l=t[0],s=t[1],i=e.tables||(e.length?e[0].children:null),o=[],r=!!s,d=r?this.down("[name=grid_st]"):this.down("[name=grid_sc]");if(i)for(a=0;a<i.length;a++)(n=r?i[a].content:i[a]).uid=n.uid||""+a,n.product_code=l.get("product_code"),n.allow_insert=n.allow_insert,n.allow_insert_desc=n.allow_insert?"Yes":"",o.push(n);d.store.loadData(o)},_regTables:function(e){var t,a=this,n=a.down("[name=grid_sc]"),l=a.down("[name=grid_st]"),s=(a.alias_map,{}),i=(e?l:n).getSelectionModel().selected;if(0!=i.length||e){if(!e)for(t=0;t<l.store.data.items.length;t++)s[l.store.data.items[t].get("external_name")]=1;for(t=0;t<i.length;t++)e?l.store.remove(i.items[t]):s[i.items[t].get("external_name")]||l.store.add(i.items[t]);e||n.getSelectionModel().clear()}else IG$.alertmsg(ig$.appname,"Search and check table to register.",null,null,0,"error")},initComponent:function(){var s=this;s.title="Select object",$s.apply(this,{padding:5,defaults:{bodyStyle:"padding:10px"},items:[{xtype:"panel",layout:{type:"vbox",align:"stretch"},items:[{xtype:"combobox",queryMode:"local",fieldLabel:"Schema",name:"fschema",displayField:"name",valueField:"name",emptyText:"Select Item",typeAhead:!0,forceSelection:!1,autoSelect:!0,autoScroll:!0,store:{fields:["name","uid","db_uid","type"]}},{xtype:"panel",flex:1,layout:{type:"hbox",align:"stretch"},items:[{xtype:"gridpanel",name:"grid_sc",emptyText:IRm$.r1("M_S_S1"),selType:"checkboxmodel",selModel:{checkSelector:".x-grid-cell",mode:"MULTI"},store:{fields:["name","type","nodepath","uid","schemaname","dispname","checked"]},tbar:[{xtype:"textfield",name:"src_keyword",fieldLabel:"Search",labelWidth:60,width:160,enableKeyEvents:!0,listeners:{keyup:function(e,t,a){13==t.keyCode&&this._searchTb()},scope:this}},{xtype:"button",text:"..",handler:function(){this._searchTb()},scope:this},"->"],columns:[{text:IRm$.r1("B_TYPE"),width:60,sortable:!0,dataIndex:"object_type"},{text:IRm$.r1("B_NAME"),flex:1,sortable:!0,dataIndex:"name"},{text:IRm$.r1("B_OBJ_NAME"),flex:1,sortable:!0,dataIndex:"external_name"}],listeners:{itemdblclick:function(e,t,a,n,l){s._regTables()},scope:this}},{xtype:"container",layout:{type:"vbox",align:"stretch"},items:[{xtype:"container",flex:1},{xtype:"button",text:">",handler:function(){this._regTables()},scope:this},{xtype:"button",text:"<",handler:function(){this._regTables(1)},scope:this},{xtype:"container",flex:1}]},{xtype:"gridpanel",name:"grid_st",emptyText:IRm$.r1("M_S_S1"),selType:"checkboxmodel",selModel:{checkSelector:".x-grid-cell",mode:"MULTI"},tbar:[{xtype:"textfield",name:"src_keyword",fieldLabel:"Search",labelWidth:60,width:160,enableKeyEvents:!0,listeners:{keyup:function(e,t,a){13==t.keyCode&&this._searchTb()},scope:this}},{xtype:"button",text:"..",handler:function(){this._searchTb()},scope:this}],store:{fields:["name","type","nodepath","uid","schemaname","dispname","checked"]},columns:[{text:IRm$.r1("B_TYPE"),width:60,sortable:!0,dataIndex:"object_type"},{text:IRm$.r1("B_NAME"),flex:1,sortable:!0,dataIndex:"name"},{text:IRm$.r1("B_OBJ_NAME"),flex:1,sortable:!0,dataIndex:"external_name"}],listeners:{itemdblclick:function(e,t,a,n,l){s._regTables(1)},scope:this}}]}]}],buttons:[{text:IRm$.r1("B_CONFIRM"),handler:function(){for(var e=this.down("[name=grid_st]"),t=[],a=0;a<e.store.data.items.length;a++)t.push(e.store.data.items[a].data);t.length?(this.callback&&this.callback.execute(t),this.close()):IG$.alertmsg(ig$.appname,"Search and check table to register.",null,null,0,"error")},scope:this},{text:IRm$.r1("B_CLOSE"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this._init()}}}),IG$.cube_object_select.superclass.initComponent.apply(this,arguments)}});
IG$.securityFilter=$s.extend($s.window,{title:"Security Filter Management",modal:!1,layout:"fit",closable:!1,resizable:!1,width:400,height:500,bodyPadding:10,_key:0,_addFilter:function(){var s=this,e=new IG$.mgrUserDuty({modal:!1,callback:new IG$.callBackObj(s,function(e){for(var t,i,n=[],a="",l=this.down("[name=gridduty]"),r=0;r<e.length;r++){var o={sid:e[r].get("sid"),name:e[r].get("name")};n.push(o)}if(0<n.length){for((t=new IG$.clFilterGroup(null)).auth=[],r=0;r<n.length;r++)t.auth.push({name:n[r].name,sid:n[r].sid}),a+=(0<r?",":"")+n[r].name;t.active=!0,t.index=s._key++,s.securityfilter.push(t),i=l.store.add({authname:a,active:t.active,index:t.index}),s.authSet(i,"edit")}})});IG$.checkLogin(s,e)},_confirm:function(){if(this.callback){for(var e=this.down("[name=gridduty]"),t={},i=0;i<e.store.data.items.length;i++)t[e.store.data.items[i].get("index")]=!0;for(i=panel.securityfilter.length-1;0<=i;i--)t[panel.securityfilter[i].index]||panel.securityfilter.splice(i,1);this.callback.execute()}this.close()},loadSecurityFilter:function(){var e,t,i,n,a=this,l=[],r=this.down("[name=gridduty]");if(a.securityfilter)for(e=0;e<a.securityfilter.length;e++){for((n=a.securityfilter[e]).auth=n.auth||[],n.index=a._key++,i="",t=0;t<n.auth.length;t++)i+=(0<t?",":"")+n.auth[t].name;l.push({authname:i,active:n.active,index:n.index})}r.store.loadData(l)},authSet:function(l,e){for(var t,i,n,r,a,o=this,s=o.down("[name=gridduty]"),c=l.get("index"),d=0;d<this.securityfilter.length;d++)if(o.securityfilter[d].index==c){r=o.securityfilter[d],n=d;break}"remove"==e?(t=s.store.indexOf(l),o.securityfilter.splice(t,1),s.store.remove(l)):"auth"==e?(i=new IG$.mgrUserDuty({modal:!1,sel:r.auth,callback:new IG$.callBackObj(o,function(e){for(var t=[],i="",n=(this.down("[name=gridduty]"),0);n<e.length;n++){var a={sid:e[n].get("sid"),name:e[n].get("name")};t.push(a)}if(0<t.length){for(r.auth=[],n=0;n<t.length;n++)r.auth.push({name:t[n].name,sid:t[n].sid}),i+=(0<n?",":"")+t[n].name;l.set("authname",i)}})}),IG$.checkLogin(o,i)):(a=new IG$.filterEditorWindow({sheetoption:{model:{filter:r,cube_object:{uid:o.uid}}},reportoption:{cubeuid:o.uid},callback:new IG$.callBackObj(o,function(e){this.securityfilter[n]=e.model.filter})}),IG$.checkLogin(o,a))},initComponent:function(){var a=this,e=[{xtype:"form",layout:"anchor",defaults:{anchor:"100%"},border:0,items:[{xtype:"displayfield",value:"Select user duty from list"},{xtype:"gridpanel",name:"gridduty",flex:1,selType:"checkboxmodel",selModel:{checkSelector:".x-grid-cell",mode:"MULTI"},multiSelect:!0,store:{fields:["authname","active","index"]},columns:[{header:"Auth Name",dataIndex:"authname",flex:1,sortable:!1,hideable:!1},{xtype:"actioncolumn",width:70,items:[{iconCls:"icon-grid-add",tooltip:"Edit",handler:function(e,t,i){var n=e.store.getAt(t);a.authSet.call(a,n,"edit")}},{iconCls:"icon-grid-config",tooltip:"Edit",handler:function(e,t,i){var n=e.store.getAt(t);a.authSet.call(a,n,"auth")}},{iconCls:"icon-grid-delete",tooltip:"Remove Filtering",handler:function(e,t,i){var n=e.store.getAt(t);a.authSet.call(a,n,"remove")}}]}]}]}],t=[{text:IRm$.r1("L_ADD_FILTER"),handler:function(){this._addFilter()},scope:this},"->",{text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}];$s.apply(this,{items:e,buttons:t}),IG$.securityFilter.superclass.initComponent.apply(this,arguments)},listeners:{afterrender:function(e){this.loadSecurityFilter()}}});
IG$.m$CubeModel=function(e){var o,t,i,r,n,l,b=this;if(b._mc=e=e||{},$s.defaults(e,{pool:[]}),b.zoom=1,b.groupview=!1,b.tables=[],b.relations=[],b.highlight=[],b.fixKeyMode=!1,n=e.tables)for(t=0;t<n.length;t++){if((l=new IG$.m$TblObj(n[t])).fields=[],r=l.columns)for(i=0;i<r.length;i++)r[i].seq=l.seq;b.tables.push(l)}if(n=e.joins)for(t=0;t<n.length;t++)(o=n[t]).source.seq=o.source.seq||0,o.target.seq=o.target.seq||0,b.relations.push(o);if(n=e.securityfilter,b.securityfilter=[],n)for(t=0;t<n.length;t++)o=n[t],b.securityfilter.push(o);b.highlight=e.highlight},IG$.m$TblObj=function(e){this._mc=e,this.ranged=!1},IG$.m$TblObj.prototype={stageX:function(){var e=this,o=0,t=e.bbox;return e.box&&(e.bbox={left:e.box.pobj.scrollPanel.offset().left,top:e.box.pobj.scrollPanel.offset().top},t=e.bbox,o=$(e.box.innerGrid.body.dom).offset().left-t.left),o},stageY:function(e){var o,t,i,r,n,l=this,b=0,s=l.bbox;return l.box&&(l.bbox={left:l.box.pobj.scrollPanel.offset().left,top:l.box.pobj.scrollPanel.offset().top},s=l.bbox,o=$(l.box.innerGrid.body.dom),i=(t=l.box.innerGrid.down("[name=skey]"))&&t.body?$(t.body.dom):null,b=o.offset().top-s.top+(i&&i.height()||0),null!=e&&(b+=(n=(r=l.box.innerGrid).getHeight.call(r,e)).d,l.ranged=n.ranged)),b},bodyWidth:function(){var e=0;return this.box&&(e=this.box.innerGrid.getWidth()),e},bodyHeight:function(){var e=0;return this.box&&((e=this.box.innerGrid.getHeight()).ranged||(e=e.d)),e}},IG$.m$CubeModel.prototype={getXML:function(){return this._mc}};
IG$.cubeModelViewer=function(e,t){var o=this;o.sobj=t,o.viewer=e,o.dialog=[],o.links=[],o.zoomRatio=1,o.lineMode="2"},IG$.cubeModelViewer.prototype={init:function(){var t=this;t._mouseActionPoint=null,t.container=$("<div class='igc-cubemodelviewer'></div>").css({position:"absolute",top:0,bottom:0,left:0,right:0,overflow:"auto"}).appendTo(t.viewer),t.paint=$("<div></div>"),t.paint.appendTo(t.container),t.scrollPanel=$("<div></div>").css({position:"absolute",top:0,bottom:0,width:IG$.j$ext._w(t.container),height:IG$.j$ext._h(t.container),backgroundColor:"none"}).appendTo(t.container),t.appendScrollBar(),t.container.droppable({drop:function(e,t){}}),t.allowDrop(t.scrollPanel[0]),t.container.bind("resize",function(e){t.validateSize.call(t)})},zoom:function(e){var t=this,o=t.zoomRatio+e;.3<o&&o<5&&(t.zoomRatio=o,$(t.scrollPanel).css({transform:"scale("+o+","+o+")","transform-origin":"0px 0px"}))},allowDrop:function(a){var n=this;this.dropZone=$s.create($s.dropzone,a,{ddGroup:"CubeModelDDGroup",nodeouttimer:-1,getTargetFromEvent:function(e){var t=e.browserEvent.pageX||e.browserEvent.clientX,o=e.browserEvent.pageY||e.browserEvent.clientY,i=n.getRendererByPoint(t,o);return null==i&&(i=a),i},notifyOut:function(e,t,o){var i=this;i.lastOverNode&&(i.onNodeOut(i.lastOverNode,e,t,o),i.lastOverNode=null),n.isDragging=!1,n.hideDropFeedback&&(n.hideDropFeedback.call(n,t),1==i.accept&&1==i.pivotmove&&n.sheetobj&&(-1<i.nodeouttimer&&clearTimeout(i.nodeouttimer),i.nodeouttimer=setTimeout(function(){n.hideDropFeedback.call(n,t)},100)))},onNodeEnter:function(e,t,o,i){n.isDragging=!0;var a,l=!1;i.records&&0<i.records.length?"Table"!=(a=i.records[0].get("type"))&&"InlineView"!=a&&"CubeModel"!=a||(l=!0):i.cellData&&(a=i.cellData,l=!0),this.accept=l},onNodeOut:function(e,t,o,i){},onNodeOver:function(e,t,o,i){var a=this,l=window.Ext?1==a.accept?Ext.dd.DropZone.prototype.dropAllowed:Ext.dd.DropZone.prototype.dropNotAllowed:a.accept;return 1==a.accept&&(i.records&&0<i.records.length?i.records[0].data:i.cellData),l},onNodeDrop:function(e,t,o,i){return 1==this.accept&&(i.records&&0<i.records.length?(dt=i.records[0].data,n.sobj.onDropRecord.call(n.sobj,o,dt)):dt=i.cellData),!(this.accept=!1)}})},focusTable:function(e){var t,o,i,a=this,l=a.container,n=e.box.innerGrid,r=a.viewer;n&&(o=l.offset(),n.$ex?(a._psel&&a._psel.box&&$(a._psel.box.innerGrid.$ex.$view).removeClass("igc-f-table"),t=(i=$(n.$ex.$view)).offset(),i.addClass("igc-f-table"),l.animate({scrollTop:Math.max(t.top-o.top+l.scrollTop()-(r.height()-i.height())/2,0),scrollLeft:Math.max(t.left-o.left+l.scrollLeft()-(r.width()-i.width())/2,0)},200)):n.el&&n.el.dom&&(a._psel&&a._psel.box&&$(a._psel.box.innerGrid.el.dom).removeClass("igc-f-table"),t=(i=$(n.el.dom)).offset(),i.addClass("igc-f-table"),l.animate({scrollTop:Math.max(t.top-o.top+l.scrollTop()-(r.height()-i.height())/2,0),scrollLeft:Math.max(t.left-o.left+l.scrollLeft()-(r.width()-i.width())/2,0)},200)),a._psel=e)},getRendererByPoint:function(){return null},appendScrollBar:function(){var e=this;e.scrollbar=$("<div></div>").css({position:"absolute",top:0,bottom:0,width:IG$.j$ext._w(e.container),height:IG$.j$ext._h(e.container),backgroundColor:"none"}).appendTo(e.scrollPanel),e.rcanvas=Raphael(e.scrollbar[0],0,0,"100%","100%"),e._ca=[]},scrollHandler:function(e,t){var o=this;switch(e){case"down":o._mouseActionPoint={x:t.pageX,y:t.pageY};break;case"up":o._mouseActionPoint=null;break;case"move":var i=IG$.j$ext._w(container),a=IG$.j$ext._w(scrollPanel),l=IG$.j$ext._h(container),n=IG$.j$ext._h(scrollPanel);if(null!=o._mouseActionPoint&&(i<a||h_container<h_scrollPanel)){var r=o.paint,s=o.scrollPanel,d=o.scrollbar,c=o.container.offset(),h=s.offset(),f=t.pageX-o._mouseActionPoint.x,p=t.pageY-o._mouseActionPoint.y,b={top:h.top+p,left:h.left+f};if(o._mouseActionPoint={x:t.pageX,y:t.pageY},b.top<l-n||b.left<i-a||0<b.top-c.top||0<b.left-c.left)return;d.offset(b),s.offset(b),r.offset(b)}}},clearAll:function(){var e=this;e.dialog=[],e.links=[],e.rcanvas.clear(),$.each(e._ca,function(e,t){t.remove()}),e._ca=[],e.scrollPanel.empty(),e.appendScrollBar()},validateTimer:-1,validateSize:function(){var e=this;e.validateTimer&&clearTimeout(e.validateTimer),e.validateTimer=setTimeout(function(){e.validateSizeProc.call(e)},100)},validateSizeProc:function(){for(var e=this,t=(e.container.offset(),IG$.j$ext._w(e.container)),o=IG$.j$ext._h(e.container),i=0;i<e.dialog.length;i++)t=Math.max(t,e.dialog[i].table.stageX()+e.dialog[i].table.bodyWidth()+100),o=Math.max(o,e.dialog[i].table.stageY()+e.dialog[i].table.bodyHeight()+100);IG$.j$ext._w(e.scrollPanel,t),IG$.j$ext._h(e.scrollPanel,o),IG$.j$ext._w(e.scrollbar,t),IG$.j$ext._h(e.scrollbar,o),IG$.j$ext._w(e.paint,t),IG$.j$ext._h(e.paint,o),e.rcanvas.setViewBox(0,0,t,o,!0),e.rcanvas.setSize(t,o),e.validateLinks()},validateLinks:function(){var e,t=this;for(t.rcanvas.clear(),$.each(t._ca,function(e,t){t.remove()}),t._ca=[],e=0;e<t.links.length;e++)t.links[e].refresh.call(t.links[e],e,1==t.sobj.cubemodel.groupview)},addBox:function(e,t,o,i,a,l){var n=new IG$.tableBox(this,e,t,o,i,a);return n.main=l,n.collapsePanel.call(n),n.innerGrid.fixKeyMode.call(n.innerGrid,a._mcfixKeyMode),this.dialog.push(n),n},addLink:function(e,t,o,i){var a,l,n,r=this;for(r.relations=i,a=0;a<r.links.length;a++)if((n=r.links[a])&&(n.fromobj._mc.uid==e._mc.uid&&n.toobj._mc.uid==t._mc.uid&&n.fromobj._mc.seq==e._mc.seq&&n.toobj._mc.seq==t._mc.seq||n.fromobj._mc.uid==t._mc.uid&&n.toobj._mc.uid==e._mc.uid&&n.fromobj._mc.seq==t._mc.seq&&n.toobj._mc.seq==e._mc.seq)){l=n;break}return l?l.links.push(o):(l=new IG$.LinkField(r,e,t,o,i),r.links.push(l)),l},removeTbl:function(e){for(var t,o,i=this.sobj,a=i.cubemodel,l=this.dialog,n=this.links,r=0;r<a.tables.length;r++)if(e.table==a.tables[r]){a.tables.splice(r,1);break}for(r=0;r<l.length;r++)if(l[r]==e){l.splice(r,1);break}for(r=n.length-1;0<=r;r--)if(n[r].fromobj==e.table||n[r].toobj==e.table){for(o=n[r],t=a.relations.length-1;0<=t;t--)a.relations[t].bl==o&&a.relations.splice(t,1);n.splice(r,1)}i.updateUsedTable.call(i),i.validateTables.call(i),i.validateJoins.call(i)}},IG$.tableBox=function(n,e,t,o,i,c){var s=this,a=this,l=n,r=c._mc.name;a.pobj=n,(a.table=c)._mc.theight=c._mc.theight||i,c._mc.seq&&0<c._mc.seq&&(r+="("+c._mc.seq+")"),a.innerGrid=new $s.panel({renderTo:this.pobj.scrollPanel[0],table:c,autoScroll:!1,stateful:!1,draggable:!0,plain:!1,minimizable:!1,alwaysFramed:!0,closable:!0,cpa:l,title:r,x:e,border:1,y:t,width:o,height:(c._mc.theight||100)<100?100:c._mc.theight,viewmode:"physical",fixKeyVal:!1,fixKeyMode:function(e){this.fixKeyVal=e,this.g_key.setVisible(e),this.loadData()},layout:{type:"vbox",align:"stretch"},_loadModel:function(){var n=this,e=n.table._mc,t=new IG$._rpc$;e.uid&&"cubemodel"==e.type.toLowerCase()&&(t.init(n,{ack:"content",payload:{uid:e.uid,type:e.type},mbody:{}},n,function(e){for(var t,o=e.content.tables,i=n.down("[name=stables]"),a=[],l=0;l<o.length;l++)t={uid:o[l].uid,type:o[l].type,name:o[l].name,nodepath:o[l].nodepath},a.push(t);i.store.loadData(a)}),t.send())},_loadField:function(r){var e,t=this,o=new IG$._rpc$,s=t.table._mc,d=t.table._tables;t.table._sel_table=r,d[r]?((e=t.cpa.sobj).validateTables(),e.validateJoins()):(o.init(t,{ack:"tablecontent",payload:{uid:r,option:"StoredContent"},mbody:{option:"folder",readcontent:"T"}},t,function(e){var t,o,i,a=e.length?e[0]:null,l=(a&&a.content,[]),n=this.cpa.sobj;if(d[r]={columns:[]},a&&a.children)for(t=a.children,i=0;i<t.length;i++)(o=t[i].content).model=s.uid,o.tablename=a.name||o.tablename,o.alias=o.alias||o.name,o.iskey=o.iskey,o.leaf=!0,o.dispname=o.name,o.allowDrag=!0,o.seq=c._mc.seq,o.tableuid=a.uid,l.push(o);d[r].columns=l,n.validateTables(),n.validateJoins()},null),o.send())},loadData:function(){var e,t,o=this,i=[],a=[],l=o.table,n=o.table._mc,r=n.columns;if("cubemodel"==n.type.toLowerCase()){if(!l._sel_table||!l._tables[l._sel_table])return void o._loadModel();r=l._tables[l._sel_table].columns}if(r)for(e=0;e<r.length;e++)t=r[e],!o.fixKeyVal||1!=t.iskey&&1!=t.hasjoin?i.push(t):a.push(t);o.g_key.store.loadData(a),o.g_fields.store.loadData(i)},getHeight:function(e){var t,o,i,a,l,n={d:0,ranged:!1},r=!1,s=!1;if(this.fixKeyVal){for(l=(i=this.g_key).getHeight(),t=0;t<i.store.data.items.length;t++)if(i.store.data.items[t].get("name")==e){o=i.getView().getNode(t);break}o&&(s=!0,-1<(a=$(o).offset().top-$(i.el.dom).offset().top+$(o).height()/2)&&a<l?r=!0:(a=a<0?0:a,a=Math.min(a,l)))}if(0==s){if(l=(i=this.g_fields).getHeight(),e){for(t=0;t<i.store.data.items.length;t++)if(i.store.data.items[t].get("name")==e){o=i.getView().getNode(t);break}}else a=l;o&&(-1<(a=$(o).offset().top-$(i.el.dom).offset().top+$(o).height()/2)&&a<l?r=!0:(a=a<0?0:a,a=Math.min(a,l)))}return a&&(n.d=a),n.ranged=r,n},adjHeight:function(){var e,t,o=this,i=o.getHeight();o.fixKeyVal&&(0==(e=o.g_key.store.data.items.length)?o.g_key.setVisible(!1):(o.g_key.setVisible(!0),t=Math.min(22*e+2,.4*i),o.g_key.setHeight(t)),o.cpa.validateLinks.call(o.cpa))},searchField:function(){var e=this;e.__s&&clearTimeout(e.__s),e.__s=setTimeout(function(){e.searchFlt.call(e)},40)},searchFlt:function(){var e=this.down("[name=g_fields]").store,i=this.down("[name=skey]").getValue();i?(i=i.toLowerCase(),e.clearFilter(!0),e.filterBy(function(e){var t=e.get("name").toLowerCase(),o=(o=e.get("alias")||"").toLowerCase();return-1<t.indexOf(i)||-1<o.indexOf(i)})):e.clearFilter(!1)},items:[{xtype:"container",hidden:"CubeModel"!=a.table._mc.type,layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",name:"stables",flex:1,displayField:"name",valueField:"uid",store:{},listeners:{change:function(e){e.getValue()&&(a.innerGrid.table._tables=a.innerGrid.table._tables||{},a.innerGrid._loadField(e.getValue()))},scope:this}},{xtype:"button",iconCls:"icon-refresh",tooltip:"Refresh",handler:{},scope:this}]},{xtype:"textfield",name:"skey",emptyText:"Search Items",enableKeyEvents:!0,listeners:{keyup:function(e,t,o){e.ownerCt.searchField.call(e.ownerCt)}}},{xtype:"gridpanel",name:"g_key",border:0,scroll:"vertical",autoScroll:!0,enableDragDrop:!0,enableDD:!0,useArrows:!0,header:!1,hideHeaders:!0,hidden:!0,cpa:l,ddGroup:"CubeModelFieldDDGroup",viewConfig:{emptyText:IRm$.r1("L_P_RELOAD"),plugins:{ptype:"gridviewdragdrop",ddGroup:"CubeModelFieldDDGroup"},listeners:{beforedrop:function(e,t,o,i){var a=t.records[0];return a&&o&&l.sobj.onDropField.call(l.sobj,a,o),!1},drop:function(e,t,o,i){o&&o.get("name")}}},store:{fields:["name","nodepath","datasize","datatype","tablename","type","selected","seq","alias","tableuid"]},afterScroll:function(){this.cpa.validateLinks.call(this.cpa)},columns:[{xtype:"checkcolumn",dataIndex:"selected",enableColumnHide:!1,checkedAll:!1,width:30,editor:{xtype:"checkbox",cls:"x-grid-checkheader-editor"},listeners:{checkchange:function(e,t,o,i){for(var a=s.innerGrid.g_fields.store.data.items[t].get("nodepath"),l=s.table,n=0;n<l.fields.length;n++)if(l.fields[n].nodepath==a){l.fields[n].selected=o;break}},headerclick:function(e,t,o,i,a){var l,n=e.ownerCt,r=s.table;if("checkcolumn"==t.xtype){for(t.checkedAll=!t.checkedAll,l=0;l<n.store.data.items.length;l++)n.store.data.items[l].set("selected",t.checkedAll);for(l=0;l<r.fields.length;l++)r.fields[l].selected=t.checkedAll}}}},{header:"Name",dataIndex:"name",sortable:!0,hideable:!1,flex:1},{header:"Alias",dataIndex:"alias",sortable:!0,hideable:!1,hidden:!0,flex:1}],listeners:{afterrender:function(e){this.getView().on("bodyscroll",this.afterScroll,this)},scrollershow:function(e,t,o){}}},{xtype:"gridpanel",name:"g_fields",border:0,scroll:"vertical",autoScroll:!0,enableDragDrop:!0,enableDD:!0,useArrows:!0,header:!1,hideHeaders:!0,flex:1,cpa:l,ddGroup:"CubeModelFieldDDGroup",viewConfig:{emptyText:IRm$.r1("L_P_RELOAD"),plugins:{ptype:"gridviewdragdrop",ddGroup:"CubeModelFieldDDGroup"},listeners:{beforedrop:function(e,t,o,i){var a=t.records[0];return a&&o&&l.sobj.onDropField.call(l.sobj,a,o),!1},drop:function(e,t,o,i){o&&o.get("name")}}},store:{fields:["name","nodepath","datasize","datatype","tablename","type","selected","seq","alias","tableuid"]},afterScroll:function(){this.cpa.validateLinks.call(this.cpa)},columns:[{xtype:"checkcolumn",dataIndex:"selected",enableColumnHide:!1,checkedAll:!1,width:30,editor:{xtype:"checkbox",cls:"x-grid-checkheader-editor"},listeners:{checkchange:function(e,t,o,i){for(var a=s.innerGrid.g_fields.store.data.items[t].get("nodepath"),l=s.table,n=0;n<l.fields.length;n++)if(l.fields[n].nodepath==a){l.fields[n].selected=o;break}},headerclick:function(e,t,o,i,a){var l,n=e.ownerCt,r=s.table;if("checkcolumn"==t.xtype){for(t.checkedAll=!t.checkedAll,l=0;l<n.store.data.items.length;l++)n.store.data.items[l].set("selected",t.checkedAll);for(l=0;l<r.fields.length;l++)r.fields[l].selected=t.checkedAll}}}},{header:"Name",dataIndex:"name",sortable:!0,hideable:!1,flex:1},{header:"Alias",dataIndex:"alias",sortable:!0,hideable:!1,hidden:!0,flex:1}],listeners:{afterrender:function(e){this.getView().on("bodyscroll",this.afterScroll,this)},scrollershow:function(e,t,o){}}}],bbar:[{xtype:"button",iconCls:"icon-tb-alias",tooltip:"Alias",handler:function(){var e=this.innerGrid,t=this.innerGrid.g_key,o=this.innerGrid.g_fields.columns,i=t.columns;switch("physical"==e.viewmode?e.viewmode="logical":"logical"==e.viewmode?e.viewmode="both":e.viewmode="physical",e.viewmode){case"physical":o[1].show(),o[2].hide(),i[1].show(),i[2].hide();break;case"logical":o[1].hide(),o[2].show(),i[1].hide(),i[2].show();break;default:o[1].show(),o[2].show(),i[1].show(),i[2].show()}},scope:s},{xtype:"button",iconCls:"icon-tb-refresh",tooltip:"Refresh",handler:function(){var e,t=this;t.innerGrid.g_fields;"cubemodel"==t.table._mc.type.toLowerCase()?(e=t.innerGrid.down("[name=stables]")).getValue()&&(t.table._tables=t.table._tables||{},t.innerGrid._loadField(e.getValue())):t.main.loadTableContent.call(t.main,t.table)},scope:s},{xtype:"button",iconCls:"icon-tb-preview",tooltip:"Preview",handler:function(){this.main.previewSQL.call(this.main,this.table)},scope:s},{xtype:"displayfield",value:"",name:"m_disp"}],listeners:{afterrender:function(e){var t=this;t.fixKeyVal=t.cpa.sobj.fixKeyMode,t.g_key=t.down("[name=g_key]"),t.g_fields=t.down("[name=g_fields]"),t.m_disp=t.down("[name=m_disp]"),t.loadData()},scrollershow:function(e,t,o){},resize:function(e,t,o,i,a,l){n.validateSize.call(n)},startmove:function(e){e.$ex&&(e.$ex.config.zoomRatio=n.zoomRatio)},move:function(e,t,o,i){(t<0||o<0)&&this.setPosition(t<0?0:t,o<0?0:o),n.validateSize.call(n)},close:function(e,t){l.removeTbl.call(l,s)}}})},IG$.tableBox.prototype={fixKeyMode:function(e){this.table.fixKeyMode!=e&&(this.table.fixKeyMode=e,this.innerGrid.fixKeyMode.call(this.innerGrid,e))},collapsePanel:function(e){var t=this.pobj;this.table._mc.width,this.table._mc.theight;this.innerGrid.setVisible(!0),t.validateSize.call(t),t.validateLinks.call(t)}},IG$.LinkField=function(e,t,o,i,a){var l=this;l.pobj=e,l.fromobj=t,l.toobj=o,l.links=[i],l.relations=a,l._fromDir="",l._toDir="",l.lineMode=e.lineMode},IG$.LinkField.prototype={validateDirection:function(e){var t=$(this.fromobj.box.innerGrid.body.dom),o=t.offset(),i=$(this.toobj.box.innerGrid.body.dom),a=i.offset(),l=IG$.j$ext._w(t)*e,n=IG$.j$ext._w(i)*e;o.left+l<a.left?(this._fromDir="right",this._toDir="left"):(a.left+n<o.left?this._fromDir="left":(o.left,a.left,this._fromDir="right"),this._toDir="right")},showLinkEditor:function(e,t){new IG$.linkEditor({pobj:this.pobj,link:e,links:t,relations:this.relations,callback:new IG$.callBackObj(this,this.rs_showLinkEditor)}).show(null)},rs_showLinkEditor:function(e){var t,o=e[0];switch(e[1]){case"remove":this.pobj.sobj.updateJoinFields.call(this.pobj.sobj),this.pobj.sobj.validateLinks.call(this.pobj.sobj),this.pobj.validateLinks.call(this.pobj);break;case"confirm":for(t=0;t<this.links.length;t++)this.links[t]!=o[0]&&(this.links[t].join=o[0].join);this.pobj.validateLinks.call(this.pobj)}},refresh:function(e,d){var c,h,f,p,b,m,t,u=this,g=1,_=u.fromobj,v=u.toobj,x=u.links,y=u.pobj.rcanvas,w={stroke:"#8d8d8d","stroke-width":1,fill:"none",opacity:1},k={stroke:"#8d8d8d",fill:"#8d8d8d",opacity:1},o=u.pobj.zoomRatio,j=1/o;u.links&&1<u.links.length&&1==d&&(g=1.5*u.links.length),u.validateDirection(o),t=1==d&&0<x.length?[x[0]]:x,$.each(t,function(e,t){if(t){var o=u._fromDir,i=u._toDir;t.p1dist=void 0===t.p1dist?null:t.p1dist,t.source.tablename==v._mc.name&&t.target.tablename==_._mc.name&&t.source.seq==v._mc.seq&&t.target.seq==_._mc.seq?(_=u.toobj,v=u.fromobj,o!=i&&(o="right"==o?"left":"right",i="right"==i?"left":"right")):(_=u.fromobj,v=u.toobj),m=1==x.length||0==d?x[e].source.name:null,c={x:_.stageX()*j,y:_.stageY(m)*j},m=1==x.length||0==d?x[e].target.name:null,p={x:v.stageX()*j,y:v.stageY(m)*j},1==_.ranged&&1==v.ranged?(w.stroke="#000000",w["stroke-width"]=g,k.stroke="#000000",k.fill="#000000"):1<g?(w.stroke="#000000",w["stroke-width"]=g,k.stroke="#000000",k.fill="#000000"):0,"right"==o?(c.x+=_.bodyWidth(),h={x:c.x+10,y:c.y}):"left"==o&&(h={x:c.x-10,y:c.y}),"right"==i?(p.x+=v.bodyWidth(),f={x:p.x+10,y:p.y}):"left"==i&&(f={x:p.x-10,y:p.y}),b=0<(b=IG$.lineInterpolate(h,f,3)).length?b[1]:null,x&&0<x.length&&"RIGHT OUTER"==x[0].join?"right"==i?y.path("M"+p.x+" "+(p.y+10)+"L"+(p.x+10)+" "+p.y+"L"+p.x+" "+(p.y-10)).attr(w):y.path("M"+p.x+" "+(p.y+10)+"L"+(p.x-10)+" "+p.y+"L"+p.x+" "+(p.y-10)).attr(w):x&&0<x.length&&"LEFT OUTER"==x[0].join&&("right"==o?y.path("M"+c.x+" "+(c.y+10)+"L"+(c.x+10)+" "+c.y+"L"+c.x+" "+(c.y-10)).attr(w):y.path("M"+c.x+" "+(c.y+10)+"L"+(c.x-10)+" "+c.y+"L"+c.x+" "+(c.y-10)).attr(w)),y.path("M"+c.x+" "+c.y+"L"+h.x+" "+h.y+"L"+f.x+" "+f.y+"L"+p.x+" "+p.y).attr(w);var a,l=1==x.length||1==d?x:[x[e]],n=$("<div class='igc-cm-join'><span></span></div>").appendTo(u.pobj.scrollbar),r="",s=$("span",n);if(1==d)for(e=0;e<x.length;e++)0<e&&(r+="\n"),r+=x[e].source.name,x[e].source.name!=x[e].target.name&&(r+=" - "+x[e].target.name);else r=t.source.name+" - "+t.target.name;s.html(r),n.attr("title",r),a=Math.min(s.width()/2||30,20),n.css({left:b.x-a,top:b.y}),n.bind("click",function(e){e.preventDefault(),e.stopPropagation(),u.showLinkEditor.call(u,l,x)}),u.pobj._ca.push(n)}})}};
IG$.linkFieldEditor=$s.extend($s.window,{title:"Join (Relation) Custom Field",modal:!0,region:"center",layout:"fit",closable:!1,resizable:!1,width:420,_init:function(){var e=this,t=e._target;t&&(e.down("[name=t_disp]").setValue(t.name),e.down("[name=t_value]").setValue(e.joinobj[e.fieldname]))},_confirm:function(){var e=this;e._target&&(e.joinobj[e.fieldname]=e.down("[name=t_value]").getValue()),e.callback&&e.callback.execute(),e.close()},initComponent:function(){$s.apply(this,{padding:10,items:[{xtype:"container",layout:{type:"vbox",align:"stretch"},padding:10,items:[{xtype:"displayfield",name:"t_disp"},{xtype:"textarea",name:"t_value",height:120},{xtype:"displayfield",value:"Field in formula, Use {FIELD}. Ex: SUBSTR({FIELD}, 1, 6)"}]}],buttons:[{text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this._init()}}}),IG$.linkFieldEditor.superclass.initComponent.apply(this,arguments)}}),IG$.linkEditor=$s.extend($s.window,{title:"Join (Relation) Editor",modal:!0,region:"center",layout:"fit",closable:!1,resizable:!1,width:420,autoHeight:!0,callback:null,_curLink:null,_init:function(){if(this._curLink=null,this.link&&0<this.link.length){var e,t,i=this.down("[name=selR]"),n=this.down("[name=btn_upd]"),l=[];if(1<this.link.length){for(i.setVisible(!0),n.setVisible(!0),e=0;e<this.link.length;e++)t=this.link[e],l.push({name:t.source.tablename+"."+t.source.name+" - "+t.target.tablename+"."+t.target.name,__i:e});i.store.loadData(l),i.setValue(0)}this.setFieldValue(this.link[0])}},setFieldValue:function(e){var t=this,i=t.down("[name=sfield]"),n=t.down("[name=tfield]"),l=t.down("[name=oprel]");e&&(t._curLink=e,i.setValue(t.getDispName(e.source)),n.setValue(t.getDispName(e.target)),l.setValue(e.join))},getDispName:function(e){return e.formula?e.formula.replace("{FIELD}",e.name):e.tablename+"."+e.name},removeLink:function(){var e,t,i=this,n=0,l=i.down("[name=selR]"),a=i.link,o=i.relations,s=i._curLink,r=i.pobj.links;if(1<a.length){for(d=0;d<o.length;d++)if(o[d]==s){o.splice(d,1);break}for(d=0;d<a.length;d++)if(a[d]==s){a.splice(d,1),n=1;break}for(d=0;d<r.length;d++){for(e=t=0;e<r[d].links.length;e++)if(r[d].links[e]==s){r[d].links.splice(e,1),t=1;break}if(t){0==r[d].length&&r.splice(d,1);break}}if(n){for(var c=l.getValue(),d=0;d<l.store.data.items.length;d++)if(l.store.data.items[d].get("__i")==c){l.store.removeAt(d);break}1==l.store.data.items.length&&l.hide(),0<l.store.data.items.length&&l.setValue(l.store.data.items[0].get("__i"))}for(d=0;d<l.store.data.items.length;d++)l.store.data.items[d].set("__i",d);i.callback&&i.callback.execute([a,"remove"])}else{for(d=0;d<o.length;d++)if(o[d]==s){o.splice(d,1);break}for(d=0;d<r.length;d++){for(e=n=0;e<r[d].links.length;e++)if(r[d].links[e]==s){r[d].links.splice(e,1),n=1;break}if(n){0==r[d].length&&r.splice(d,1);break}}i.callback&&i.callback.execute([a,"remove"]),i.close()}},confirmChanges:function(){var e=this.down("[name=oprel]"),t=this._curLink;t&&(t.join=e.getValue(),t.operator="=")},_confirm:function(){var e=this;e.confirmChanges(),e.callback&&e.callback.execute([e.link,"confirm"]),e.close()},editField:function(e){var t,i=this,n=i._curLink,l=i.down("[name="+(e?"s":"t")+"field]"),a=e?n.source:n.target,o=(e?"source":"target")+"_field_formula";a&&(t=new IG$.linkFieldEditor({joinobj:n,_target:a,fieldname:o,callback:new IG$.callBackObj(i,function(){l.setValue(this.getDispName(a))})}),IG$.checkLogin(i,t))},initComponent:function(){$s.apply(this,{padding:10,items:[{xtype:"form",layout:{type:"vbox",align:"stretch"},padding:10,items:[{xtype:"combobox",fieldLabel:"Relation",name:"selR",hidden:!0,queryMode:"local",autoSelect:!0,autoScroll:!0,editable:!1,labelField:"name",displayField:"name",valueField:"__i",store:{fields:["name","__i"]},listeners:{change:function(e,t,i,n){var l=e.getValue();this.setFieldValue(this.link[l])},scope:this}},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},name:"sfield_cnt",items:[{xtype:"textfield",name:"sfield",fieldLabel:"Source field",readOnly:!0,flex:1},{xtype:"button",text:"..",handler:function(){this.editField(!0)},scope:this}]},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},name:"tfield_cnt",items:[{xtype:"textfield",name:"tfield",fieldLabel:"Target field",readOnly:!0,flex:1},{xtype:"button",text:"..",handler:function(){this.editField(!1)},scope:this}]},{xtype:"fieldset",layout:{type:"vbox",align:"stretch"},defaults:{labelWidth:150},title:"Options",items:[{xtype:"combobox",name:"oprel",fieldLabel:"Source to Target data is",queryMode:"local",autoSelect:!0,editable:!1,valueField:"op",displayField:"name",labelField:"name",$w:390,store:{fields:["name","op","desc"],data:[{name:"Inner equal",op:"INNER",desc:"Show only match values"},{name:"Left outer",op:"LEFT OUTER",desc:"Show all source values even not match"},{name:"Right outer",op:"RIGHT OUTER",desc:"Show all target values even not match"},{name:"Auto natural",op:"NATURAL",desc:"Automatic join with column foreign key"},{name:"Full outer",op:"FULL OUTER",desc:"Show all source and target values"}]},listeners:{change:function(e){for(var t,i,n=e.getValue(),l=this.down("[name=op_desc]"),a=0;a<e.store.data.items.length;a++)if((i=e.store.data.items[a]).get("op")==n){t=i;break}t&&l.setValue("* "+t.get("desc"))},scope:this}},{xtype:"displayfield",name:"op_desc"}]},{xtype:"container",layout:{type:"hbox",align:"right"},items:[{xtype:"button",name:"btn_upd",text:"Confirm current",hidden:!0,handler:function(){this.confirmChanges()},scope:this},{xtype:"button",text:"Remove Relation",handler:function(){this.removeLink()},scope:this}]}]}],buttons:[{text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this._init()}}}),IG$.linkEditor.superclass.initComponent.apply(this,arguments)}});
IG$.CubeModel=$s.extend(IG$.v$pnl,{collapseFirst:!1,bodyBorder:!1,layout:"fit",defaults:{collapsible:!1,split:!1,animFloat:!1,autoHide:!1,useSplitTips:!0},initialized:!1,closable:!0,overflowX:"hidden",overflowY:"hidden",iconCls:"icon-cubemodel",_init:function(){var t=this,e=t.down("[name=mcontainer]");t.m=new IG$.cubeModelViewer($(e.body.dom),t),t.m.init(),t.uid?(t.load_content(),t.down("[name=t_save]").setVisible(t.writable),t.writable&&IG$.checkLock(t,function(e){"unlock"!=e&&(t.writable=!1,t.down("[name=t_save]").hide())})):t._c$?t.rs_load_content(t._c$):(t.cubemodel=new IG$.m$CubeModel(null),t.loadPool())},load_content:function(){var e=this,t=new IG$._rpc$;t.init(e,{ack:"content",payload:{address:e.uid},mbody:{option:"diagnostics"}},e,e.rs_load_content,null),t.send()},rs_load_content:function(e){var t,i,n=this;n.cubemodel=new IG$.m$CubeModel(e.content),!(i=n.cubemodel._mc).datasource&&n.obj_uid?i.datasource={uid:n.obj_uid}:n.obj_uid&&(i.datasource.uid=n.obj_uid),n.obj_uid=i.datasource.uid,n.cubemodel.datasource={uid:i.datasource.uid||n.obj_uid},t={type:"ROOT",name:"DataSource",uid:n.obj_uid,leaf:!1,children:[{type:"load",name:"Loading..."}]},(t=n.down("[name=mtree]").setRootNode(t)).expand(),n.loadPool()},loadPool:function(){this.validateTables(),this.validateJoins()},updatePoolInfo:function(e,t){for(var i,n,a,o,l=0;l<e.length;l++)if((o=e[l]).dispname=o.name,17<o.dispname.length&&"_"==o.dispname.charAt(17)&&(o.dispname=o.dispname.substring(18)),o.children)for(a=o.children,i=0;i<a.length;i++)n=a[i],t.push({value:n.uid,name:o.dispname+"-"+n.name});else t.push({value:"",name:o.dispname+"-ERROR(No Schema)"})},updateUsedTable:function(){var e,t=this.down("[name=grid_st]").store,i=this.cubemodel,n={};if(t.data.items.length){for(e=0;e<i.tables.length;e++)n[i.tables[e]._mc.uid]=1;for(e=0;e<t.data.items.length;e++)t.data.items[e].set("used",n[t.data.items[e].get("uid")]?"*":"")}},loadTableContent:function(l,s,d){var e=new IG$._rpc$,t=l._mc;e.init(this,{ack:"tablecontent",payload:{uid:t.uid,nodepath:t.nodepath,name:t.name,option:"StoredContent"},mbody:{option:"folder",readcontent:"T"}},this,function(e){var t,i,n,a=e.length?e[0]:null,o=(a&&a.content,[]);if(a&&a.children)for(t=a.children,n=0;n<t.length;n++)(i=t[n].content).tablename=l._mc.name||i.tablename,i.alias=i.alias||i.name,i.iskey=i.iskey,i.leaf=!0,i.dispname=i.name,i.allowDrag=!0,i.seq=l._mc.seq,i.tableuid=l._mc.uid,o.push(i);l._mc.columns=o,(!s||s&&d)&&(this.validateTables(),this.validateJoins())},null),e.send()},previewSQL:function(e){var t=new IG$.dlgLoadPreview({table:e});IG$.checkLogin(this,t)},updateJoinFields:function(){for(var e,t,i,n,a,o,l,s=this.cubemodel,d=0;d<s.tables.length;d++){for(i=(t=s.tables[d])._mc,tname=i.name+"_"+i.seq,i.columns=i.columns||[],e=0;e<i.columns.length;e++)i.columns[e].hasjoin=!1;for(n=0;n<s.relations.length;n++)if(r=s.relations[n],a=r.source.tablename+"_"+r.source.seq,o=r.target.tablename+"_"+r.target.seq,l=a==tname?r.source.name:o==tname?r.target.name:null)for(e=0;e<i.columns.length;e++)if(i.columns[e].name==l){i.columns[e].hasjoin=!0;break}t.box&&t.fixKeyMode&&t.box.innerGrid.loadData.call(t.box.innerGrid)}},validateTables:function(a){var o,l,s,d,r,c=this,u=c.cubemodel,h=c.m;c.tablemap=c.tablemap||{},c.updateJoinFields(),$.each(u.tables,function(e,t){var i,n=t._mc;l=n.x,s=n.y,d=n.width,r=n.height,n.theight||n.height,i=n.uid+"_"+n.seq,t.box?t.box.innerGrid.loadData.call(t.box.innerGrid):(o=h.addBox.call(h,l,s,d,r,t,c),t.box=o,a&&c.loadTableContent.call(c,t,a,e==u.tables.length-1)),c.tablemap[i]=t}),h.validateSize.call(h)},validateJoins:function(){for(var e,t,i,n=this,a=n.cubemodel,o=n.m,l=a.relations.length-1;0<=l;l--)e=a.relations[l],t=n.tablemap[(e.source.model||e.source.tableuid)+"_"+e.source.seq],i=n.tablemap[(e.target.model||e.target.tableuid)+"_"+e.target.seq],t&&i?e.bl||(e.bl=o.addLink.call(o,t,i,e,a.relations)):a.relations.splice(l,1);n.updateJoinFields(),n.validateLinks(),o.validateLinks.call(o)},validateLinks:function(){for(var e,t,i,n=this.down("[name=mRel]"),a=[],o=this.m.relations||[],l=0;l<o.length;l++)t=(e=o[l]).source,i=e.target,t&&i&&a.push({s0:t.tablename,t0:i.tablename,s1:t.seq,t1:i.seq,s2:t.name,t2:i.name,r0:e.join,sdesc:t.tablename+"."+t.name,tdesc:i.tablename+"."+i.name,l:e});n.store.loadData(a)},onDropRecord:function(e,t){var i,n=t,a=this.cubemodel,o=this.m.viewer.offset(),l=new IG$.m$TblObj(null),s=l._mc={};for(IG$.CopyObject(n,l._mc,"nodepath;name;type;uid;memo;schemaname;alias"),s.x=e.getX()-o.left,s.y=e.getY()-o.top,s.width=180,s.height=200,s.seq=0,l.fields=[],i=0;i<a.tables.length;i++)a.tables[i]._mc.uid==s.uid&&(s.seq=Math.max(s.seq,a.tables[i]._mc.seq+1));a.tables.push(l),this.updateUsedTable(),this.loadTableContent(l)},updateModel:function(){var e,t,i,n,a,o,l,s,d,r,c=this.m,u=c.scrollPanel.offset(),h=this.cubemodel,m=h._mc,b={},f=1/c.zoomRatio;for(m.tables=[],m.joins=[],m.securityfilter=[],e=0;e<h.relations.length;e++)d={join:(r=h.relations[e]).join,operator:r.operator,source:r.source,target:r.target,source_field_formula:r.source_field_formula,target_field_formula:r.target_field_formula},b[r.source.uid]=1,b[r.target.uid]=1,m.joins.push(d);for(e=0;e<h.tables.length;e++){if(s=(i=h.tables[e])._mc,(l=IG$.copyObject(s)).columns=[],n=i.box.innerGrid,a=(o=$(n.$ex.$view)).offset(),l.x=(a.left-u.left)*f,l.y=(a.top-u.top)*f,l.width=o.width(),l.height=o.height(),l.theight=l.height,s.columns)for(t=s.columns.length-1;0<=t;t--)(s.columns[t].iskey||b[s.columns[t].uid])&&l.columns.push(s.columns[t]);m.tables.push(l)}if(h.securityfilter)for(e=0;e<h.securityfilter.length;e++)m.securityfilter.push(h.securityfilter[e])},saveContent:function(e){var t=this;t.updateModel(),t.fireEvent("_model_updated");var i=t.cubemodel,n=i.getXML.call(i),a=new IG$._rpc$,o=e?{pid:i.item.pid,address:i.item.address,name:i.item.name,type:"CubeModel"}:{uid:t.uid};a.init(t,{ack:"writecontent",payload:o,mbody:n,meta_type:"cubemodel"},t,function(e){this.uid=e.uid,this.setTitle(e.name),IG$.alertmsg(ig$.appname,IRm$.r1("M_SAVED"),null,null,0,"success")},null),a.send()},onDropField:function(e,t){var i,n,a=this,o=a.cubemodel,l=a.m,s={join:"inner",operator:"="};s.source=e.data,s.target=t.data,o.relations.push(s),a.updateJoinFields(),i=a.tablemap[(s.source.model||s.source.tableuid)+"_"+s.source.seq],n=a.tablemap[(s.target.model||s.target.tableuid)+"_"+s.target.seq],i&&n&&(s.bl=l.addLink.call(l,i,n,s,o.relations),a.validateLinks(),l.validateLinks.call(l))},toolbarHandler:function(e){var t,i=this,n=i.m;switch(e){case"cmd_save":i.uid?i.saveContent():i.saveAsContent(!1);break;case"cmd_saveas":i.saveAsContent(!1);break;case"cmd_simple_view":i.cubemodel.groupview=!i.cubemodel.groupview,n.validateLinks.call(n);break;case"cmd_fix_key":var a=i.cubemodel;for(a.fixKeyMode=!a.fixKeyMode,t=0;t<a.tables.length;t++)a.tables[t].box.fixKeyMode.call(a.tables[t].box,a.fixKeyMode);break;case"cmd_autojoin":i.auto_join();break;case"cmd_load_fields":i.load_fields();break;case"cmd_beutify":i.beutify_diagram();break;case"cmd_table_order":new IG$.dlgTableOrder({cubemodel:i.cubemodel}).show(i);break;case"cmd_refresh_table":i.down("[name=grid_st]").store.loadData([]),i._s1&&i.loadDatabaseTable(i._s1,"StoredContent",null,{readcontent:"T"})}},load_fields:function(){var i=this,e=i.cubemodel;e.tables.length&&$.each(e.tables,function(e,t){i.loadTableContent(t)})},auto_join:function(){var e,t,i,n,a,o,l=this.cubemodel,s={},d=[];if(1<l.tables.length){for(e=0;e<l.relations.length;e++)s[(a=(n=l.relations[e]).source.tableuid+"_"+n.source.fieldname)+":"+(o=n.target.tableuid+"_"+n.target.fieldname)]=1,s[o+":"+a]=1;for(e=0;e<l.tables.length;e++)for((i=l.tables[e])._cnames={},t=0;t<i._mc.columns.length;t++)i._cnames[i._mc.columns[t].fieldname]=i._mc.columns[t];for(e=0;e<l.tables.length;e++)i=l.tables[e],this.get_auto_join(l.tables,s,d,i);0<d.length?new IG$.JoinRec({joins:d,callback:new IG$.callBackObj(this,function(e){for(var t,i,n,a=this.m,o=0;o<e.length;o++)t=e[o],l.relations.push(t),i=this.tablemap[(t.source.model||t.source.tableuid)+"_"+t.source.seq],n=this.tablemap[(t.target.model||t.target.tableuid)+"_"+t.target.seq],i&&n&&(t.bl=a.addLink.call(a,i,n,t,l.relations));this.validateLinks(),a.validateLinks.call(a)})}).show():IG$.alertmsg(ig$.appname,"No join suggestions on this model",null,null,0,"success")}},get_auto_join:function(e,t,i,n){for(var a,o,l,s,d,r,c,u,h,m,b=n._mc,f=b.uid+"_",p=0;p<e.length;p++)if(m=e[p]._mc,b.uid!=m.uid&&(!b.external_name||b.external_name&&b.external_name!=m.external_name)){for(s=m.uid+"_",r=[],c=[],u=m.columns.length,h=!1,a=0;a<u;a++)d=m.columns[a].fieldname,n._cnames[d]&&(o=f+d,l=s+d,-1<d.indexOf("id")&&(h=!0),t[o+":"+l]||(r.push({join:"inner",operator:"=",source:n._cnames[d],target:m.columns[a]}),t[o+":"+l]=1,t[l+":"+o]=1),c.push(d));if((5<c.length&&5<u||c.length==u)&&h)for(a=r.length-1;0<=a;a--)r[a].source.fieldname.indexOf("id")<0&&r.splice(a,1);for(a=0;a<r.length;a++)i.push(r[a])}},beutify_diagram:function(){var e,t,i,n,a=this,o=a.cubemodel,l=[],s=[],d={},r={},c=[];if(1<o.tables.length&&1<o.relations.length){for(f=0;f<o.relations.length;f++)r[(i=o.relations[f]).source.tableuid]=r[i.source.tableuid]||[],r[i.source.tableuid].push(i),r[i.target.tableuid]=r[i.target.tableuid]||[],r[i.target.tableuid].push(i);for(f=0;f<o.tables.length;f++)(n=o.tables[f]).parent=null,n.childnodes=[],n.jointable=[],d[n._mc.uid]=n,c.push(n);for(;0<c.length;)if(r[(n=c[0])._mc.uid])for(e={fact_table:null,tables:[]},t=r[n._mc.uid],f=0;f<t.length;f++)e.tables.push(n),l.push(e),c.splice(0,1),a.gather_join_tables(c,r,d,t[f],e,n);else s.push(n),c.splice(0,1);if(0<l.length)for(f=0;f<l.length;f++)a.update_table_hierarchy(d,l[f]);for(var u,h=10,m=10,b=0,f=0;f<s.length;f++)h+=(u=a.update_position(h,m,10,s[f])).x,b=Math.max(b,u.y);for(m+=b+10,h=10,f=0;f<l.length;f++)m=(u=a.update_position(h,m,10,l[f].fact_table)).y}},update_table_hierarchy:function(e,t){var i={};t.tables.sort(function(e,t){var i=e.jointable.length;return t.jointable.length-i}),t.fact_table=t.tables[0],i[t.fact_table._mc.uid]=1,this.update_linklist(e,t.fact_table,i)},update_linklist:function(e,t,i){for(var n,a=0;a<t.jointable.length;a++)i[(n=t.jointable[a])._mc.uid]||(i[n._mc.uid]=1,t.childnodes.push(n),t.jointable[a].parent=t,this.update_linklist(e,n,i))},update_position:function(e,t,i,n){var a,o=e,l=t,s=0;if(n.box.innerGrid.setPosition(e,t),l+=n._mc.height,n.childnodes&&n.childnodes.length){for(l+=i,a=0;a<n.childnodes.length;a++)this.update_position(o,l,i,n.childnodes[a]),o+=n._mc.width+i,s=Math.max(s,n._mc.height);l+=s}return{x:o,y:l}},gather_join_tables:function(e,t,i,n,a,o){for(var l,s,d,r=n.source.tableuid==o._mc.uid?n.target:n.source,c=0;c<e.length;c++)if(e[c]._mc.uid==r.tableuid){if(d=e[c],a.tables.push(d),e.splice(c,1),o.jointable.push(d),d.jointable.push(o),s=t[d._mc.uid])for(l=0;l<s.length;l++)this.gather_join_tables(e,t,i,s[l],a,d);break}},loadDatabaseTable:function(e,t,i,n){var a,o=e.get("nodepath"),l=new IG$._rpc$,s={address:o,option:t,search:i,uid:e.get("uid")};if(n)for(a in n)s[a]=n[a];s.subfolder="T",l.init(this,{ack:"content",payload:s,mbody:s},this,this.rs_loadDatabaseTable,!1,[e,t]),l.send()},rs_loadDatabaseTable:function(e,t){t[0];var i,n,a,o=t[1],l=e.children||[],s=[],d=!!o,r=this.down("[name=grid_st]"),c=this.cubemodel,u={};if(l){for(c.tables=c.tables||[],i=0;i<c.tables.length;i++)u[c.tables[i]._mc.uid]=1;for(i=0;i<l.length;i++)a=(n=d?l[i].content:l[i]).type.toLowerCase(),n.uid=n.uid||""+i,n.uid!=this.uid&&(u[n.uid]&&(n.used="*"),"cubemodel"!=a&&(n.physical_name=n.attributes.attrb3),n.iconcls=IG$.get_metatype_icon(a),s.push(n))}r.store.loadData(s)},saveAsContent:function(e){var t=new IG$.metaSelectDlg({mode:"newitem",tree_options:{rootuid:this.obj_uid},callback:new IG$.callBackObj(this,this.saveNewContent,e)});IG$.checkLogin(this,t)},saveNewContent:function(e,t){this.cubemodel.item={name:e.name,address:e.nodepath+"/"+e.name,pid:e.uid},this.saveContent(!0)},_r_join:function(e){for(var t,i=this.cubemodel,n=this.m,a=i.relations,o=0;o<a.length;o++)if(a[o]==e){a.splice(o,1);break}for(o=0;o<n.links.length;o++){for(t=!1,j=0;j<n.links[o].links.length;j++)if(n.links[o].links[j]==e){n.links[o].links.splice(j,1),t=!0;break}if(1==t){0==n.links[o].length&&n.links.splice(o,1);break}}this.updateJoinFields(),this.validateLinks(),n.validateLinks.call(n)},searchRelationship:function(){var a=this.down("[name=txt_rel]").getValue(),e=this.down("[name=mRel]").store;e.clearFilter(),a&&(a=a.toLowerCase(),e.filterBy(function(e){for(var t=[e.get("s0"),e.get("s2"),e.get("t0"),e.get("t2")],i=!1,n=0;n<t.length;n++)if(t[n]&&-1<t[n].toLowerCase().indexOf(a)){i=!0;break}return i}))},rs_custom_click_func:function(e,t,i){this._s1=e,this.toolbarHandler("cmd_refresh_table")},initComponent:function(){var a=this;$s.apply(this,{items:[{xtype:"panel",layout:"border",split:!0,items:[{xtype:"panel",region:"west",width:250,hideHeaders:!0,title:"Table Lists",layout:{type:"vbox",align:"stretch"},items:[new IG$.n$navTreeCom({name:"mtree",rootuid:this.obj_uid,visibleItems:"folder;dataset;",flex:1,showCustomMenu:function(e){var t=this.customMenu,i=e.get("type").toLowerCase(),n=e.get("name"),a=e.get("nodepath"),o=e.get("uid"),l=(e.get("type"),1==e.get("writable")||1==e.get("manage")),s=1==e.get("manage"),d=!1;return t.removeAll(),(l||s)&&(d=!0,"folder"==i&&t.add({text:IRm$.r1("B_FOLDER"),hidden:ig$.features.ig_n_f_f,handler:function(){this._createMetaObject.call(this,"Folder",o,a,e)},scope:this}),t.add({text:IRm$.r1("L_RENAME_ITEM",n),hidden:ig$.features.ig_n_ren,handler:function(){this._renameMetaObject.call(this,n,o,a,record)},scope:this}),t.add({text:IRm$.r1("L_DELETE_ITEM",n),hidden:ig$.features.ig_n_del,handler:function(){this.deleteMetaObject.call(this,o,record)},scope:this})),d},custom_expand_func:new IG$.callBackObj(a,function(e){this.rs_custom_click_func(e,1,0)}),custom_click_func:new IG$.callBackObj(a,function(e,t){this.rs_custom_click_func(e,0,1)})}),{xtype:"gridpanel",name:"grid_st",flex:2,title:"Registered Table",emptyText:IRm$.r1("M_S_S2"),plain:!0,store:{showcheckselect:!0,fields:["name","type","uid","nodepath","dispname","checked","allow_insert","allow_insert_desc","iconcls","physical_name"]},enableDragDrop:!0,enableDD:!0,columns:[{text:"",width:20,dataIndex:"used"},{xtype:"templatecolumn",text:IRm$.r1("B_NAME"),flex:2,sortable:!1,dataIndex:"name",tdCls:"igc-td-link",tpl:"<div class='ig-navi-itemicon-p'><div class='ig-navi-itemicon {iconcls}'></div></div><span class='ig-navi-text' title='{name} ({type})'>{name} </span>",editor:{allowBlank:!1}}],dockedItems:[{xtype:"toolbar",dock:"top",items:[{iconCls:"icon-refresh",tooltip:"Refresh",handler:function(){this.toolbarHandler("cmd_refresh_table")},scope:this},{xtype:"textfield",flex:1,name:"_filter",enableKeyEvents:!0,listeners:{keyup:function(e,t,i){13==t.keyCode&&IG$._dofilter(this,"grid_st",["name","alias"])},scope:this}},{xtype:"button",text:"..",handler:function(){IG$._dofilter(this,"grid_st",["name","alias"])},scope:this}]}],listeners:{cellclick:function(e,t,i,n,a,o,l,s){var d,r,c=e.store.getAt(o),u=this.cubemodel;if("*"==c.get("used")){for(d=0;d<u.tables.length;d++)if(u.tables[d]._mc.uid==c.get("uid")){r=u.tables[d];break}r&&this.m.focusTable(r)}},scope:this}}]},{type:"panel",html:"",split:!0,overflowX:"hidden",overflowY:"hidden",name:"mcontainer",region:"center"},{xtype:"panel",split:!0,title:"Relations",region:"east",name:"p_joins",hidden:!0,tools:[{type:"collapse"}],width:320,layout:{type:"vbox",align:"stretch"},items:[{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",fieldLabel:"Search",name:"txt_rel",labelWidth:40,labelAlign:"right",flex:1,enableKeyEvents:!0,listeners:{keyup:function(e,t,i){13==t.keyCode&&a.searchRelationship()},scope:this}},{xtype:"button",text:"..",handler:function(){a.searchRelationship()}}]},{xtype:"gridpanel",name:"mRel",flex:1,store:{fields:["s0","s1","s2","t0","t1","t2","r0","sdesc","tdesc","l"]},columns:[{text:"From",flex:1,dataIndex:"sdesc"},{text:"To",flex:1,dataIndex:"tdesc"},{xtype:"actioncolumn",width:45,items:[{iconCls:"icon-grid-config",tooltip:"Config item",handler:function(e,t,i){var n,a=e.store.getAt(t).get("l");a&&a.bl&&(n=a.bl).showLinkEditor.call(n,[n.links[0]],n.links)}},{iconCls:"icon-grid-delete",tooltip:"Delete item",handler:function(e,t,i){var n=e.store.getAt(t);a._r_join(n.get("l"))}}]}]}]}]}],tbar:[{iconCls:"icon-toolbar-save",name:"t_save",text:"Save",tooltip:IRm$.r1("L_SAVE_REPORT"),handler:function(){this.toolbarHandler("cmd_save")},scope:this},"-",{iconCls:"icon-toolbar-simple-view",tooltip:"Simple Relation View",handler:function(){this.toolbarHandler("cmd_simple_view")},scope:this},{iconCls:"icon-toolbar-table-order",tooltip:"Table order",handler:function(){this.toolbarHandler("cmd_table_order")},scope:this},"-",{iconCls:"icon-toolbar-fixkey",text:"Fix key",tooltip:"Fix Key columns",handler:function(){this.toolbarHandler("cmd_fix_key")},scope:this},{iconCls:"icon-toolbar-autojoin",text:IRm$.r1("L_AUTO_JOIN"),tooltip:"Auto Join",handler:function(){this.toolbarHandler("cmd_autojoin")},scope:this},{iconCls:"icon-toolbar-tablesort",text:IRm$.r1("L_JOIN_BEUTIFY"),tooltip:"sort",handler:function(){this.toolbarHandler("cmd_beutify")},scope:this},{iconCls:"icon-refresh",tooltip:"Refresh",handler:function(){this.toolbarHandler("cmd_load_fields")},scope:this},"-",{iconCls:"icon-toolbar-export",tooltip:"Print",handler:function(){this.toolbarHandler("cmd_print")},scope:this},"-",{tooltip:"Zoom In",iconCls:"icon-toolbar-zoomin",handler:function(){this.m.zoom(.1)},scope:this},{tooltip:"Zoom Out",iconCls:"icon-toolbar-zoomout",handler:function(){this.m.zoom(-.1)},scope:this},"->",{iconCls:"icon-joins",tooltip:"Joins",handler:function(){var e=this.down("[name=p_joins]");e.isVisible()?e.hide():e.show()},scope:this}],listeners:{afterrender:function(e){this._init()},resize:function(e){this.m.validateSize()},beforeclose:function(e,t){var i,n=this;return n.writable&&n.uid&&((i=new IG$._rpc$).init(n,{ack:"helpcontent",payload:{uid:n.uid},mbody:{option:"lock",detail:"close"}},n,function(e){},!1),i.send()),!0}}}),IG$.CubeModel.superclass.initComponent.call(this)}}),IG$.dlgTableOrder=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",closable:!0,resizable:!0,width:500,height:610,callback:null,_init:function(){var e,t,i,n=this.cubemodel,a=[],o=this.down("[name=grd_tables]");for(n.tables=n.tables||[],e=n.tables,t=0;t<e.length;t++)(i={uid:e[t]._mc.uid,name:e[t]._mc.name,seq:e[t]._mc.seq}).disp=i.seq?i.name+"("+i.seq+")":i.name,a.push(i);o.store.loadData(a)},confirmChanges:function(){for(var e,t,i=this.cubemodel.tables,n={},a=this.down("[name=grd_tables]"),o=0;o<a.store.data.items.length;o++)n[(e=a.store.data.items[o]).get("uid")+"_"+e.get("seq")]=o;for(o=0;o<i.length;o++)t=i[o]._mc.uid+"_"+i[o]._mc.seq,i[o].sortindex=n[t];i.sort(function(e,t){return e.sortindex-t.sortindex}),this.close()},changeOrder:function(e){var t,i,n=this.down("[name=grd_tables]"),a=n.getSelectionModel(),o=a.selected;o&&1==o.length&&(i=o.items[0],t=n.store.indexOf(i),-1==e?0<t&&(n.store.remove(i),i=n.store.insert(t-1,i),a.select(i,!0)):t+1<n.store.data.items.length&&(n.store.remove(i),i=n.store.insert(t+1,i),a.select(i,!0)))},initComponent:function(){this.title=IRm$.r1("L_TBL_ORD"),$s.apply(this,{defaults:{padding:10},items:[{xtype:"panel",layout:{type:"hbox",align:"stretch"},items:[{xtype:"gridpanel",flex:1,name:"grd_tables",store:{xtype:"store",fields:["name","uid","seq","disp"]},columns:[{xtype:"gridcolumn",flex:1,text:IRm$.r1("B_NAME"),dataIndex:"name"}]},{xtype:"container",padding:"0 0 0 5",layout:{type:"vbox",pack:"center",align:"stretch"},items:[{xtype:"container",flex:1},{xtype:"button",iconCls:"ig-btn-up",handler:function(){this.changeOrder(-1)},scope:this},{xtype:"container",height:10},{xtype:"button",iconCls:"ig-btn-down",handler:function(){this.changeOrder(1)},scope:this},{xtype:"container",flex:1}]}]}],buttons:[{text:IRm$.r1("B_CONFIRM"),handler:function(){this.confirmChanges()},scope:this},{text:IRm$.r1("B_CLOSE"),handler:function(){this.close()},scope:this}]}),IG$.dlgTableOrder.superclass.initComponent.apply(this,arguments)},listeners:{afterrender:function(e){e._init.call(e)}}}),IG$.dlgLoadPreview=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",closable:!0,resizable:!0,width:950,autoHeight:!0,callback:null,_init:function(){var e=this;e.table?e.load_content():e.dataset&&e.rs_load_content(e.dataset)},load_content:function(e){var t=this,i=new IG$._rpc$,n=t.table._mc;i.init(t,{ack:"tablecontent",payload:{uid:n.uid,type:n.type,passwd:e,option:"preview"},mbody:{option:"preview"}},t,t.rs_load_content,t.err_load_content),i.send()},rs_load_content:function(e){var t,i,n,a,o,l,s,d=e.headers,r=e.inline_data,c=[],u=[],h=[],m=this.down("[name=dataview]"),b=this.table?this.table._mc:null,f={};if(d&&r){if(b&&b.columns)for(t=0;t<b.columns.length;t++)f[b.columns[t].name]=b.columns[t].alias;for(e.delimiter,t=0;t<d.length;t++)f[a=d[t].name]&&f[a]!=a&&(a=f[a]+" - "+a),o="col_"+t,u.push({xtype:"gridcolumn",width:150,text:a,dataIndex:o}),h.push({name:o,mapping:o});for(u.length,t=0;t<r.length;t++){for(n={},s=r[t],i=0;i<s.length;i++)n[o="col_"+i]=s[i];c.push(n)}}l={store:"array",fields:h,data:c},m.reconfigure(l,u)},initComponent:function(){this.title=IRm$.r1("L_PRV_DATA"),$s.apply(this,{defaults:{padding:10},layout:"fit",items:[{xtype:"panel",layout:{type:"vbox",align:"stretch"},items:[{xtype:"displayfield",value:"Table data preview"},{xtype:"gridpanel",name:"dataview",height:400,columns:[]}]}],buttons:[{text:IRm$.r1("B_CLOSE"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this._init()}}}),IG$.dlgLoadPreview.superclass.initComponent.apply(this,arguments)}}),IG$.JoinRec=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",closable:!0,resizable:!0,width:600,autoHeight:!0,padding:5,_init:function(){for(var e,t,i,n,a=this.down("[name=gmain]"),o=this.joins,l=[],s=0;s<o.length;s++)i=(t=o[s]).source,n=t.target,e={stableuid:i.tableuid,stable:i.tablename,sfield:i.fieldname,ttableuid:n.tableuid,ttable:n.tablename,tfield:n.fieldname,join:t.join},l.push(e);a.store.loadData(l)},_confirm:function(){for(var e,t,i=this,n=i.down("[name=gmain]"),a=i.joins,o=[],l={},s=0;s<n.store.data.items.length;s++)l[(e=n.store.data.items[s]).get("stableuid")+"_"+e.get("sfield")+":"+e.get("ttableuid")+"_"+e.get("tfield")]=1;for(s=0;s<a.length;s++)l[(t=a[s]).source.tableuid+"_"+t.source.fieldname+":"+t.target.tableuid+"_"+t.target.fieldname]&&o.push(t);i.callback&&i.callback.execute(o),i.close()},initComponent:function(){$s.apply(this,{title:"Join Recommendations",items:[{xtype:"panel",layout:{type:"vbox",align:"stretch"},minHeight:400,padding:10,items:[{xtype:"gridpanel",name:"gmain",flex:1,columns:[{text:"Source Table",dataIndex:"stable"},{text:"Source Field",dataIndex:"sfield"},{text:"Target Table",dataIndex:"ttable"},{text:"Target Field",dataIndex:"tfield"},{text:"Operator",dataIndex:"join"},{xtype:"actioncolumn",width:45,items:[{iconCls:"icon-grid-delete",tooltip:"Delete item",handler:function(e,t,i){e.store.getAt(t);e.store.removeAt(t)}}]}],store:{fields:["stable","sfield","ttable","tfield","join","stableuid","ttableuid"]}}]}],buttons:[{text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{text:IRm$.r1("B_CLOSE"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this._init()}}}),IG$.JoinRec.superclass.initComponent.apply(this,arguments)}});

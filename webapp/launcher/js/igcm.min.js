...
IG$.styleWizard=$s.extend(IG$.v$pnl,{layout:"border",closable:!0,iconCls:"icon-style",reportoption:null,callback:null,ignoreBase:0,loadGlobalStyle:function(){var e=this.down("[name=p_h]").getLayout(),t=new IG$._rpc$;e.setActiveItem(0),t.init(this,{ack:"appoption",payload:{address:"ReportStyle"},mbody:{}},this,this.rs_loadGlobalStyle,null),t.send()},rs_loadGlobalStyle:function(e){var t,a,l,n,s=this,o=e.themes,m=s.down("[name=c_themes]"),i=s.down("[name=stylelist]"),c=s.down("[name=basestyle]"),d=[],r=[],h={},y={},_={},u=[{name:""}],p=[];if(s.themes={},s._mc=e,o){for(h[(l={name:"Default",leaf:!1,expanded:!0,children:[]}).name]=l,r.push(l),h[(l={name:"Custom",leaf:!1,expanded:!0,children:[]}).name]=l,r.push(l),a=0;a<o.length;a++)(t=o[a]).name,t.c_cset,n={_mc:t,name:t.name,styleinfo:[],base_styles:{}},d.push({name:n.name,value:n.name}),s.themes[n.name]=n,$.each([{name:"Default",custom:!1,nodename:"default_styles"},{name:"Custom",custom:!0,nodename:"custom_styles"}],(function(e,a){var l,s,o,m,i,c=t[a.nodename];if(c)for(s=h[a.name],l=0;l<c.length;l++)m={name:(o=new IG$.clStyleObject(c[l],a.name.toLowerCase(),a.custom)).name,leaf:!0,custom:a.custom,basestylename:a.basestylename},a.custom||(a.basestylename||u.push({name:o.name,value:o.name}),n.base_styles[o.name]=o),n.styleinfo.push(o),i=a.name.toLowerCase()+"_"+o.name,y[i]||(s.children.push(m),y[i]=m,a.custom&&!_[o.name]&&(_[o.name]=c[l],p.push({name:o.name,kname:a.name,custom:a.custom,node:c[l]})))}));$.each(s.themes,(function(e,t){var a,l,n,s,o,m=0;for(a=0;a<p.length;a++){for(n=p[a],m=0,l=0;l<t.styleinfo.length;l++)if((s=t.styleinfo[l]).custom&&s.name==n.name){m=1;break}0==m&&(o=new IG$.clStyleObject(n.node,n.kname.toLowerCase(),n.custom),t.styleinfo.push(o))}}))}c.store.loadData(u),i.store.setRootNode({expanded:!0,text:"Style",name:"Style",children:r}),i.getRootNode().expand(),m.store.loadData(d),m.setValue(d.length?ig$.theme_id||d[0].value:null)},loadStyle:function(){var e=this,t=e.down("[name=c_themes]").getValue(),a=e.themes[t],l=e.down("[name=c_cset]"),n=e.down("[name=gs_enable]"),s=e.down("[name=gs_col]"),o=e.down("[name=gs_opa]"),m=e.down("[name=p_h]"),i=e.down("[name=b_r]");e.__cth&&(e.__cth.c_cset=l.getValue(),e.__cth.gs_enable=n.getValue(),e.__cth.gs_col=s.getValue(),e.__cth.gs_opa=o.getValue(),e.commitStyleItem()),a&&(e.__cth=a,l.setValue(a._mc.c_cset||""),n.setValue(a._mc.gs_enable),s.setValue(a._mc.gs_col),o.setValue(a._mc.gs_opa),m.getLayout().setActiveItem(0),i.setVisible(!1))},editStyleItem:function(e){var t,a,l,n,s=this,o=s.__cth,m=s.down("[name=form_header]"),i=s.down("[name=form_data]"),c=s.down("[name=basestyle]");if(o)for(s.commitStyleItem(),t=0;t<o.styleinfo.length;t++)if(o.styleinfo[t].name==e){if(n=o.styleinfo[t],s._editingstyle=n,"custom"==n.itemtype||n.basestylename){for(a=0;a<o.styleinfo.length;a++)if(o.styleinfo[a].name==n.basestylename){l=o.styleinfo[a];break}s.ignoreBase=!0,c.setValue(l?l.name:""),s.ignoreBase=!1}m.loadStyleData.call(m,n.header,l?l.header:null),i.loadStyleData.call(i,n.data,l?l.data:null);break}},commitStyleItem:function(){var e,t=this.__cth,a=this._editingstyle,l=this.down("[name=form_header]"),n=this.down("[name=form_data]");n.updateStyleData.call(n),l.updateStyleData.call(l),a&&("custom"==a.itemtype||a.basestylename)&&(e=t.base_styles[a.basestylename])&&a.forceBsStyl(e,!0)},_confirm:function(){var e=this,t=e.down("[name=c_cset]"),a=e.down("[name=gs_enable]"),l=e.down("[name=gs_col]"),n=e.down("[name=gs_opa]");e.__cth&&(e.__cth.c_cset=t.getValue(),e.__cth.gs_enable=a.getValue(),e.__cth.gs_col=l.getValue(),e.__cth.gs_opa=n.getValue()),e.commitStyleItem(),e.saveStyleItem()},saveStyleItem:function(){var e=new IG$._rpc$,t={},a=this.themes;t={meta_type:"report_themes",name:"ReportStyle",type:"AppOption",uid:"ReportStyle",themes:[]},$.each(a,(function(e,a){var l,n,s,o={};for(l=0;l<a.styleinfo.length;l++)o[(s=a.styleinfo[l]).name]=s;var m={name:a.name,c_cset:a.c_cset,gs_enable:a.gs_enable,gs_opa:a.gs_opa||.6,gs_col:a.gs_col,default_styles:[],custom_styles:[]};for(l=0;l<a.styleinfo.length;l++)0==(s=a.styleinfo[l]).custom?s.basestylename?(n=o[s.basestylename],m.default_styles.push(s.getData(n))):m.default_styles.push(s.getData()):(n=o[s.basestylename],m.custom_styles.push(s.getData(n)));t.themes.push(m)})),e.init(this,{ack:"appoption",payload:{address:"ReportStyle",option:"updatecontent"},mbody:t,meta_type:"report_themes"},this,(function(e){IG$.alertmsg(ig$.appname,IRm$.r1("M_SAVED"),null,null,0,"success")}),null),e.send()},copyThemes:function(e,t){var a,l,n;for(a=0;a<e.styleinfo.length;a++)l=e.styleinfo[a],(n=new IG$.clStyleObject(null,l.itemtype,l.custom)).name=l.name,n.nodename=l.nodename,n.basestylename=l.basestylename,n.header=new IG$.clStyleItem(null,"Header"),n.data=new IG$.clStyleItem(null,"Data"),n.applyBaseStyle.call(n,l),t.styleinfo.push(n)},toolbarHandler:function(e){var t,a=this,l=a.down("[name=stylelist]");a.styleinfo;switch(e){case"cmd_refresh":a.loadGlobalStyle();break;case"cmd_add_custom":var n=new IG$.makeStyle({styleinfo:a.__cth.styleinfo,callback:new IG$.callBackObj(a,a.rs__appendCustomStyle)});IG$.checkLogin(a,n);break;case"cmd_add_theme":n=new IG$.makeStyle({m_theme:1,themes:a.themes,callback:new IG$.callBackObj(a,(function(e){var t,a=e[0],l=(e[1],this.down("[name=c_themes]"));a&&(t={name:a,c_cset:null,gs_enable:!1,gs_col:0,gs_opa:.6,styleinfo:[]},this.copyThemes(this.__cth,t),this.themes[t.name]=t,l.store.add({name:a,value:a}))}))});IG$.checkLogin(a,n);break;case"cmd_remove_theme":IG$.confirmMessages(null,null,(function(e){if("yes"==e){var t,l,n=a.down("[name=c_themes]");if(a.__cth&&n.store.data.items.length>1){for(t=0;t<n.store.data.items.length;t++)if((l=n.store.data.items[t]).get("name")==a.__cth.name){n.store.remove(l);break}delete a.themes[a.__cth.name],a.__cth=null,n.setValue(n.store.data.items[0].get("value"))}}}),a,a);break;case"cmd_remove":a.down("[name=b_r]").setVisible(!1);(t=(t=l.getSelectionModel().getSelection())&&t.length>0?t[0]:null)&&1==t.get("custom")&&(stylename=t.get("name"),$.each(a.themes,(function(e,t){var a,l=t.styleinfo;for(a=0;a<l.length;a++)if(l[a].custom&&l[a].name==stylename){l.splice(a,1);break}})),t.remove())}},rs__appendCustomStyle:function(e){var t,a=e[0],l=e[1];if(l&&a){$.each(this.themes,(function(e,t){var n,s,o,m=t.styleinfo;for(n=0;n<m.length;n++)if(m[n].name==l){s=m[n];break}s&&((o=new IG$.clStyleObject(null,"item",!0)).name=a,o.nodename="ItemStyle",o.basestylename=l,o.header=new IG$.clStyleItem(null,"Header"),o.data=new IG$.clStyleItem(null,"Data"),m.push(o),o.applyBaseStyle.call(o,s))}));var n,s,o=this.down("[name=stylelist]").store.getRootNode();for(t=0;t<o.childNodes.length;t++)if("Custom"==o.childNodes[t].get("name")){s=o.childNodes[t];break}n={name:a,leaf:!0,custom:!0},s.appendChild(n)}},updateBaseStyle:function(){var e=this,t=e._editingstyle,a=e.down("[name=form_header]"),l=e.down("[name=form_data]"),n=e.down("[name=basestyle]").getValue();bstyle=e.__cth.base_styles[n],t&&bstyle&&(t.basestylename=n,t.forceBsStyl(bstyle),a.loadStyleData(t.header),l.loadStyleData(t.data))},initComponent:function(){var e,t=this,a=new IG$.styleEditor({title:IRm$.r1("L_STYLE_TITLE"),name:"form_header",htype:"hd",flex:1}),l=new IG$.styleEditor({title:IRm$.r1("L_STYLE_DATA"),name:"form_data",htype:"dt",flex:1}),n=[{name:"Select",value:""}],s=IG$.__chartoption.chartcolors;for(e in s)n.push({name:e,value:e});t.title=IRm$.r1("T_STYLE_WIZARD"),$s.apply(this,{defaults:{bodyStyle:"padding:3px"},dockedItems:[{xtype:"toolbar",dock:"top",plain:!0,items:[{iconCls:"icon-toolbar-save",tooltip:IRm$.r1("L_SAVE_CONTENT"),handler:function(){this._confirm()},scope:this},"-",{xtype:"combobox",fieldLabel:"Themes",name:"c_themes",displayField:"name",labelWidth:60,labelAlign:"right",valueField:"value",editable:!1,queryMode:"local",store:{fields:["name","value"]},listeners:{change:function(e,t,a,l){this.loadStyle()},scope:this}},{iconCls:"icon-toolbar-add",tooltip:"Add Theme",text:"Add Theme",handler:function(){this.toolbarHandler("cmd_add_theme")},scope:this},{iconCls:"icon-toolbar-remove",tooltip:"Remove Theme",handler:function(){this.toolbarHandler("cmd_remove_theme")},scope:this}]}],items:[{xtype:"panel",width:270,border:1,region:"west",layout:"anchor",padding:5,title:"General Options",items:[{xtype:"combobox",fieldLabel:"Chart Style",name:"c_cset",displayField:"name",labelPosition:"top",labelWidth:60,valueField:"value",editable:!1,queryMode:"local",store:{fields:["name","value"],data:n}},{xtype:"fieldset",title:"Grid stripe",anchor:"100%",layout:"anchor",paddingY:30,items:[{xtype:"checkbox",fieldLabel:IRm$.r1("L_GS_ENABLED"),name:"gs_enable",boxLabel:IRm$.r1("B_ENABLED")},{xtype:"fieldcontainer",anchor:"100%",fieldLabel:IRm$.r1("L_ALT_COLOR"),layout:"hbox",items:[{xtype:"textfield",name:"gs_col",width:60},{xtype:"splitter"},{xtype:"splitbutton",width:30,menu:{showSeparator:!1,items:[{xtype:"colorpicker",listeners:{select:function(e,t){this.down("[name=gs_col]").setValue("#"+t)},scope:t}},"-"]}}]},{xtype:"numberfield",fieldLabel:"Opacity",name:"gs_opa",width:200,minValue:0,maxValue:1,step:.1,value:.4}]},{xtype:"treepanel",title:"Style",name:"stylelist",preventHeader:!0,flex:1,split:!0,border:1,rootVisible:!1,hideHeaders:!0,autoScroll:!0,store:{xtype:"treestore",fields:["name","text","custom"],root:{expanded:!0,name:"Style",children:[]},folderSort:!1},columns:[{xtype:"treecolumn",text:"text",flex:1,sortable:!1,dataIndex:"name"}],listeners:{itemclick:function(e,t,a,l,n){var s,o=this,m=t.get("name"),i=o.down("[name=b_r]"),c=o.down("[name=p_h]"),d=o.down("[name=p_d]"),r=(o.down("[name=p_dc]"),o.down("[name=basestyle]")),h=o.__cth?o.__cth.styleinfo:null,y=!1,_=!1;if(h){for(s=0;s<h.length;s++)if(h[s].name==m){y=!0;break}y&&(1==t.get("custom")&&(_=!0),d.setTitle("Edit : "+m),o.editStyleItem.call(o,m)),c.getLayout().setActiveItem(y?1:0),i.setVisible(_),r.setVisible(_&&y)}},scope:this},tbar:[{iconCls:"icon-refresh",tooltip:IRm$.r1("L_REFRESH"),handler:function(){this.toolbarHandler("cmd_refresh")},scope:this},"-",{iconCls:"icon-toolbar-add",tooltip:"Add Custom Style",text:"Add Style",handler:function(){this.toolbarHandler("cmd_add_custom")},scope:this},{iconCls:"icon-toolbar-remove",tooltip:"Remove Style",name:"b_r",hidden:!0,handler:function(){this.toolbarHandler("cmd_remove")},scope:this}]}]},{xtype:"panel",region:"center",layout:"card",name:"p_h",items:[{html:"Click stylename to edit"},{xtype:"panel",layout:{type:"vbox",align:"stretch"},name:"p_dc",items:[{xtype:"combobox",name:"basestyle",fieldLabel:"Base Style",queryMode:"local",displayField:"name",valueField:"name",editable:!1,autoSelect:!0,hidden:!0,store:{fields:[{name:"name"}]},listeners:{change:function(){this.ignoreBase||this.updateBaseStyle()},scope:this}},{xtype:"tabpanel",title:"Edit :",name:"p_d",layout:{type:"fit",align:"stretch"},items:[l,a]}]}]}],listeners:{afterrender:function(){"g"==this.styletype&&this.loadGlobalStyle()}}}),IG$.styleWizard.superclass.initComponent.apply(this,arguments)}});

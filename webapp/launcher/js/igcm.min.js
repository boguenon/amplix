...
IG$.mgrBBS=$s.extend(IG$.v$pnl,{scroll:!1,closable:!0,layout:"fit",init_f:function(){var e=this,t=e.down("[name=bbscateg]"),i=e.down("[name=cuid]"),o=new IG$._rpc$;e._init_file_ldr(),o.init(e,{ack:"bbs",payload:{option:"list_category"},mbody:{}},e,(function(e){var o=[{title:"Select All",uid:""}],l=[];$.each(e,(function(e,t){o.push({uid:t.uid,title:t.title}),l.push({uid:t.uid,title:t.title})})),t.store.loadData(o),t.setValue(""),i.store.loadData(l)})),o.send()},_init_file_ldr:function(){var e=this,t=e.down("[name=d_file]").el.dom,i=$(".m_fileupload",t),o=e.down("[name=d_upfiles]");i.empty(),fileupload=$("<input type='file' name='files[]' data-url='upload' multiple></input>").appendTo(i).hide(),dropzone=$("<div class='filedropzone fade' style='height:80px'>Drop files here</div>").appendTo(i),d_progress=$("<div class='file-progress'><div class='bar' style='width: 0%;'></div></div>").appendTo(i),dropzone.bind("click",(function(e){fileupload.trigger("click")})),fileupload.fileupload({url:ig$.servlet,dataType:"json",formData:{_mts_:IG$._g$a||""},done:function(t,i){var l,n,d,a,s=i.result||{errorcode:"0xffff",errormsg:"Server incorrect responding"},r=[];if(s.errorcode)IG$.ShowErrorMessage(s,e,null);else if(s.result)for(l=s.result.length?s.result:[s.result],n=0;n<l.length;n++)d=l[n],r.push(d);if(r&&r.length)for(o.show(),n=0;n<r.length;n++)a=o.store.add(r[n]),o.selModel.select(a,!0)},progressall:function(e,t){var i=parseInt(t.loaded/t.total*100,10),o=$(".bar",d_progress);o.css("width",i+"%"),o.text("Loaded "+t.loaded+" / "+t.total)},dropZone:dropzone}).bind("fileuploadsubmit",(function(e,t){})),fileupload.fileupload("option","url",ig$.servlet)},_load_bbs:function(e){var t=this.down("[name=bbs_list]"),i=new IG$._rpc$;i.init(this,{ack:"bbs",payload:{option:"list",cuid:e},mbody:{}},this,(function(e){t.store.loadData(e)})),i.send()},view_bbs:function(e){var t,i,o=this,l=o.down("[name=p_view]"),n=o.down("[name=bbs_list]"),d=l.down("[name=d_content]"),a=o.down("[name=d_upfiles]");n.hide(),l.show(),i=function(e){o._edit_item=e,l.setAllValues(e),o._editor&&o._editor.summernote("code",e.content||"");var t,i,n=[];if(e.files){for(i=0;i<e.files.length;i++)t=e.files[i],n.push({uid:t.fuid,filename_org:t.fname});a.store.loadData(n)}},o._editor||(o._editor=$("#note_editor",d.body.dom).summernote({placeholder:"write here...",disableResizeEditor:!0,minHeight:400})),e&&e.get("uid")?((t=new IG$._rpc$).init(null,{ack:"bbs",payload:{option:"get",uid:e.get("uid")},mbody:{}},null,(function(e){i(e)})),t.send()):i({title:""})},view_list:function(){var e=this.down("[name=p_view]"),t=this.down("[name=bbs_list]");e.hide(),t.show()},save_bbs:function(){var e,t,i=this,o=i.down("[name=p_view]"),l=i.down("[name=d_upfiles]").store,n=i._edit_item;if(!o.getAllValues(n))if(n.content=i._editor.summernote("code"),n.content){for(n.files=[],e=0;e<l.data.items.length;e++)t=l.data.items[e],n.files.push({fuid:t.get("uid"),fname:t.get("filename_org")});(new IG$._rpc$).init(null,{ack:"bbs",payload:{option:"save"},mbody:n,meta_type:"bbs"},null,(function(e){i.view_list(),i._load_bbs()}))}else IG$.alertmsg(ig$.appname,"Content is required!",null,null,0,"error")},initComponent:function(){$s.apply(this,{items:[{xtype:"panel",layout:{type:"vbox",align:"stretch"},padding:20,flex:1,items:[{xtype:"gridpanel",name:"bbs_list",store:{},border:0,flex:1,columns:[{xtype:"gridcolumn",text:IRm$.r1("L_CATEGORY"),width:200,dataIndex:"categ"},{xtype:"gridcolumn",text:IRm$.r1("B_TITLE"),dataIndex:"title",tdCls:"igc-td-link",flex:1},{text:IRm$.r1("B_DATE"),width:150,sortable:!1,dataIndex:"mdatefm"},{xtype:"gridcolumn",text:IRm$.r1("B_STATUS"),dataIndex:"active",width:50},{xtype:"actioncolumn",width:60,items:[{iconCls:"icon-grid-dbicon",handler:function(e,t,i){var o=e.store.data.items[t];this.openDSLayer("cmd_edit_config",o)},scope:this},{iconCls:"igc-share",tooltip:IRm$.r1("L_OBJECT_AUTH"),hidden:!1!==ig$.features.ig_n_oauth||ig$.$l_>5,handler:function(e,t,i){var o=e.store.data.items[t];this.openDSLayer("cmd_object_auth",o)},scope:this},{iconCls:"icon-grid-delete",tooltip:IRm$.r1("L_REMOVE"),handler:function(e,t,i){var o=e.store,l=o.getAt(t);IG$.deleteMetaObject(l.get("uid"),l,IG$.callBackObj(this,(function(){o.removeAt(t)})))},scope:this}]}],listeners:{cellclick:function(e,t,i,o,l,n){1==i&&this.view_bbs(o)},scope:this},tbar:[{text:"Write",handler:function(){this.view_bbs()},scope:this},{xtype:"combobox",displayField:"title",valueField:"uid",name:"bbscateg",fieldLabel:IRm$.r1("L_CATEGORY"),queryMode:"local",editable:!1,autoSelect:!0,store:{fields:["name","uid"]},listeners:{change:function(e,t,i,o){this._load_bbs(t)},scope:this}}]},{xtype:"panel",hidden:!0,name:"p_view",autoScroll:!1,layout:"fit",items:[{xtype:"panel",autoScroll:!0,layout:"anchor",items:[{xtype:"combobox",required:!0,displayField:"title",valueField:"uid",name:"cuid",fieldLabel:IRm$.r1("L_CATEGORY"),queryMode:"local",editable:!1,autoSelect:!0,store:{fields:["name","uid"]}},{xtype:"textfield",name:"title",required:!0,fieldLabel:IRm$.r1("B_TITLE")},{xtype:"html",name:"d_content",height:550,html:"<div id='note_editor'></div>"},{xtype:"fieldset",layout:{type:"vbox",align:"stretch"},title:"File upload",items:[{html:"<div class='m_fileupload'></div>",name:"d_file",height:120,bodyPadding:10},{name:"d_upfiles",xtype:"gridpanel",height:320,hidden:!0,selType:"checkboxmodel",selModel:{mode:"MULTI"},store:{fields:[]},columns:[{text:IRm$.r1("L_FILENAME"),dataIndex:"filename_org",flex:1},{text:IRm$.r1("L_FILEEXT"),dataIndex:"fileext",flex:1},{xtype:"actioncolumn",width:20,items:[{iconCls:"icon-grid-delete",tooltip:"Delete item",handler:function(e,t,i){var o=e.store.getAt(t);e.store.remove(o)}}]}]}]},{xtype:"container",height:20},{xtype:"container",layout:{type:"hbox",align:"stretch"},items:[{xtype:"container",flex:1},{xtype:"button",text:"Confirm",handler:function(){this.save_bbs()},scope:this},{xtype:"button",text:"Cancel",handler:function(){this.view_list()},scope:this},{xtype:"container",flex:1}]}]}]}]}],listeners:{afterrender:function(){this.init_f()},scope:this}}),IG$.mgrBBS.superclass.initComponent.call(this)}});

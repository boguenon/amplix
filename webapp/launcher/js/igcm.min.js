...
IG$.MetaEditorPanel=$s.extend($s.panel,{autoScroll:!0,collapseFirst:!1,layout:"fit",closable:!0,initComponent:function(){$s.apply(this,{tbar:[{text:"Save Content",handler:function(){this.saveContent()},scope:this}]}),IG$.MetaEditorPanel.superclass.initComponent.call(this)},items:[{xtype:"textarea",name:"metaview"}],listeners:{render:function(t){t.uid&&0<t.uid.length&&this.loadMetaContent(t.uid,t.itemtype)},resize:function(t,e,n,i,a){t.validateSize.call(t,e,n)}},saveContent:function(){var t=this;t.setLoading(!0);var e=t.down("[name=metaview]"),n=new IG$._rpc$,i=e.getValue();n.init(t,{ack:"31",payload:{uid:t.uid},mbody:i},t,t.rs_saveContent(),null),n.send()},rs_saveContent:function(t){IG$.alertmsg(ig$.appname,IRm$.r1("M_SAVED"),null,null,0,"success")},loadMetaContent:function(t,e){var n=this;n.uid=t,n.setLoading(!0);var i=new IG$._rpc$,a="cube"==e,o=a?"cubecontent":"content",l=a?{option:"CubeContent"}:{};i.init(n,{ack:o,payload:{uid:t},mbody:l},n,n.rs_loadMetaContent,null),i.send()},rs_loadMetaContent:function(t){content=JSON.stringify(t,null,2),metaview=this.down("[name=metaview]"),metaview.setValue(content)},validateSize:function(t,e,n){}}),IG$.MetaEditorMainPanel=function(){IG$.MetaEditorMainPanel.superclass.constructor.call(this,{id:"doc-body",region:"center",margins:"0 5 5 0",resizeTabs:!0,minTabWidth:135,tabWidth:135,enableTabScroll:!0,activeTab:0,layout:"fit",items:[{id:"welcome-panel",title:"MetaEditor",autoLoad:{url:"./html/metaeditor.html",callback:null,scope:this},iconCls:"icon-docs",autoScroll:!0}]})},IG$.MetaEditorMainPanel=$s.extend($s.tabpanel,{initEvents:function(){IG$.MetaEditorMainPanel.superclass.initEvents.call(this),this.body.on("click",this.onClick,this)},navigateApp:function(t,e,n,i){var a=this.getComponent(i);if(a)this.setActiveTab(a);else{var o=IG$.createAppPanel(t,"metaeditor",n,i,null);if(null!=o){o.uid=t,o.address=i,o.itemtype=e,o.title=n;var l=this.add(o);this.setActiveTab(l)}}}});

...
IG$.dlg_select_ds||(IG$.dlg_select_ds=$s.extend($s.window,{width:500,height:520,layout:"fit",padding:5,_init:function(){var e=new IG$._rpc$;e.init(this,{ack:"userdb",payload:{address:"/Connections",option:"list"},mbody:{}},this,(function(e){var t,a=e.children,i=this.down("[name=dsource]"),n=[];if(a&&a.length)for(t=0;t<a.length;t++)(1==this.sel_mode||a[t].attributes&&"T"==a[t].attributes.attrb1)&&n.push(a[t]);i.store.loadData(n)}),!1),e.send()},_confirm:function(e){var t=this,a=t.down("[name=dsource]"),i=t.down("[name=opt_dbtype]").getValue().cb_dbtype,n=e?null:a.getSelectionModel().selected;"db"==i||1==t.sel_mode?e?(t.callback&&t.callback.execute(e),t.close()):n&&n.length?(t.callback&&t.callback.execute(n.items[0]),t.close()):IG$.ShowError("Select datasource to continue!",t):(t.callback&&t.callback.execute(),t.close())},initComponent:function(){$s.apply(this,{title:"Select DataSource",items:[{xtype:"panel",padding:10,layout:{type:"vbox",align:"stretch"},items:[{xtype:"fieldset",title:"Storage Options",hidden:1==this.sel_mode,layout:{type:"vbox",align:"stretch"},items:[{xtype:"radiogroup",name:"opt_dbtype",fieldLabel:"Data Storage",padding:"0 5",plain:!0,items:[{boxLabel:"Use Temporary",name:"cb_dbtype",inputValue:"h2",checked:!0},{boxLabel:"Staging Database",name:"cb_dbtype",inputValue:"db"}]}]},{xtype:"fieldset",title:"Staging Databases",flex:1,layout:{type:"vbox",align:"stretch"},items:[{xtype:"gridpanel",name:"dsource",flex:1,selType:"checkboxmodel",selModel:{mode:"SINGLE"},store:{fields:[]},columns:[{text:IRm$.r1("B_NAME"),dataIndex:"name",tdCls:"igc-td-link"},{text:IRm$.r1("B_DESC"),dataIndex:"description"}],listeners:{cellclick:function(e,t,a,i,t,n,l){var s=this.down("[name=opt_dbtype]").getValue();1==a&&(s&&"db"==s.cb_dbtype?this._confirm(i):IG$.ShowError("Check datatype to staging database!",this))},scope:this}}]}]}],buttons:["->",{xtype:"button",text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{xtype:"button",text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){e._init()}}}),IG$.dlg_select_ds.superclass.initComponent.call(this)}}));

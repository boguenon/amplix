...
IG$.sch_prog=$s.extend(IG$.v$pnl,{padding:10,closable:!0,iconCls:"icon-schedule",layout:"fit",init_f:function(){this.load_cnt()},load_cnt:function(){var e=new IG$._rpc$;e.init(this,{ack:"appoption",payload:{address:"schedule_config"},mbody:{}},this,function(e){var t=this,a=t.down("[name=grdprog]");t._mc=e||{},t._mc.meta_type="schedule_config",a.store.loadData(t._mc.programs)},null),e.send()},_editProg:function(a){var n=this,i=n.down("[name=grdprog]"),e=new IG$.sch_progEd({mdata:a?a.data:null,callback:new IG$.callBackObj(n,function(e){var t;if(a){for(t in e)a.data[t]=e[t];a.refresh()}else i.store.add(e);n._save(1)})});IG$.checkLogin(n,e)},_update_content:function(){var e,t,a,n=this.down("[name=grdprog]"),i={meta_type:"schedule_config",programs:[]};for(e=0;e<n.store.data.items.length;e++)a={mod_type:(t=n.store.data.items[e]).get("mod_type"),name:t.get("name"),java_class:t.get("java_class"),java_source:t.get("java_source"),java_import:t.get("java_import"),java_extra:t.get("java_extra"),ui_layout:t.get("ui_layout"),ui_script:t.get("ui_layout")},i.programs.push(a);return this._mc=i,1},_save:function(e){var t=this,a=new IG$._rpc$;t._update_content()&&(e?(a.init(t,{ack:"appoption",payload:{address:"schedule_config",option:"updatecontent"},mbody:t._mc,meta_type:"schedule_config"},t,function(e){IG$.alertmsg(ig$.appname,IRm$.r1("M_SAVED"),null,null,0,"success")},!1),a.send()):IG$.confirmMessages(ig$.appname,IRm$.r1("L_SAVE_CHANGES"),function(e){"yes"==e&&(a.init(t,{ack:"appoption",payload:{address:"schedule_config",option:"updatecontent"},mbody:t._mc,meta_type:"schedule_config"},t,function(e){IG$.alertmsg(ig$.appname,IRm$.r1("M_SAVED"),null,null,0,"success")},!1),a.send())}))},initComponent:function(){$s.apply(this,{items:[{xtype:"gridpanel",flex:1,name:"grdprog",store:{xtype:"store"},columns:[{text:"Name",width:200,dataIndex:"name"},{text:"Package name",flex:1,dataIndex:"java_class"},{xtype:"actioncolumn",width:60,items:[{iconCls:"icon-grid-delete",tooltip:IRm$.r1("L_REMOVE"),handler:function(e,t,a){var n=e.store;n.getAt(t);IG$.confirmMessages(ig$.appname,"Do you want to delete this job program?",function(e){n.removeAt(t)})},scope:this}]}],listeners:{itemclick:function(e,t,a,n,i,o){this._editProg(t)},scope:this},tbar:[{text:"Save",handler:function(){this._save()},scope:this},{text:"Refresh",handler:function(){this.init_f()},scope:this},{text:"Add New Program",handler:function(){this._editProg()},scope:this}]}]}),IG$.sch_prog.superclass.initComponent.call(this)},listeners:{afterrender:function(e){e.init_f()}}}),IG$.sch_progEd=$s.extend($s.window,{modal:!1,region:"center",layout:"fit",closable:!1,resizable:!1,width:650,height:520,pname:"com.amplix.scheduler.job.",init_f:function(){var e=this,t=e.mdata||{};t.mod_type=t.mod_type||"scheduler_quartz",e.down("[name=mod_type]").setValue(t.mod_type),e.down("[name=m_name]").setValue(t.name),e.down("[name=m_java_class]").setValue(t.java_class?t.java_class:t.name?e.pname+t.name:e.pname),e.down("[name=java_source]").setValue(t.java_source?t.java_source.join("\n"):""),e.down("[name=java_import]").setValue(t.java_import?t.java_import.join("\n"):""),e.down("[name=java_extra]").setValue(t.java_extra?t.java_extra.join("\n"):""),e.down("[name=ui_layout]").setValue(t.ui_layout?t.ui_layout.join("\n"):""),e.down("[name=ui_script]").setValue(t.ui_script?t.ui_script.join("\n"):"")},_upcheck:function(){var e,t=this,a=t.down("[name=m_name]"),n=t.down("[name=m_java_class]"),i=t.down("[name=java_source]"),o=t.down("[name=java_import]"),s=t.down("[name=java_extra]"),l=t.down("[name=ui_layout]"),p=t.down("[name=ui_script]");if(e={mod_type:t.down("[name=mod_type]").getValue(),name:a.getValue(),java_class:n.getValue(),java_source:i.getValue()?i.getValue().split("\n"):null,java_import:o.getValue()?o.getValue().split("\n"):null,java_extra:s.getValue()?s.getValue().split("\n"):null,ui_layout:l.getValue()?l.getValue().split("\n"):null,ui_script:p.getValue()?p.getValue().split("\n"):null},a.clearInvalid(),e.name)return e;a.setInvalid("required")},commit_f:function(){var e=this._upcheck();e&&this.callback&&(this.callback.execute(e),this.close())},_doCompile:function(){var e=new IG$._rpc$,t=this._upcheck();t&&(e.init(this,{ack:"plugin",payload:{option:"compile"},mbody:{meta_type:"schedule_config",programs:[t]},meta_type:"schedule_config"},this,function(e){var t,a=this.down("[name=txtoutput]"),n=e&&e.length?e[0]:null,i=[];n&&n.results&&(t=n.results.error_details)&&$.each(t,function(e,t){i.push(t.message||"")}),a.setValue(i.join("\n")||"success!")}),e.send())},_updmodtype:function(){this.down("[name=mod_type]").getValue()},_pname:function(){var e=this.down("[name=m_java_class]"),t=this.down("[name=m_name]").getValue()||"";e.setValue(this.pname+t)},initComponent:function(){this.title="Schedule Program",$s.apply(this,{padding:10,items:[{xtype:"panel",padding:10,layout:{type:"vbox",align:"stretch"},items:[{xtype:"combobox",name:"mod_type",fieldLabel:"Module Type",required:!0,displayField:"name",valueField:"value",store:{data:[{name:"Scheduler Class",value:"scheduler_quartz"},{name:"External DataLoader",value:"external_dataloader"}]},listeners:{change:function(){this._updmodtype()},scope:this}},{xtype:"container",height:10},{xtype:"tabpanel",padding:10,items:[{xtype:"panel",padding:10,layout:{type:"vbox",align:"stretch"},autoScroll:!0,title:"Java Execution",items:[{xtype:"textfield",fieldLabel:"Name",name:"m_name",enableKeyEvents:!0,listeners:{keyup:function(e,t){this._pname()},change:function(e,t){this._pname()},scope:this}},{xtype:"fieldset",paddingY:20,title:"Java Codes",layout:{type:"vbox",align:"stretch"},items:[{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",fieldLabel:"JavaClass",name:"m_java_class",readOnly:!0}]},{xtype:"panel",name:"vpanel_0",layout:{type:"vbox",align:"stretch"},items:[{xtype:"textarea",fieldLabel:"Source Code",name:"java_source",height:300,labelPosition:"top"},{xtype:"textarea",fieldLabel:"Java Imports",name:"java_import",height:200,labelPosition:"top"},{xtype:"textarea",fieldLabel:"Extra Code",name:"java_extra",height:200,labelPosition:"top"}]},{xtype:"container",layout:{type:"hbox",align:"stretch"},items:[{xtype:"container",flex:1},{xtype:"button",text:"Compile",handler:function(){this._doCompile()},scope:this}]},{xtype:"textarea",fieldLabel:"Output Message",name:"txtoutput",height:120,labelPosition:"top"}]}]},{xtype:"panel",padding:10,layout:{type:"vbox",align:"stretch"},autoScroll:!0,title:"Option UI Design",items:[{xtype:"fieldset",name:"p_editor",paddingY:20,title:"Option UI Codes",layout:{type:"vbox",align:"stretch"},items:[{xtype:"textarea",fieldLabel:"Layout UI",height:300,name:"ui_layout",labelPosition:"top"},{xtype:"textarea",fieldLabel:"Layout Script",height:300,name:"ui_script",labelPosition:"top"}]}]}]}]}],buttons:["->",{text:IRm$.r1("B_CONFIRM"),handler:function(){this.commit_f()},scope:this},{text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this.init_f()}}}),IG$.sch_progEd.superclass.initComponent.apply(this,arguments)}});
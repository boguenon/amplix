...
IG$.dlg_select_ds||(IG$.dlg_select_ds=$s.extend($s.window,{width:500,height:520,layout:"fit",padding:5,_init:function(){var e=new IG$._rpc$;e.init(this,{ack:"userdb",payload:{address:"/Connections",option:"list"},mbody:{}},this,(function(e){var t,i=e.children,l=this.down("[name=dsource]"),n=[];if(i&&i.length)for(t=0;t<i.length;t++)(1==this.sel_mode||i[t].attributes&&"T"==i[t].attributes.attrb1)&&n.push(i[t]);l.store.loadData(n)}),!1),e.send()},_confirm:function(e){var t=this,i=t.down("[name=dsource]"),l=t.down("[name=opt_dbtype]").getValue().cb_dbtype,n=e?null:i.getSelectionModel().selected;"db"==l||1==t.sel_mode?e?(t.callback&&t.callback.execute(e),t.close()):n&&n.length?(t.callback&&t.callback.execute(n.items[0]),t.close()):IG$.ShowError(IRm$.r1("E_SEL_DC"),t):(t.callback&&t.callback.execute(),t.close())},initComponent:function(){$s.apply(this,{title:IRm$.r1("T_SEL_DB"),items:[{xtype:"panel",padding:10,layout:{type:"vbox",align:"stretch"},items:[{xtype:"fieldset",title:IRm$.r1("L_STORAGE_OPTIONS"),hidden:1==this.sel_mode,layout:{type:"vbox",align:"stretch"},items:[{xtype:"radiogroup",name:"opt_dbtype",fieldLabel:IRm$.r1("L_DATA_STORAGE"),padding:"0 5",plain:!0,items:[{boxLabel:IRm$.r1("L_USE_TEMP"),name:"cb_dbtype",inputValue:"h2",checked:!0},{boxLabel:IRm$.r1("L_USE_STG"),name:"cb_dbtype",inputValue:"db"}],listeners:{change:function(e,t,i){this.down("[name=mview]").setDisabled(!t||!t.cb_dbtype||"db"!=t.cb_dbtype)},scope:this}}]},{xtype:"fieldset",name:"mview",title:IRm$.r1("L_STAGING_DB"),flex:1,layout:{type:"vbox",align:"stretch"},disabled:1!=this.sel_mode,items:[{xtype:"gridpanel",name:"dsource",flex:1,selType:"checkboxmodel",selModel:{mode:"SINGLE",checkSelector:".x-grid-cell"},store:{fields:[]},columns:[{text:IRm$.r1("B_NAME"),dataIndex:"name",tdCls:"igc-td-link"},{text:IRm$.r1("B_DESC"),dataIndex:"description"}],listeners:{cellclick:function(e,t,i,l,t,n,s){var o=this.down("[name=opt_dbtype]").getValue();1!=this.sel_mode&&1==i&&(o&&"db"==o.cb_dbtype?this._confirm(l):IG$.ShowError(IRm$.r1("E_CHECK_DTYPE"),this))},scope:this}}]}]}],buttons:["->",{xtype:"button",text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{xtype:"button",text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){e._init()}}}),IG$.dlg_select_ds.superclass.initComponent.call(this)}}));

...
IG$.mgrSysCfg=$s.extend(IG$.v$pnl,{scroll:!1,closable:!0,iconCls:"icon-config",_init:function(){this._load_data()},_load_data:function(){var e=new IG$._rpc$;e.init(this,{ack:"appoption",payload:{address:"sys_config"},mbody:{}},this,function(e){this._mc=e},!1),e.send()},_add_sso:function(e){var t,a=this.down("[name=_sso_p]"),l={xtype:"fieldset",title:e.sso_name||"",layout:{type:"vbox",align:"stretch"},items:[{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"sso_name",fieldLabel:"Short Name"},{xtype:"checkbox",boxLabel:"Enabled",name:"sso_enabled"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"sso_name",fieldLabel:"Description"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"sso_name",fieldLabel:"Authentication Class"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"sso_name",fieldLabel:"Authorization Class"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"sso_name",fieldLabel:"Authentication Class"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",fieldLabel:"Apply Method",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,name:"sso_method",store:{xtype:"store",fields:["name","value"],data:[{name:"Validate First",value:"before_only"}]}}]}]};t=a.add(l),l._item=t},initComponent:function(){$s.apply(this,{layout:"fit",items:[{xtype:"panel",border:1,layout:{type:"vbox",align:"stretch"},tbar:[{text:"Save",cls:"ig_r_save",handler:function(){},scope:this},{text:"Refresh",iconCls:"icon-refresh",tooltip:"Refresh",handler:function(){this._load_data()},scope:this}],items:[{xtype:"tabpanel",layout:"fit",items:[{type:"panel",title:"General",layout:{type:"vbox",align:"stretch"},bodyPadding:10,margin:30,autoScroll:!0,items:[{xtype:"fieldset",title:"Email Setup",layout:{type:"vbox",align:"stretch"},items:[{xtype:"checkbox",boxLabel:"Enabled",name:"email_enabled",fieldLabel:" "},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",fieldLabel:"Server Type",name:"email_protocol",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,store:{xtype:"store",fields:["name","value"],data:[{name:"SMTP",value:"SMTP"},{name:"Sendmail",value:"Sendmail"}]}},{xtype:"combobox",fieldLabel:"Encryption",name:"email_encryption",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,store:{xtype:"store",fields:["name","value"],data:[{name:"None",value:""},{name:"STARTTLS",value:"STARTTLS"},{name:"SSL/TLS",value:"SSL/TLS"}]}},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",fieldLabel:"From address",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"email_address",placeholder:"youremail@server.com"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",fieldLabel:"Authentication Method",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",name:"email_auth_type",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,store:{xtype:"store",fields:["name","value"],data:[{name:"None",value:""},{name:"Login",value:"login"},{name:"Plain",value:"plain"},{name:"NT LAN Manager",value:"nt"}]}},{xtype:"checkbox",boxLabel:"Authentication Required",name:"email_auth"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",fieldLabel:"Server Address",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"email_server",placeholder:"smtp.server.com"},{xtype:"textfield",name:"email_port",placeholder:"Port number(443)"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",fieldLabel:"Credentials",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",placeholder:"Userid",name:"email_authuser"},{xtype:"textfield",placeholder:"Password",name:"email_authpass"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"container",flex:1},{xtype:"button",text:"Test email settings",handler:function(){},scope:this}]}]},{xtype:"fieldset",title:"General",layout:{type:"vbox",align:"stretch"},items:[{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",fieldLabel:"Log level",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,name:"sys_loglevel",store:{xtype:"store",fields:["name","value"],data:[{name:"All",value:"ALL",desc:"The ALL has the lowest possible rank and is intended to turn on all logging."},{name:"Debug",value:"DEBUG",desc:"The DEBUG Level designates fine-grained informational events that are most useful to debug an application."},{name:"Info",value:"INFO",desc:"The INFO level designates informational messages that highlight the progress of the application at coarse-grained level."},{name:"Warn",value:"WARN",desc:"The WARN level designates potentially harmful situations."},{name:"Error",value:"ERROR",desc:"The ERROR level designates error events that might still allow the application to continue running."},{name:"Fatal",value:"FATAL",desc:"The FATAL level designates very severe error events that will presumably lead the application to abort."},{name:"Off",value:"OFF",desc:"The OFF has the highest possible rank and is intended to turn off logging."},{name:"Trace",value:"TRACE",desc:"The TRACE Level designates finer-grained informational events than the DEBUG"}]}},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",fieldLabel:"Scheduler Service",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,name:"sch_method",store:{xtype:"store",fields:["name","value"],data:[{name:"Embedded Quartz",value:"internal"},{name:"External Agent",value:"external"}]}},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",fieldLabel:"Excel Output Type",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,name:"excel_type",store:{xtype:"store",fields:["name","value"],data:[{name:"Excel 2018 (XSLX)",value:"xlsx"},{name:"Excel 2013 (XLS)",value:"xls"}]}},{xtype:"container",flex:1}]}]},{xtype:"fieldset",title:"Meta Data",layout:{type:"vbox",align:"stretch"},items:[{xtype:"checkbox",fieldLabel:"Store Metafile",name:"meta_enable_file",boxLabel:"Enable"},{xtype:"textfield",placeholder:"meta_files",fieldLabel:"Location",value:"meta_files"},{xtype:"fieldcontainer",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",fieldLabel:"File Name Rule",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,name:"meta_name_rule",store:{xtype:"store",fields:["name","value"],data:[{name:"UID",value:"uid"},{name:"Name",value:"name"}]}},{xtype:"container",flex:1}]}]},{xtype:"fieldset",title:"Python Integration",layout:{type:"vbox",align:"stretch"},items:[{xtype:"fieldcontainer",fieldLabel:"Module Type",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",queryMode:"local",displayField:"name",valueField:"value",editable:!1,autoSelect:!0,name:"python_method",store:{xtype:"store",fields:["name","value"],data:[{name:"WebSocket",value:"websocket"},{name:"Static HTML",value:"export"}]}},{xtype:"container",flex:1}]},{xtype:"textfield",fieldLabel:"Python Executible",name:"python_exec"},{xtype:"container",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",fieldLabel:"Jupyter URL",name:"python_jupyter",placeholder:"http://localhost:8888/",flex:1},{xtype:"checkbox",name:"python_need_auth",boxLabel:"Need Authentication"}]},{xtype:"fieldcontainer",fieldLabel:"Credentials",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"python_username",placeholder:"Username"},{xtype:"textfield",name:"python_password",placeholder:"Password"},{xtype:"container",flex:1}]}]},{xtype:"fieldset",title:"Security",layout:{type:"vbox",align:"stretch"},items:[{xtype:"checkbox",fieldLabel:"Snooze Login",name:"sec_enable_snooze",boxLabel:"Snooze"},{xtype:"numberfield",fieldLabel:"Snooze Time(min)",name:"sec_snooze_time",value:2},{xtype:"textfield",name:"sec_tenant_post_proc",fieldLabel:"Tenant Post Call Module"},{xtype:"textfield",fieldLabel:"Password Rule",name:"sec_password_rule",placeholder:"^(?=S+$).{8,}$"},{xtype:"fieldcontainer",fieldLabel:"maxfileupload",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"Max File upload"},{xtype:"container",flex:1}]},{xtype:"fieldcontainer",fieldLabel:"Bulk Max File upload",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"maxfileuploadbulk"},{xtype:"container",flex:1}]},{xtype:"html",html:["<div>","#^                 # start-of-string","#(?=.*[0-9])       # a digit must occur at least once <br/>","#(?=.*[a-z])       # a lower case letter must occur at least once <br/>","#(?=.*[A-Z])       # an upper case letter must occur at least once <br/>","#(?=.*[@#$%^&+=])  # a special character must occur at least once <br/>","#(?=\\S+$)          # no whitespace allowed in the entire string <br/>","#.{8,}             # anything, at least eight places though <br/>","#$                 # end-of-string <br/>","# strong password <br/>","# ^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=])(?=\\S+$).{8,}$ <br/>","# median password  <br/>","# ^(?=.*[0-9])(?=.*[a-z])(?=\\S+$).{8,}$ <br/>","# weak password  <br/>","# ^(?=\\S+$).{8,}$ <br/>","</div>"]},{xtype:"numberfield",name:"sec_wrong_passwd",fieldLabel:"Lock Wrong Password",value:0}]},{xtype:"fieldset",title:"Data Mashing",layout:{type:"vbox",align:"stretch"},items:[{xtype:"textfield",fieldLabel:"H2 URL for Mashing",name:"h2_jdbcurl"},{xtype:"fieldcontainer",fieldLabel:"Credentials",layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"h2_username",placeholder:"Username"},{xtype:"textfield",name:"h2_password",placeholder:"Password"},{xtype:"container",flex:1}]}]}]},{type:"panel",title:"Single Sign On",layout:{type:"vbox",align:"stretch"},bodyPadding:10,autoScroll:!0,name:"_sso_p",tbar:[{text:"Add New Rule",handler:function(){var e=this,t={};e._add_sso(t),e._mc.sso_module=e._mc.sso_module||[],e._mc.sso_module.push(t)},scope:this}],items:[]}]}]}],listeners:{afterrender:function(e){e._init()}}}),IG$.mgrSysCfg.superclass.initComponent.call(this)}});

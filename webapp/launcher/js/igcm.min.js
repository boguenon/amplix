...
IG$.systemlookup=$s.extend(IG$.v$pnl,{scroll:!1,initialized:!1,closable:!0,layout:"fit",bodyPadding:5,iconCls:"icon-ing-docdef",init_f:function(){var e,t=this,n=this.down("[name=m_navi]"),o=new IG$._rpc$;o.init(t,{ack:"helpcontent",payload:{uid:"/SYS_Lookup",name:"SYS_Lookup",type:"Folder",post:"create",duty:"everyone",mode:"s"},mbody:{option:"translate"}},t,(function(o){var a=o&&o.length?o[0].uid:null;a&&(t.tuid=a,e=new IG$.n$navTreeCom({name:"mtree",rootuid:a,btype:"codemap",rootname:"Code Mapping",visibleItems:"folder;",showCustomMenu:function(e){var t=this.customMenu,n=(e.get("type").toLowerCase(),e.get("name")),o=e.get("nodepath"),a=e.get("uid"),i=(e.get("type"),!(!e.get("writable")&&!e.get("manage"))),d=!!e.get("manage"),l=!1;return t.removeAll(),(i||d)&&(l=!0,t.add({text:IRm$.r1("B_FOLDER"),hidden:ig$.features.ig_n_f_f,handler:function(){this._createMetaObject.call(this,"Folder",a,o,e)},scope:this}),t.add({text:IRm$.r1("L_RENAME_ITEM",n),hidden:ig$.features.ig_n_ren,handler:function(){this._renameMetaObject.call(this,n,a,o,record)},scope:this}),t.add({text:IRm$.r1("L_DELETE_ITEM",n),hidden:ig$.features.ig_n_del,handler:function(){this.deleteMetaObject.call(this,a,record)},scope:this})),l},custom_expand_func:new IG$.callBackObj(t,t.rs_custom_click_func),custom_click_func:new IG$.callBackObj(t,t.rs_custom_click_func)}),n.add(e))})),o.send()},rs_custom_click_func:function(e){var t=this.down("[name=t_btn]");t.setDisabled(!0),this._s1=e,(e.get("writable")||e.get("manageable"))&&t.setDisabled(!1),this.load_content(e)},load_content:function(e){var t=new IG$._rpc$;t.init(this,{ack:"content",payload:{uid:e.get("uid")},mbody:{}},this,(function(e){var t,n,o=e?e.children:null,a=[],i=this.down("[name=g1]");if(o)for(t=0;t<o.length;t++)"CodeMap"==(n=o[t]).type&&a.push(n);i.store.loadData(a)}),!1),t.send()},createItem:function(e){var t=this,n=t.down("[name=mtree]");t._s1&&n._createMetaObject.call(n,e,t._s1.get("uid"),t._s1.get("nodepath"),t._s1)},toolbarHandler:function(e){var t,n,o,a=this,d=0;switch(e){case"cmd_rename":if(t=a.down("[name=g1]"),(n=t.getSelectionModel().selected)&&n.length>0){o=n.items[0];var l=new IG$.makeItemEditor({itemname:o.get("name"),uid:o.get("uid"),nodepath:o.get("nodepath"),itemtype:o.get("type"),memo:o.get("memo")||"",callback:new IG$.callBackObj(a,(function(e,t){}))});IG$.checkLogin(this,l)}break;case"cmd_move":if(t=a.down("[name=g1]"),(n=t.getSelectionModel().selected)&&n.length>0){a=this;var s=new IG$.metaSelectDlg({visibleItems:"folder",targetobj:"folder",tree_options:{cubebrowse:!1,rootuid:a.tuid},callback:new IG$.callBackObj(a,(function(e){e&&IG$.confirmMessages(IRm$.r1("B_CONFIRM"),IRm$.r1("B_CD_MHS",e.name),(function(t){if("yes"==t){for(address=[],d=0,i=0;i<n.length;i++)((o=n.items[i]).get("writable")||o.get("manage"))&&(address.push({uid:o.get("uid")}),d++);d>0&&(req=new IG$._rpc$,req.init(a,{ack:"helpcontent",payload:address,mbody:{option:"move",target:e.uid}},a,(function(e){var t=this.down("[name=mtree]"),n=t.getRootNode();t.refreshNode.call(t,n)}),null,null),req.send())}}))}))});IG$.checkLogin(this,s)}break;case"cmd_delete":t=a.down("[name=g1]"),(n=t.getSelectionModel().selected)&&n.length>0&&(o=n.items[0],IG$.confirmMessages(ig$.appname,"Confirm to delete content?",(function(e){if("yes"==e){var n=new IG$._rpc$;n.init(a,{ack:"deletecontent",payload:{uid:o.get("uid")},mbody:{}},a,(function(e){t.store.remove(o)}),null),n.send()}})));break;case"cmd_export_meta":IG$.confirmMessages(IRm$.r1("T_EXP_MC"),IRm$.r1("T_EXP_MC_Q"),(function(e){var t,n,o=a,i=new IG$._rpc$;(t={uid:o.tuid,name:"SYS_Lookup",type:"Folder",nodepath:"/SYS_Lookup"})&&t.uid&&"yes"==e&&(n={uid:t.uid,nodepath:t.nodepath,name:t.name,type:t.type},i.init(o,{ack:"content",payload:n,mbody:{output:"file"}},o,(function(e){var t,n;e&&(t=e.luid,n=e.filename,t&&n&&$.download(ig$.servlet,[{name:"ack",value:"download"},{name:"payload",value:t},{name:"mbody",value:n},{name:"_mts_",value:IG$._g$a||""}],"POST"))}),null),i.send())}),a,a)}},initComponent:function(){this.items=[{xtype:"panel",layout:"border",border:!1,items:[{xtype:"panel",layout:"fit",region:"west",collapsed:!1,width:200,title:"Navigator",name:"m_navi",tbar:[{xtype:"button",name:"t_btn",text:IRm$.r1("B_CR"),disabled:!0,menu:{xtype:"menu",items:[{text:IRm$.r1("B_FOLDER"),hidden:ig$.features.ig_n_f_f,handler:function(){this.createItem("Folder")},scope:this},"-",{text:IRm$.r1("L_CODEMAPPING"),hidden:ig$.features.ig_n_lk,handler:function(){this.createItem("CodeMap")},scope:this}]}},{xtype:"button",iconCls:"icon-refresh",tooltip:IRm$.r1("L_REFRESH"),handler:function(){var e=this.down("[name=mtree]"),t=e.getRootNode();e.refreshNode.call(e,t)},scope:this}],items:[]},{xtype:"panel",region:"center",flex:1,layout:"fit",tbar:[{xtype:"button",text:IRm$.r1("L_RENAME"),handler:function(){this.toolbarHandler("cmd_rename")},scope:this},{xtype:"button",text:IRm$.r1("L_MOVE"),handler:function(){this.toolbarHandler("cmd_move")},scope:this},{xtype:"button",text:IRm$.r1("L_REMOVE"),handler:function(){this.toolbarHandler("cmd_delete")},scope:this},"->",{text:IRm$.r1("L_EXPORT_META"),handler:function(){this.toolbarHandler("cmd_export_meta")},scope:this}],items:[{xtype:"gridpanel",name:"g1",store:{xtype:"store",fields:["uid","name","description","nodepath","type","writable"]},selType:"checkboxmodel",selModel:{checkSelector:".x-grid-cell",mode:"SINGLE"},columns:[{text:IRm$.r1("B_NAME"),dataIndex:"name",tdCls:"igc-td-link"},{text:IRm$.r1("B_DESC"),dataIndex:"description",flex:1},{xtype:"actioncolumn",width:30,menuDisabled:!0,items:[{iconCls:"icon-grid-config",tooltip:IRm$.r1("L_EDIT"),handler:function(e,t,n){var o=e.store.getAt(t),a=IG$.mainPanel;a&&a.navigateApp.call(a,o.get("uid"),o.get("type").toLowerCase(),o.get("name"),o.get("nodepath"),!1,o.get("writable"))},scope:this}]}],listeners:{cellclick:function(e,t,n,o,a,i,d,l){if(1==n){var s=e.store.getAt(i),c=IG$.mainPanel;c&&c.navigateApp.call(c,s.get("uid"),s.get("type").toLowerCase(),s.get("name"),s.get("nodepath"),!1,s.get("writable"))}},scope:this}}]}]}],this.listeners={afterrender:function(e){e.init_f.call(e)}},IG$.systemlookup.superclass.initComponent.call(this)}});

...
IG$.p$DataMgr=$s.extend(IG$.v$pnl,{closable:!0,hideMode:"offsets",layout:"fit",bodyPadding:0,iconCls:"icon-dataset",_init:function(){var e=this;e.uid?e.loadContent():(e._mc=e._mc||{},e.loadUserDB())},loadContent:function(){var e=new IG$._rpc$;e.init(this,{ack:"content",payload:{uid:this.uid,revision:this.revision},mbody:{option:"content"}},this,(function(e){var t=this;t._mc=e.content||{},t.down("[name=t_save]").setVisible(t._mc.writable),t.loadJoins(),t.loadUserDB(!0)})),e.send()},loadJoins:function(){var e,t,a,i=this._mc.joins,n=this.down("[name=m2]"),s=[];if(i&&i.length)for(a=0;a<i.length;a++)(t={stable:(e=i[a]).source?e.source.tableuid:null,sfield:e.source?e.source.uid:null,stablename:e.source?e.source.tablename:null,sfieldname:e.source?e.source.name:null,ttable:e.target?e.target.tableuid:null,tfield:e.target?e.target.uid:null,ttablename:e.target?e.target.tablename:null,tfieldname:e.target?e.target.name:null,oprel:e.join}).sdesc=t.stablename+"."+t.sfieldname,t.tdesc=t.ttablename+"."+t.tfieldname,s.push(t);n.store.loadData(s)},showLinkEditor:function(e){var t,a,i=this.down("[name=m1]"),n=this.down("[name=m2]"),s=[];for(t=0;t<i.store.data.items.length;t++)a=i.store.data.items[t],s.push({name:a.get("name"),uid:a.get("uid")});new IG$.dsjoin({tables:s,srcrec:e,callback:new IG$.callBackObj(this,(function(t){this._mc;e?(e.set("stable",t.stable),e.set("sfield",t.sfield),e.set("stablename",t.stablename),e.set("sfieldname",t.sfieldname),e.set("ttable",t.ttable),e.set("tfield",t.tfield),e.set("ttablename",t.ttablename),e.set("tfieldname",t.tfieldname),e.set("sdesc",t.stablename+"."+t.sfieldname),e.set("tdesc",t.ttablename+"."+t.tfieldname)):(t.sdesc=t.stablename+"."+t.sfieldname,t.tdesc=t.ttablename+"."+t.tfieldname,n.store.add(t))}))}).show(null)},loadUserDB:function(e){var t=new IG$._rpc$,a=this.bobj_datasource?this.bobj_datasource.uid:null;t.init(this,{ack:"userdb",payload:{address:"/Connections",option:"list"},mbody:{}},this,(function(t){var i,n,s=this,l=t.children,o=[];if(l&&l.length){for(i=0;i<l.length;i++)l[i].attributes&&"T"==l[i].attributes.attrb1&&!l[i].scid&&(o.push(l[i]),a&&a==l[i].uid&&(n=l[i]));if(s.bobj_uid)return s._mc.datasource=n||null,void s._startapp();var d;if(o.length){if(s._mc.datasource)for(i=0;i<o.length;i++)if(o[i].uid==s._mc.datasource.uid){d=o[i];break}if(!d&&s._mc.datasource)return void IG$.ShowError(IRm$.r1("E_DS_NOT_ALLOW_UPLOAD"),s);if(!e||e&&!s._mc.datasource_selected)return dlg=new IG$.dlg_select_ds({datasource:s._mc.datasource,callback:new IG$.callBackObj(s,(function(e){s._mc.datasource=e?{uid:e.data.uid,name:e.data.name}:null,s._mc.datasource||IG$.alertmsg(ig$.appname,"File upload will be on temporary filespaces!",null,s,1,"info",null,null,null,0),s._startapp()}))}),void IG$.checkLogin(s,dlg);s._startapp()}else e||(IG$.alertmsg(ig$.appname,"File upload will be on temporary filespaces!",null,s,1,"info",null,null,null,0),s._mc.datasource=null),s._startapp()}else e&&s._startapp()}),!1),t.send()},_startapp:function(){var e=this,t=e.down("[name=_m5]"),a=e.down("[name=dbareq]");t.store.loadData(e._mc.datafiles),a.setVisible(!(!1!==ig$.features.ig_n_dataset_dba||!e._mc.datasource)),e.uid?e.getTbls():e.uploadFile()},getTbls:function(){var e=this,t=new IG$._rpc$;t.init(e,{ack:"content",payload:{uid:e.uid},mbody:{subfolder:"T"}},e,(function(t){var a,i,n=t&&t.children?t.children:null,s=e.down("[name=m1]"),l=e.down("[name=m1f]"),o=e.down("[name=t_btn]"),d=[];if(n)for(i=0;i<n.length;i++)a=n[i],d.push(a);s.store.loadData(d),l.store.loadData([]),o.setDisabled(!0)})),t.send()},uploadFile:function(e){var t=new IG$.ExcelFileUploader({callback:new IG$.callBackObj(this,this.rs_uploadFile,e)});IG$.checkLogin(this,t)},rs_uploadFile:function(e,t){this.loadFileToTbl({fileuid:e.fileuid,datalabel:e.datalabel,uploadmode:e.uploadmode,delimiter:e.delimiter,targetsheet:e.targetsheet},t)},loadColumnInfo:function(e){var t,a=this.down("[name=m3]");t=e.get("columns"),a.store.loadData(t),this.updateColumnInfo(e)},previewData:function(e){var t=new IG$._rpc$,a=e.get("files"),i=a.length?a[a.length-1].uid:null;i?(t.init(this,{ack:"uploadcontent",payload:{uid:i,sheetname:e.get("sheetname"),count:"100"},mbody:{option:"preview_mdt"}},this,(function(e){if(IG$.dlgLoadPreview){new IG$.dlgLoadPreview({dataset:e}).show()}else{var t=ig$.bootconfig.scmap.igcn;IG$.getScriptCache(t,new IG$.callBackObj(this,(function(){IG$.dlgLoadPreview?new IG$.dlgLoadPreview({dataset:e}).show():IG$.ShowError(IRm$.r1("L_ERR_L_MOD"))})))}})),t.send()):IG$.alertmsg(ig$.appname,"No file is registered on this item!",null,null,0,"warning")},updateColumns:function(){var e,t=this._m5sel,a=(this.down("[name=m3]"),{});return t&&(e=t.get("columns"),$.each(e,(function(e,t){a[t.pname]=t}))),t},appendColumn:function(e){var t,a,i=this._m5sel,n=this.down("[name=m3]");for(t=0;t<n.store.data.items.length;t++)if(n.store.data.items[t].get("fieldname").toUpperCase()==e){a=1;break}if(a)IG$.alertmsg(ig$.appname,"Already appended same field information!",null,null,0,"warning");else{var s={name:e,fieldname:e,fielduid:e,physicalname:e,datatype:"string",datasize:50};n.store.add(s),i.get("columns").push(s)}},pstatus_map:{1:"WAITING",9:"REJECTed - {DESC}",2:"ACCEPTed and created table"},requestTable:function(){var e,t=this,a=new IG$._rpc$;t.uid?(e=t.updateColumns())&&(a.init(t,{ack:"uploadcontent",payload:{uid:t._mc.uid,fuid:e.get("uid")},mbody:{option:"reqdba"}},t,(function(e){if(e&&e.pstatus){var a="Data already requested (";a=(a+=t.pstatus_map[e.pstatus]).replace("{DESC}",e.description||""),a+=")",IG$.alertmsg(ig$.appname,a,null,null,0,"success")}else IG$.alertmsg(ig$.appname,"Requested meta creation to admin! Please save content to update last information!",null,null,0,"success")})),a.send()):IG$.ShowError(IRm$.r1("E_SAVE_CONTENT"),t)},createTable:function(){var e,t=this,a=new IG$._rpc$;e=t.updateColumns(),t.uid?e&&(a.init(t,{ack:"uploadcontent",payload:{uid:t._mc.uid,fuid:e.get("uid")},mbody:{option:"create_tb"}},t,(function(e){var t,a,i,n=this,s={};for(IG$.alertmsg(ig$.appname,"Content saved successfully!",null,null,0,"success"),n._mc=n._mc||{},t=0;t<n._mc.datafiles.length;t++)s[n._mc.datafiles[t].name]=n._mc.datafiles[t];for(t=0;t<e.content.datafiles.length;t++)s[(a=e.content.datafiles[t]).name]&&((i=s[a.name]).dataset_meta=a.dataset_meta,i.columns=a.columns);n._startapp()})),a.send()):IG$.ShowError(IRm$.r1("E_SAVE_CONTENT"),t)},requestTableList:function(){var e=this,t=new IG$._rpc$,a=e.down("[name=dbareq]");a.setVisible(!1===ig$.features.ig_n_dataset_dba),t.init(e,{ack:"uploadcontent",payload:{uid:e._m5sel?e._m5sel.get("uid"):"",mode:"ALL"},mbody:{option:"reqdba_lists"}},e,(function(e){var t;for(e=e||[],t=0;t<e.length;t++)e[t].status=this.pstatus_map[e[t].pstatus];a.store.loadData(e)})),t.send()},getCreateScript:function(){var e,t=new IG$._rpc$;(e=this.updateColumns())&&(t.init(this,{ack:"uploadcontent",payload:{uid:e.get("uid"),sheetname:e.get("sheetname"),option:"create_script"},mbody:this._mc,meta_type:"dataset"},this,(function(e){var t=new IG$.dlgsqlview({sql:e.CREATE});IG$.checkLogin(this,t),IG$.alertmsg(ig$.appname,"Save content to finalize query!",null,null,0,"success")})),t.send())},getPhysicalTable:function(e){var t,a,i,n=this.down("[name=m1]");for(t=0;t<n.store.data.items.length;t++)if((i=(a=n.store.data.items[t]).get("attributes"))&&i.attrb2==e.get("pname"))return a},updateColumnInfo:function(e){var t=this,a=t._mc.datasource,i=new IG$._rpc$,n=t.getPhysicalTable(e),s=(t.down("[name=m3]"),t.down("[name=btn_create_req]")),l=t.down("[name=btn_create]"),o=t.down("[name=btn_sys_key]"),d=t.down("[name=btn_sql]");o.setVisible(!0),d.setVisible(!0),s.setVisible(!(!a||n||!1!==ig$.features.ig_n_ds_reqb)),l.setVisible(!n&&!1===ig$.features.ig_n_ds_sddlb),n&&(prop={uid:n.get("uid"),option:"StoredContent"},i.init(t,{ack:"tablecontent",payload:prop,mbody:{option:prop.option}},t,(function(e){}),!1),i.send())},loadFileToTbl:function(e,t){this._ltb;var a=this.down("[name=_m5]"),i=new IG$._rpc$;i.init(this,{ack:"uploadcontent",payload:{fileuid:e.fileuid,datalabel:e.datalabel,uploadmode:e.uploadmode,delimiter:e.delimiter,targetsheet:e.targetsheet},mbody:{option:"register_mdt"}},this,(function(i){var n,s,l,o,d=this._mc;if(d.datafiles=d.datafiles||[],i.results&&i.results.length){for(n=0;n<i.results.length;n++)if(l=i.results[n],s={uid:l.uid,name:i.name,filename:i.name,sheetid:n,sheetname:l.name||"sheet_"+n,pname:l.pname,columns:[],files:[]},!(t&&t.get("sheetname")!=s.sheetname&&i.results.length>1)){if(t){(s=t.data).files.push({uid:e.fileuid,name:i.name}),o=1;break}$.each(i.results[n].headers,(function(e,t){var a=t;s.columns.push(a)})),s.files.push({uid:e.fileuid,name:i.name}),d.datafiles.push(s),a.store.add(s)}t&&!o&&IG$.alertmsg(ig$.appname,"Same sheet item not found for this upload!",null,null,0,"warning")}})),i.send()},saveAsContent:function(e){var t=new IG$.metaSelectDlg({mode:"newitem",tree_options:{rootuid:this.bobj_uid||"/"},callback:new IG$.callBackObj(this,this.saveNewContent,e)});IG$.checkLogin(this,t)},saveNewContent:function(e,t){$s.apply(this._mc,{name:e.name,address:e.nodepath+"/"+e.name,pid:e.uid}),this.saveContent(!0)},saveContent:function(e){var t,a,i,n=this._mc,s=new IG$._rpc$,l=n,o=this.down("[name=m2]");for(t=e?{pid:n.pid,address:n.address,name:n.name,type:"DataSet"}:{uid:n.uid},l.joins=[],i=0;i<o.store.data.items.length;i++)a=o.store.data.items[i],l.joins.push({source:{uid:a.get("sfield"),name:a.get("sfieldname"),tableuid:a.get("stable"),tablename:a.get("stablename")},target:{uid:a.get("tfield"),name:a.get("tfieldname"),tableuid:a.get("ttable"),tablename:a.get("ttablename")},join:a.get("oprel")});l.datasource_selected=!0,s.init(this,{ack:"writecontent",payload:t,mbody:l,meta_type:"dataset"},this,(function(e){this.uid=e.uid,this._mc.uid=e.uid,this._mc.name=e.name,this.setTitle(e.name),IG$.alertmsg(ig$.appname,IRm$.r1("M_SAVED"),null,null,0,"success")}),null),s.send()},_load_ds:function(){var e=this,t=IG$.mainPanel;return e._mc&&e._mc.datasource&&e._mc.datasource.uid&&t.navigateApp(e._mc.datasource.uid,"userdb",e._mc.datasource.name,null,!1,!0,{}),!0},_rmDs:function(e){var t,a,i=this,n=i.down("[name=_m5]"),s=i.down("[name=m3]"),l=i._mc.datafiles,o=-1,d=e.get("uid"),r=n.store;for(a=0;a<l.length;a++)l[a].uid==d&&(t=l[a],o=a);if(t&&t.dataset_meta){var c=new IG$._rpc$;c.init(i,{ack:"deletecontent",payload:{uid:t.dataset_meta.uid},mbody:{}},i,(function(){l.splice(o,1),r.remove(e),s.store.loadData([]),this.getTbls()})),c.send()}else l.splice(o,1),r.remove(e),s.store.loadData([])},createItem:function(e,t){var a=this,i=a._s1;i&&IG$._createMetaObject.call(a,e,i.get("uid"),i.get("nodepath"),i,new IG$.callBackObj(a,(function(e,t){a._s1&&a.load_fields(a._s1)})))},load_fields:function(e){var t=this,a=new IG$._rpc$,i=e.get("uid");i&&(a.init(t,{ack:"content",payload:{uid:i},mbody:{subfolder:"T"}},t,(function(e){var a=e&&e.children?e.children:null,i=t.down("[name=m1f]"),n=t.down("[name=t_btn]");i.store.loadData(a),n.setDisabled(!1)})),a.send())},edit_dimension:function(e){var t=IG$.mainPanel,a=e.get("type").toLowerCase();"link"==a&&(a=e.get("rawtype").toLowerCase()),t&&"folder"!=a&&"table"!=a&&"inlineview"!=a&&t.navigateApp.call(t,e.get("uid"),a,e.get("name"),e.get("nodepath"),!0,1==e.get("writable"),{cubeuid:this.uid,obj_uid:this.uid,callback:new IG$.callBackObj(this,(function(t){t&&e.set("name",t.name)}))})},initComponent:function(){var e=this;$s.apply(e,{layout:"fit",tbar:[{xtype:"button",iconCls:"icon-toolbar-save",name:"t_save",text:IRm$.r1("B_SAVE"),tooltip:IRm$.r1("L_SAVE_REPORT"),handler:function(){this.uid?this.saveContent():this.saveAsContent(!1)},scope:this},"-",{iconCls:"icon-upload",tooltip:"Upload File",name:"tb_upload",handler:function(){this.uploadFile()},scope:this},"-",{iconCls:"icon-refresh",tooltip:IRm$.r1("B_REFRESH"),handler:function(){this.getTbls()},scope:this},"->",{iconCls:"icon-report",text:IRm$.r1("M_REPORT"),hidden:e.bobj_uid,handler:function(){var t=IG$.mainPanel;if(e.uid){var a=e._mc.datasource?e._mc.datasource.uid:e._mc.uid;t.navigateApp.call(t,null,"report","New Report",null,!0,!0,{cubeuid:a,load_cube:{cube_objects:[{uid:e._mc.uid,name:e._mc.name,cubeuid:a,type:e._mc.type||"DataSet"}],ds_object:{uid:a,name:e._mc.datasource?e._mc.datasource.name:e._mc.name}}})}else IG$.ShowError(IRm$.r1("E_SAVE_CONTENT"),e)},scope:this},{xtype:"button",hidden:ig$.$l_>5||e.bobj_uid,text:IRm$.r1("L_SEL_DB"),handler:function(){var e=this;IG$.confirmMessages(ig$.appname,e._mc.name+" "+IRm$.r1("M_CONFIRM_DS_CHANGE"),(function(t){"yes"==t&&e.loadUserDB()}))},scope:this}],items:[{xtype:"tabpanel",items:[{xtype:"panel",region:"center",title:IRm$.r1("L_UPLOADED_FILE"),flex:1,layout:{type:"hbox",align:"stretch"},items:[{xtype:"gridpanel",title:IRm$.r1("L_UPLOADED_FILE"),flex:1,name:"_m5",store:{fields:["filename","uid","sheetname"]},selType:"checkboxmodel",selModel:{mode:"MULTI"},columns:[{text:IRm$.r1("B_NAME"),flex:1,tdCls:"igc-td-link",dataIndex:"filename"},{text:IRm$.r1("L_SHEET_NAME"),flex:1,dataIndex:"sheetname",tdCls:"itc-td-link"},{text:IRm$.r1("L_PHYSICAL_NAME"),flex:1,dataIndex:"pname",tdCls:"itc-td-link"},{xtype:"actioncolumn",width:80,items:[{iconCls:"icon-grid-config",tooltip:"Config item",handler:function(e,t,a){var i=e.store.getAt(t);this.loadColumnInfo(i)},scope:this},{iconCls:"icon-upload",tooltip:"Upload item",handler:function(e,t,a){var i=e.store.getAt(t);this.uploadFile(i)},scope:this},{iconCls:"icon-history",tooltip:"History",handler:function(e,t,a){var i,n=e.store.getAt(t);i=new IG$.dlg_file_history({uid:this._mc.uid,rec:n}),IG$.checkLogin(this,i)},scope:this},{iconCls:"icon-grid-delete",tooltip:IRm$.r1("L_REMOVE"),handler:function(e,t,a){var i=this,n=e.store.getAt(t);IG$.confirmMessages(IRm$.r1("B_CONFIRM"),IRm$.r1("M_CONFIRM_DELETE"),(function(e){"yes"==e&&i._rmDs(n)}))},scope:this}]}],listeners:{cellclick:function(e,t,a,i,n,s){var l,o=this;o._m5sel=i,1==a?o.loadColumnInfo(i):2==a?o.previewData(i):3==a&&(l=new IG$.dlg_file_history({uid:o._mc.uid,rec:i}),IG$.checkLogin(o,l))},scope:this}},{xtype:"gridpanel",title:IRm$.r1("L_CUSTOM_FIELDS"),name:"m3",flex:1,selType:"checkboxmodel",selModel:{mode:"MULTI"},store:{xtype:"store",fields:[]},columns:[{xtype:"checkcolumn",text:IRm$.r1("B_KEY"),dataIndex:"iskey",width:40},{text:IRm$.r1("B_NAME"),dataIndex:"name",tdCls:"igc-td-link",minWidth:120,flex:1},{text:IRm$.r1("L_HEADER_NAME"),dataIndex:"fieldname"},{text:IRm$.r1("L_PHYSICAL_NAME"),dataIndex:"physicalname"},{text:IRm$.r1("L_DATA_TYPE"),dataIndex:"datatype",width:80},{text:IRm$.r1("L_SIZE"),width:60,dataIndex:"datasize"}],listeners:{cellclick:function(e,t,a,i,n,s){var l;2==a&&(l=new IG$.dlg_column_prop({rec:i}),IG$.checkLogin(this,l))},scope:this},bbar:[{xtype:"displayfield",value:" "},{xtype:"button",hidden:!0,name:"btn_sys_key",text:IRm$.r1("L_ADD_SYS_KEY"),menu:{xtype:"menu",items:[{text:IRm$.r1("L_FILENAME"),handler:function(){this.appendColumn("FILENAME")},scope:this},{text:IRm$.r1("L_USERID"),handler:function(){this.appendColumn("USERID")},scope:this},{text:IRm$.r1("L_DATE_IMPORTED"),hidden:!1!==ig$.features.ig_n_fm,handler:function(){this.appendColumn("DATE")},scope:this}]}},"->",{xtype:"button",name:"btn_update",text:IRm$.r1("B_UPD"),handler:function(){var e,t,a=[],i=this.down("[name=m3]").getSelectionModel().selected;for(t=0;t<i.length;t++)a.push(i.items[t]);a.length&&(e=new IG$.dlg_column_prop({rec:a.length>1?null:a[0],records:a.length>1?a:null}),IG$.checkLogin(this,e))},scope:this},{xtype:"button",hidden:!0,name:"btn_create_req",text:IRm$.r1("L_REQ_CRT_TABLE"),handler:function(){this.requestTable()},scope:this},{xtype:"button",hidden:!0,name:"btn_create",text:IRm$.r1("L_CRT_TBL"),handler:function(){this.createTable()},scope:this},{xtype:"button",hidden:!0,name:"btn_sql",text:IRm$.r1("L_SCRIPT"),handler:function(){this.getCreateScript()},scope:this}]}]},{xtype:"container",title:IRm$.r1("L_TABLE_LIST"),layout:{type:"vbox",align:"stretch"},items:[{xtype:"container",layout:{type:"hbox",align:"stretch"},items:[{xtype:"gridpanel",name:"m1",title:IRm$.r1("L_TABLE_LIST"),flex:1,store:{xtype:"store",fields:["type","name","uid"]},columns:[{text:IRm$.r1("B_TYPE"),dataIndex:"type",width:80},{text:IRm$.r1("B_NAME"),dataIndex:"name",tdCls:"igc-td-link",flex:1}],tbar:[{text:IRm$.r1("L_EDIT_SRC"),handler:function(){this._mc.uid?this._load_ds():IG$.ShowError(IRm$.r1("E_SAVE_CONTENT"),this)},scope:this}],listeners:{cellclick:function(e,t,a,i,n,s){this._s1=i,this.load_fields(this._s1)},scope:this}},{xtype:"gridpanel",name:"m1f",title:IRm$.r1("L_FIELDS"),flex:2,store:{xtype:"store",fields:["type","name","uid"]},columns:[{text:IRm$.r1("B_TYPE"),dataIndex:"type",width:80},{text:IRm$.r1("B_NAME"),dataIndex:"name",tdCls:"igc-td-link",flex:1}],listeners:{cellclick:function(e,t,a,i,n,s){"Field"!=i.get("type")&&this.edit_dimension(i)},scope:this},tbar:[{xtype:"button",name:"t_btn",text:IRm$.r1("L_CREATE_ITEM"),disabled:!0,menu:{xtype:"menu",items:[{text:IRm$.r1("D_FOLDER"),hidden:!1!==ig$.features.ig_n_f_f,handler:function(){this.createItem("Folder")},scope:this},"-",{text:IRm$.r1("D_CUSTOMMETRIC"),hidden:!1!==ig$.features.ig_n_cm,handler:function(){this.createItem("CustomMetric")},scope:this},{text:IRm$.r1("D_MEASURE"),hidden:!1!==ig$.features.ig_n_ms,handler:function(){this.createItem("Measure")},scope:this},{text:IRm$.r1("D_FORMULA"),hidden:!1!==ig$.features.ig_n_fm,handler:function(){this.createItem("FormulaMeasure")},scope:this},"-",{text:IRm$.r1("D_DATEMETRIC"),hidden:!1!==ig$.features.ig_n_dm,handler:function(){this.createItem("DateMetric")},scope:this},{text:IRm$.r1("D_CHARTMEASURE"),hidden:!1!==ig$.features.ig_n_cms,handler:function(){this.createItem("ChartMeasure")},scope:this},{text:IRm$.r1("D_HIERARCHY"),hidden:!1!==ig$.features.ig_n_hm,handler:function(){this.createItem("Hierarchy")},scope:this},{text:IRm$.r1("D_UDG"),hidden:!1!==ig$.features.ig_n_udg,handler:function(){this.createItem("UDG")},scope:this}]}}]}]},{xtype:"container",layout:{type:"hbox",align:"stretch"},items:[{xtype:"gridpanel",name:"m2",title:IRm$.r1("L_RELATIONS"),flex:2,store:{xtype:"store",fields:["type","name","uid"]},columns:[{text:IRm$.r1("L_I_FROM"),flex:1,dataIndex:"sdesc"},{text:IRm$.r1("L_I_TO"),flex:1,dataIndex:"tdesc"},{xtype:"actioncolumn",width:45,items:[{iconCls:"icon-grid-config",tooltip:"Config item",handler:function(e,t,a){var i=e.store.getAt(t);this.showLinkEditor(i)},scope:this},{iconCls:"icon-grid-delete",tooltip:"Delete item",handler:function(e,t,a){var i=e.store.getAt(t);e.store.remove(i)}}]}],tbar:[{text:IRm$.r1("L_ADD_JOIN"),handler:function(){this.showLinkEditor()},scope:this}]},{xtype:"gridpanel",name:"dbareq",title:IRm$.r1("L_DBA_REQ"),hidden:!1!==ig$.features.ig_n_dataset_dba,flex:1,store:{fields:[]},tbar:["->",{text:IRm$.r1("B_REFRESH"),handler:function(){this.requestTableList()},scope:this}],columns:[{text:IRm$.r1("B_NAME"),flex:1,dataIndex:"cname"},{text:IRm$.r1("L_USERID"),dataIndex:"userid"},{text:IRm$.r1("B_STATUS"),dataIndex:"status"},{text:IRm$.r1("B_DATE"),dataIndex:"createdatefm"},{text:IRm$.r1("L_UPD_DATE"),dataIndex:"updatedatefm"}]}]}]}]}],listeners:{afterrender:function(e){e._init()},scope:this}}),IG$.p$DataMgr.superclass.initComponent.call(this)}}),IG$.dlg_file_history=$s.extend($s.window,{width:400,layout:"fit",padding:5,height:500,loadDatasetData:function(e){var t,a=this,i=new IG$._rpc$,n=a.down("[name=grdupload]").getSelectionModel().selected,s=a.rec,l={children:[],items:[]};if(e||0!=n.length)if(a.uid){if(!e)for(t=0;t<n.items.length;t++)l.children.push({uid:n.items[t].get("uid"),name:n.items[t].get("name")});i.init(a,{ack:"uploadcontent",payload:{uid:a.uid,fuid:s.get("uid"),option:"insert_mdt"},mbody:l,meta_type:"metrics"},a,(function(e){IG$.alertmsg(ig$.appname,"Data insert completed (record count : "+(e.datacount||"")+")",null,null,0,"success")})),i.send()}else IG$.ShowError(IRm$.r1("E_SAVE_CONTENT"),a);else IG$.alertmsg(ig$.appname,"No items selected!",null,null,0,"warning")},previewData:function(e){var t=new IG$._rpc$,a=e.get("uid"),i=this.rec;t.init(this,{ack:"uploadcontent",payload:{uid:a,sheetname:i.get("sheetname"),count:"100"},mbody:{option:"preview_mdt"}},this,(function(e){if(IG$.dlgLoadPreview){new IG$.dlgLoadPreview({dataset:e}).show()}else{var t=ig$.bootconfig.scmap.igcn;IG$.getScriptCache(t,new IG$.callBackObj(this,(function(){IG$.dlgLoadPreview?new IG$.dlgLoadPreview({dataset:e}).show():IG$.ShowError(IRm$.r1("L_ERR_L_MOD"))})))}})),t.send()},initComponent:function(){$s.apply(this,{title:IRm$.r1("L_FILE_UPLOAD_HIST"),items:[{xtype:"panel",layout:{type:"vbox",align:"stretch"},padding:5,items:[{xtype:"gridpanel",name:"grdupload",selType:"checkboxmodel",selModel:{mode:"MULTI"},flex:1,store:{fields:[]},bbar:[{xtype:"button",text:IRm$.r1("L_LD_INTO_TBL"),handler:function(){this.loadDatasetData()},scope:this},{xtype:"button",text:IRm$.r1("L_CLR_TBL"),handler:function(){var e=this;e.uid?IG$.confirmMessages(IRm$.r1("B_CONFIRM"),IRm$.r1("L_TB_BN"),(function(t){"yes"==t&&e.loadDatasetData(!0)})):IG$.ShowError(IRm$.r1("E_SAVE_CONTENT"),e)},scope:this}],columns:[{flex:1,text:IRm$.r1("B_NAME"),dataIndex:"name",tdCls:"igc-td-link"},{xtype:"actioncolumn",width:40,items:[{iconCls:"icon-grid-delete",tooltip:"Delete Item",handler:function(e,t,a){var i,n=e.store.getAt(t),s=this.rec;for(e.store.removeAt(t),i=0;i<s.data.files.length;i++)if(s.data.files[i].uid==n.get("uid")){s.data.files.splice(i,1);break}},scope:this}]}],listeners:{cellclick:function(e,t,a,i,n,s){1==a&&this.previewData(i)},scope:this}}]}],buttons:["->",{xtype:"button",text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this.rec&&this.down("[name=grdupload]").store.loadData(this.rec.data.files)}}}),IG$.dlg_file_history.superclass.initComponent.call(this)}}),IG$.dlg_column_prop=$s.extend($s.window,{width:400,layout:"fit",padding:5,autoHeight:!0,initComponent:function(){var e=this;$s.apply(e,{title:IRm$.r1("L_COLUMN_PROP"),items:[{xtype:"panel",layout:{type:"vbox",align:"stretch"},padding:5,items:[{xtype:"fieldset",title:IRm$.r1("L_COLUMN_PROP"),layout:{type:"vbox",align:"stretch"},items:[{xtype:"textfield",name:"name",fieldLabel:IRm$.r1("B_NAME"),required:!e.records,disabled:!!e.records},{xtype:"textfield",name:"fieldname",readOnly:!0,fieldLabel:IRm$.r1("L_HEADER_NAME"),required:!e.records,disabled:!!e.records},{xtype:"textfield",name:"physicalname",fieldLabel:IRm$.r1("L_PHYSICAL_NAME"),disabled:!!e.records},{xtype:"combobox",name:"datatype",fieldLabel:IRm$.r1("L_DATA_TYPE"),required:!0,displayField:"name",valueField:"value",store:{data:[{name:"string",value:"VARCHAR"},{name:"number",value:"NUMERIC"},{name:"decimal",value:"NUMERIC"},{name:"date",value:"DATE"}]}},{xtype:"numberfield",name:"datasize",fieldLabel:IRm$.r1("L_DATA_SIZE"),required:!e.records},{xtype:"checkbox",boxLabel:IRm$.r1("B_ENABLED"),fieldLabel:IRm$.r1("L_IS_KEY"),name:"iskey",disabled:!!e.records}]}]}],buttons:["->",{xtype:"button",text:IRm$.r1("B_CONFIRM"),handler:function(){var e,t,a=this,i={};if(a.rec){if(a.getAllValues(a.rec.data))return;a.rec.refresh()}else if(a.records){if(a.getAllValues(i))return;for(e=0;e<a.records.length;e++)(t=a.records[e]).set("datatype",i.datatype),i.datasize>0&&t.set("datasize",i.datasize)}a.close()},scope:this},{xtype:"button",text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this.rec&&e.setAllValues(this.rec.data)}}}),IG$.dlg_column_prop.superclass.initComponent.call(this)}}),IG$.dsjoin=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",closable:!1,resizable:!1,width:420,autoHeight:!0,callback:null,_curLink:null,_init:function(){var e,t,a,i=this,n=[{name:IRm$.r1("B_SELECT"),uid:""}],s=[{name:IRm$.r1("B_SELECT"),uid:""}],l=i.srcrec?i.srcrec.data:null;if(i.tables){for(a=0;a<i.tables.length;a++)n.push({name:i.tables[a].name,uid:i.tables[a].uid}),s.push({name:i.tables[a].name,uid:i.tables[a].uid});(e=i.down("[name=stable]")).store.loadData(n),(t=i.down("[name=ttable]")).store.loadData(s),e.setValue(l?l.stable:""),t.setValue(l?l.ttable:"")}i.down("[name=oprel]").setValue(l?l.oprel:"")},_confirm:function(){var e=this,t={};e.getAllValues(t)||($.each(["stable","sfield","ttable","tfield"],(function(a,i){var n,s,l;for(n=e.down("[name="+i+"]").store,s=0;s<n.data.items.length;s++)if((l=n.data.items[s]).get("uid")==t[i]){t[i+"name"]=l.get("name");break}})),e.callback&&e.callback.execute(t),e.close())},_get_columns:function(e,t,a){var i=this,n=new IG$._rpc$;e?(n.init(i,{ack:"content",payload:{uid:e},mbody:{subfolder:"T"}},i,(function(e){var n,s,l,o=e&&e.children?e.children:null,d=i.down("[name="+t+"]"),r=[{name:IRm$.r1("B_SELECT"),uid:""}];if(o)for(s=0;s<o.length;s++)(n=o[s]).uid==a&&(l=n.uid),r.push(n);d.store.loadData(r),d.setValue(l||"")})),n.send()):i.down("[name="+t+"]").store.loadData([])},initComponent:function(){$s.apply(this,{padding:10,title:IRm$.r1("L_JOIN_REL_EDITOR"),items:[{xtype:"form",layout:{type:"vbox",align:"stretch"},padding:10,items:[{xtype:"fieldcontainer",layout:{type:"vbox",align:"stretch"},name:"sfield_cnt",items:[{xtype:"combobox",fieldLabel:IRm$.r1("L_SOURCE_FIELD"),name:"stable",queryMode:"local",autoSelect:!0,autoScroll:!0,editable:!1,labelField:"name",displayField:"name",valueField:"uid",required:!0,store:{fields:["name","uid"]},listeners:{change:function(e,t,a,i){var n=e.getValue();this._get_columns(n,"sfield",this.srcrec?this.srcrec.get("sfield"):"")},scope:this}},{xtype:"combobox",name:"sfield",fieldLabel:" ",queryMode:"local",autoSelect:!0,autoScroll:!0,editable:!1,labelField:"name",displayField:"name",valueField:"uid",required:!0,store:{fields:["name","uid"]}}]},{xtype:"fieldcontainer",layout:{type:"vbox",align:"stretch"},name:"tfield_cnt",items:[{xtype:"combobox",fieldLabel:IRm$.r1("L_TARGET_FIELD"),name:"ttable",queryMode:"local",autoSelect:!0,autoScroll:!0,editable:!1,labelField:"name",displayField:"name",valueField:"uid",required:!0,store:{fields:["name","uid"]},listeners:{change:function(e,t,a,i){var n=e.getValue();this._get_columns(n,"tfield",this.srcrec?this.srcrec.get("tfield"):"")},scope:this}},{xtype:"combobox",name:"tfield",fieldLabel:" ",queryMode:"local",autoSelect:!0,autoScroll:!0,editable:!1,labelField:"name",displayField:"name",valueField:"uid",required:!0,store:{fields:["name","uid"]}}]},{xtype:"fieldset",layout:{type:"vbox",align:"stretch"},defaults:{labelWidth:150},title:IRm$.r1("L_OPTIONS"),items:[{xtype:"combobox",name:"oprel",fieldLabel:IRm$.r1("L_SRC_TO_TGT_IS"),queryMode:"local",autoSelect:!0,editable:!1,valueField:"op",displayField:"name",labelField:"name",required:!0,$w:390,store:{fields:["name","op","desc"],data:[{name:"Inner equal",op:"INNER JOIN",desc:"Show only match values"},{name:"Left outer",op:"LEFT OUTER",desc:"Show all source values even not match"},{name:"Right outer",op:"RIGHT OUTER",desc:"Show all target values even not match"},{name:"Auto natural",op:"NATURAL",desc:"Automatic join with column foreign key"},{name:"Full outer",op:"FULL OUTER",desc:"Show all source and target values"}]},listeners:{change:function(e){var t,a,i,n=e.getValue(),s=this.down("[name=op_desc]");for(a=0;a<e.store.data.items.length;a++)if((i=e.store.data.items[a]).get("op")==n){t=i;break}t&&s.setValue("* "+t.get("desc"))},scope:this}},{xtype:"displayfield",name:"op_desc"}]}]}],buttons:[{text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){this._init()}}}),IG$.dsjoin.superclass.initComponent.apply(this,arguments)}});
...
IG$.dlg_chart_clr=$s.extend($s.window,{width:500,height:520,layout:"fit",padding:5,_init:function(){this.down("[name=theme_name]").setValue("")},_confirm:function(e){var t,a,l=this,n=l.down("[name=theme_name]"),o=l.chart_color_map;for(t in l._cur_target&&(l._confirm_target(),l._cur_target=null),o)delete o[t];for(a=0;a<n.store.data.items.length;a++)(e=n.store.data.items[a]).$r&&e.$r.value&&(o[e.get("name")]=e.data.data||[]);l.callback&&l.callback.execute(),l.close()},load_colorset:function(){var e,t,a,l,n=this,o=n.down("[name=theme_name]"),s=n.down("[name=dsource]"),r=o.getValue(),i=[];for(n._cur_target&&(n._confirm_target(),n._cur_target=null),a=0;a<o.store.data.items.length;a++)if((e=o.store.data.items[a]).get("value")==r){t=e;break}if(t){for(l=t.data.data,n._cur_target=t,a=0;a<l.length;a++)i.push({value:l[a]});s.store.loadData(i)}},_confirm_target:function(){var e,t,a=this.down("[name=dsource]"),l=this._cur_target,n=[];for(e=0;e<a.store.data.items.length;e++)(t=a.store.data.items[e]).get("value")&&n.push(t.get("value"));l.data.data=n},changeOrder:function(e){var t,a,l=this.down("[name=dsource]"),n=l.getSelectionModel(),o=n.selected;o&&1==o.length&&(a=o.items[0],t=l.store.indexOf(a),-1==e?t>0&&(l.store.remove(a),a=l.store.insert(t-1,a),n.select(a,!0)):t+1<l.store.data.items.length&&(l.store.remove(a),a=l.store.insert(t+1,a),n.select(a,!0)))},initComponent:function(){var e,t=[{name:IRm$.r1("B_SELECT"),value:""}],a=this.chart_color_map;for(e in a)t.push({name:e,value:e,data:a[e]});$s.apply(this,{title:IRm$.r1("L_CHART_COLOR_ORG"),items:[{xtype:"panel",padding:10,layout:{type:"vbox",align:"stretch"},items:[{xtype:"fieldset",title:IRm$.r1("L_CHART_COLOR"),layout:{type:"vbox",align:"stretch"},items:[{xtype:"container",name:"m_selector",layout:{type:"hbox",align:"stretch"},items:[{xtype:"combobox",name:"theme_name",fieldLabel:IRm$.r1("B_NAME"),displayField:"name",labelWidth:60,labelAlign:"right",valueField:"value",editable:!1,queryMode:"local",flex:1,store:{fields:["name","value"],data:t},listeners:{change:function(e,t,a,l){this.load_colorset()},scope:this}},{xtype:"button",text:IRm$.r1("L_ADD_NEW"),handler:function(){var e=this.down("[name=m_new_item]"),t=this.down("[name=m_selector]");this.down("[name=theme_new_name]").setValue(""),e.setVisible(!0),t.setVisible(!1)},scope:this},{xtype:"button",text:IRm$.r1("L_REMOVE"),handler:function(){var e,t=this.down("[name=theme_name]"),l=[{name:IRm$.r1("B_SELECT"),value:""}];if(t.clearInvalid(),t.getValue()){for(e in delete a[t.getValue()],a)l.push({name:e,value:e,data:a[e]});t.store.loadData(l),t.setValue(l[1]?l[1].value:"")}else t.markInvalid()},scope:this}]},{xtype:"container",name:"m_new_item",hidden:!0,layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"theme_new_name",fieldLabel:IRm$.r1("B_NAME"),flex:1},{xtype:"button",text:IRm$.r1("B_ADD"),handler:function(){var e,t,a=this.down("[name=m_new_item]"),l=this.down("[name=m_selector]"),n=this.down("[name=theme_new_name]"),o=this.down("[name=theme_name]");for(n.clearInvalid(),e=n.getValue(),t=0;t<o.store.data.items.length;t++)if(o.store.data.items[t].get("value")==e){e=null;break}if(!e)return n.markInvalid(),!1;a.setVisible(!1),l.setVisible(!0),o.store.add({name:e,value:e,data:[]}),o.setValue(e)},scope:this},{xtype:"button",text:IRm$.r1("B_CANCEL"),handler:function(){var e=this.down("[name=m_new_item]"),t=this.down("[name=m_selector]");e.setVisible(!1),t.setVisible(!0)},scope:this}]}]},{xtype:"fieldset",title:IRm$.r1("L_COLOR_SETS"),flex:1,layout:{type:"hbox",align:"stretch"},items:[{xtype:"gridpanel",name:"dsource",flex:1,selType:"checkboxmodel",selModel:{mode:"MULTI"},store:{fields:[]},columns:[{text:IRm$.r1("B_NAME"),dataIndex:"value",renderer:function(e,t,a){return"<div class='igc-colorset-icon' style='background-color:"+e+";'></div><span>"+e+"</span>"},editor:{type:"color"}},{text:IRm$.r1("B_COLOR"),dataIndex:"value2",width:120,editor:{type:"text"}}],tbar:[{xtype:"button",text:IRm$.r1("L_ADD_NEW"),handler:function(){var e=this._cur_target,t=this.down("[name=dsource]");e&&t.store.add({value:""})},scope:this},{xtype:"button",text:IRm$.r1("L_REMOVE_SELECTED"),handler:function(){var e,t=this.down("[name=dsource]"),a=t.getSelectionModel().selected;for(e=a.length-1;e>=0;e--)t.store.remove(a.items[e])},scope:this},{xtype:"button",iconCls:"ig-btn-up",text:IRm$.r1("B_UP"),width:80,handler:function(){this.changeOrder(-1)},scope:this},{xtype:"button",iconCls:"ig-btn-down",text:IRm$.r1("B_DOWN"),width:80,handler:function(){this.changeOrder(1)},scope:this}],listeners:{cellclick:function(e,t,a,l,n,o){},edit:function(e,t){"value2"==e.column&&t.value&&(t.record.set("value",t.value),t.record.set("value2",""))},scope:this}}]}]}],buttons:["->",{xtype:"button",text:IRm$.r1("B_CONFIRM"),handler:function(){this._confirm()},scope:this},{xtype:"button",text:IRm$.r1("B_CANCEL"),handler:function(){this.close()},scope:this}],listeners:{afterrender:function(e){e._init()}}}),IG$.dlg_chart_clr.superclass.initComponent.call(this)}}),IG$.styleWizard=$s.extend(IG$.v$pnl,{layout:"border",closable:!0,iconCls:"icon-style",reportoption:null,callback:null,ignoreBase:0,loadGlobalStyle:function(){var e=this.down("[name=p_h]").getLayout(),t=new IG$._rpc$;e.setActiveItem(0),t.init(this,{ack:"appoption",payload:{address:"ReportStyle"},mbody:{}},this,this.rs_loadGlobalStyle,null),t.send()},rs_loadGlobalStyle:function(e){var t,a,l,n,o,s=this,r=e.themes,i=s.down("[name=c_themes]"),c=s.down("[name=stylelist]"),m=s.down("[name=basestyle]"),_=[],d=[],h={},u={},p={},y=[{name:""}],f=[];if(s.themes={},s._mc=e,o=s.allcolorset={},r){for(l={name:IRm$.r1("B_DEFAULT"),leaf:!1,expanded:!0,children:[],type:"default"},h[l.name]=l,d.push(l),l={name:IRm$.r1("B_CUSTOM"),leaf:!1,expanded:!0,children:[],type:"custom"},h[l.name]=l,d.push(l),a=0;a<r.length;a++)(t=r[a]).name,t.c_cset,n={_mc:t,name:t.name,styleinfo:[],base_styles:{},chart_color_set:t.chart_color_set},_.push({name:n.name,value:n.name}),s.themes[n.name]=n,n.chart_color_set&&$.each(n.chart_color_set,(function(e,t){o[e]||(o[e]=t)})),$.each([{name:IRm$.r1("B_DEFAULT"),custom:!1,nodename:"default_styles"},{name:IRm$.r1("B_CUSTOM"),custom:!0,nodename:"custom_styles"}],(function(e,a){var l,o,s,r,i,c=t[a.nodename];if(c)for(o=h[a.name],l=0;l<c.length;l++)r={name:(s=new IG$.clStyleObject(c[l],a.name.toLowerCase(),a.custom)).name,leaf:!0,custom:a.custom,basestylename:a.basestylename},a.custom||(a.basestylename||y.push({name:s.name,value:s.name}),n.base_styles[s.name]=s),n.styleinfo.push(s),i=a.name.toLowerCase()+"_"+s.name,u[i]||(o.children.push(r),u[i]=r,a.custom&&!p[s.name]&&(p[s.name]=c[l],f.push({name:s.name,kname:a.name,custom:a.custom,node:c[l]})))}));$.each(s.themes,(function(e,t){var a,l,n,s,r,i=0;if(!t.chart_color_set)for(a in t.chart_color_set={},IG$.__chartoption.chartcolors)for(t.chart_color_set[a]=[],l=0;l<IG$.__chartoption.chartcolors[a].length;l++)t.chart_color_set[a].push(IG$.__chartoption.chartcolors[a][l]);for(a in o)if(!t.chart_color_set[a])for(t.chart_color_set[a]=[],l=0;l<o[a].length;l++)t.chart_color_set[a].push(o[a][l]);for(a=0;a<f.length;a++){for(n=f[a],i=0,l=0;l<t.styleinfo.length;l++)if((s=t.styleinfo[l]).custom&&s.name==n.name){i=1;break}0==i&&(r=new IG$.clStyleObject(n.node,n.kname.toLowerCase(),n.custom),t.styleinfo.push(r))}}))}m.store.loadData(y),c.store.setRootNode({expanded:!0,text:IRm$.r1("B_STYLE"),name:IRm$.r1("B_STYLE"),children:d}),c.getRootNode().expand(),i.store.loadData(_),i.setValue(_.length?ig$.theme_id||_[0].value:null),s.upd_chart_clr()},upd_chart_clr:function(){var e,t,a=this.down("[name=c_themes]").getValue(),l=this.themes,n=[{name:IRm$.r1("B_SELECT"),value:""}],o=this.down("[name=c_cset]");if(a)for(k in e=l[a].chart_color_set=l[a].chart_color_set||IG$.__chartoption.chartcolors,t=l[a]._mc.c_cset,this.chart_color_map=e,e)n.push({name:k,value:k});o.store.loadData(n),o.setValue(t||"")},loadStyle:function(){var e=this,t=e.down("[name=c_themes]").getValue(),a=e.themes[t],l=e.down("[name=c_cset]"),n=e.down("[name=gs_enable]"),o=e.down("[name=gs_col]"),s=e.down("[name=gs_bs_brd_col]"),r=e.down("[name=gs_opa]"),i=e.down("[name=p_h]"),c=e.down("[name=b_r]");e.__cth&&(e.__cth.c_cset=l.getValue(),e.__cth.gs_enable=n.getValue(),e.__cth.gs_col=o.getValue(),e.__cth.gs_bs_brd_col=s.getValue(),e.__cth.gs_opa=r.getValue(),e.commitStyleItem()),a&&(e.__cth=a,n.setValue(a._mc.gs_enable),o.setValue(a._mc.gs_col),s.setValue(a._mc.gs_bs_brd_col),r.setValue(a._mc.gs_opa),i.getLayout().setActiveItem(0),c.setVisible(!1),e.upd_chart_clr())},editStyleItem:function(e){var t,a,l,n,o=this,s=o.__cth,r=o.down("[name=form_header]"),i=o.down("[name=form_data]"),c=o.down("[name=basestyle]");if(s)for(o.commitStyleItem(),t=0;t<s.styleinfo.length;t++)if(s.styleinfo[t].name==e){if(n=s.styleinfo[t],o._editingstyle=n,"custom"==n.itemtype||n.basestylename){for(a=0;a<s.styleinfo.length;a++)if(s.styleinfo[a].name==n.basestylename){l=s.styleinfo[a];break}o.ignoreBase=!0,c.setValue(l?l.name:""),o.ignoreBase=!1}r.loadStyleData.call(r,n.header,l?l.header:null),i.loadStyleData.call(i,n.data,l?l.data:null);break}},commitStyleItem:function(){var e,t=this,a=t.__cth,l=t._editingstyle,n=t.down("[name=form_header]"),o=t.down("[name=form_data]");o.updateStyleData.call(o),n.updateStyleData.call(n),l&&("custom"==l.itemtype||l.basestylename)&&(e=a.base_styles[l.basestylename])&&l.forceBsStyl(e,!0),a&&$.each(t.themes,(function(e,t){t.name!=a.name&&($.each(t.chart_color_set,(function(e,l){a.chart_color_set[e]||delete t.chart_color_set[e]})),$.each(a.chart_color_set,(function(e,a){var l;if(!t.chart_color_set[e])for(t.chart_color_set[e]=[],l=0;l<a.length;l++)t.chart_color_set[e].push(a[l])})))}))},_confirm:function(){var e=this,t=e.down("[name=c_cset]"),a=e.down("[name=gs_enable]"),l=e.down("[name=gs_col]"),n=e.down("[name=gs_bs_brd_col]"),o=e.down("[name=gs_opa]");e.__cth&&(e.__cth.c_cset=t.getValue(),e.__cth.gs_enable=a.getValue(),e.__cth.gs_col=l.getValue(),e.__cth.gs_bs_brd_col=n.getValue(),e.__cth.gs_opa=o.getValue()),e.commitStyleItem(),e.saveStyleItem()},saveStyleItem:function(){var e=new IG$._rpc$,t={},a=this.themes;t={meta_type:"report_themes",name:"ReportStyle",type:"AppOption",uid:"ReportStyle",themes:[]},$.each(a,(function(e,a){var l,n,o,s={};for(l=0;l<a.styleinfo.length;l++)s[(o=a.styleinfo[l]).name]=o;var r={name:a.name,c_cset:a.c_cset,gs_enable:a.gs_enable,gs_opa:a.gs_opa||.6,gs_col:a.gs_col,gs_bs_brd_col:a.gs_bs_brd_col,default_styles:[],custom_styles:[],chart_color_set:a.chart_color_set};for(l=0;l<a.styleinfo.length;l++)0==(o=a.styleinfo[l]).custom?o.basestylename?(n=s[o.basestylename],r.default_styles.push(o.getData(n))):r.default_styles.push(o.getData()):(n=s[o.basestylename],r.custom_styles.push(o.getData(n)));t.themes.push(r)})),e.init(this,{ack:"appoption",payload:{address:"ReportStyle",option:"updatecontent"},mbody:t,meta_type:"report_themes"},this,(function(e){IG$.alertmsg(ig$.appname,IRm$.r1("M_SAVED"),null,null,0,"success")}),null),e.send()},copyThemes:function(e,t){var a,l,n;for(a=0;a<e.styleinfo.length;a++)l=e.styleinfo[a],(n=new IG$.clStyleObject(null,l.itemtype,l.custom)).name=l.name,n.nodename=l.nodename,n.basestylename=l.basestylename,n.header=new IG$.clStyleItem(null,"Header"),n.data=new IG$.clStyleItem(null,"Data"),n.applyBaseStyle.call(n,l),t.styleinfo.push(n)},toolbarHandler:function(e){var t,a=this,l=a.down("[name=stylelist]");a.styleinfo;switch(e){case"cmd_refresh":a.loadGlobalStyle();break;case"cmd_add_custom":var n=new IG$.makeStyle({styleinfo:a.__cth.styleinfo,callback:new IG$.callBackObj(a,a.rs__appendCustomStyle)});IG$.checkLogin(a,n);break;case"cmd_add_theme":n=new IG$.makeStyle({m_theme:1,themes:a.themes,callback:new IG$.callBackObj(a,(function(e){var t,a,l,n,o=this,s=e[0],r=(e[1],o.down("[name=c_themes]"));if(s){for(l in o.themes){a=o.themes[l];break}if(t={_mc:{},name:s,c_cset:null,gs_enable:!1,gs_opa:.6,styleinfo:[],chart_color_set:null},a&&a.chart_color_set)for(l in t.chart_color_set={},a.chart_color_set)for(t.chart_color_set[l]=[],n=0;n<a.chart_color_set[l].length;n++)t.chart_color_set[l].push(a.chart_color_set[l][n]);o.copyThemes(o.__cth,t),o.themes[t.name]=t,r.store.add({name:s,value:s})}}))});IG$.checkLogin(a,n);break;case"cmd_remove_theme":IG$.confirmMessages(null,null,(function(e){if("yes"==e){var t,l,n=a.down("[name=c_themes]");if(a.__cth&&n.store.data.items.length>1){for(t=0;t<n.store.data.items.length;t++)if((l=n.store.data.items[t]).get("name")==a.__cth.name){n.store.remove(l);break}delete a.themes[a.__cth.name],a.__cth=null,n.setValue(n.store.data.items[0].get("value"))}}}),a,a);break;case"cmd_remove":a.down("[name=b_r]").setVisible(!1);(t=(t=l.getSelectionModel().getSelection())&&t.length>0?t[0]:null)&&1==t.get("custom")&&(stylename=t.get("name"),$.each(a.themes,(function(e,t){var a,l=t.styleinfo;for(a=0;a<l.length;a++)if(l[a].custom&&l[a].name==stylename){l.splice(a,1);break}})),t.remove())}},rs__appendCustomStyle:function(e){var t,a=e[0],l=e[1];if(l&&a){$.each(this.themes,(function(e,t){var n,o,s,r=t.styleinfo;for(n=0;n<r.length;n++)if(r[n].name==l){o=r[n];break}o&&((s=new IG$.clStyleObject(null,"item",!0)).name=a,s.nodename="ItemStyle",s.basestylename=l,s.header=new IG$.clStyleItem(null,"Header"),s.data=new IG$.clStyleItem(null,"Data"),r.push(s),s.applyBaseStyle.call(s,o))}));var n,o,s=this.down("[name=stylelist]").store.getRootNode();for(t=0;t<s.childNodes.length;t++)if("custom"==s.childNodes[t].get("type")){o=s.childNodes[t];break}n={name:a,leaf:!0,custom:!0},o.appendChild(n)}},updateBaseStyle:function(){var e=this,t=e._editingstyle,a=e.down("[name=form_header]"),l=e.down("[name=form_data]"),n=e.down("[name=basestyle]").getValue();bstyle=e.__cth.base_styles[n],t&&bstyle&&(t.basestylename=n,t.forceBsStyl(bstyle),a.loadStyleData(t.header),l.loadStyleData(t.data))},_config_chartcolors:function(){new IG$.dlg_chart_clr({chart_color_map:this.chart_color_map,callback:new IG$.callBackObj(this,(function(e){this.upd_chart_clr()}))}).show()},initComponent:function(){var e=this,t=new IG$.styleEditor({title:IRm$.r1("L_STYLE_TITLE"),name:"form_header",htype:"hd",flex:1}),a=new IG$.styleEditor({title:IRm$.r1("L_STYLE_DATA"),name:"form_data",htype:"dt",flex:1});e.title=IRm$.r1("T_STYLE_WIZARD"),ig$.$l_=ig$.$l_||0,$s.apply(this,{defaults:{padding:3},dockedItems:[{xtype:"toolbar",dock:"top",plain:!0,items:[{iconCls:"icon-toolbar-save",tooltip:IRm$.r1("L_SAVE_CONTENT"),handler:function(){this._confirm()},scope:this},"-",{xtype:"combobox",fieldLabel:IRm$.r1("L_THEMES"),name:"c_themes",displayField:"name",labelWidth:60,labelAlign:"right",valueField:"value",editable:!1,queryMode:"local",store:{fields:["name","value"]},hidden:ig$.$l_>5,listeners:{change:function(e,t,a,l){this.loadStyle()},scope:this}},{iconCls:"icon-toolbar-add",tooltip:IRm$.r1("L_ADD_THEME"),text:IRm$.r1("L_ADD_THEME"),hidden:ig$.$l_>5,handler:function(){this.toolbarHandler("cmd_add_theme")},scope:this},{iconCls:"icon-toolbar-remove",tooltip:"Remove Theme",hidden:ig$.$l_>5,handler:function(){this.toolbarHandler("cmd_remove_theme")},scope:this}]}],items:[{xtype:"panel",width:270,border:1,region:"west",layout:"anchor",padding:5,title:ig$.$l_<5?IRm$.r1("L_GENERAL_OPTIONS"):null,items:[{xtype:"container",layout:{type:"vbox",align:"stretch"},hidden:ig$.$l_>5,items:[{xtype:"container",layout:{type:"hbox",align:"stretch"},items:[{xtype:"displayfield",value:"Chart Style"},{xtype:"container",flex:1},{xtype:"button",text:IRm$.r1("B_SET"),handler:function(){this._config_chartcolors()},scope:this}]},{xtype:"combobox",name:"c_cset",flex:1,displayField:"name",labelWidth:60,valueField:"value",editable:!1,queryMode:"local",store:{fields:["name","value"]}}]},{xtype:"fieldset",title:IRm$.r1("L_GRID_STRIPES"),anchor:"100%",layout:"anchor",paddingY:30,hidden:ig$.$l_>5,items:[{xtype:"checkbox",fieldLabel:IRm$.r1("L_GS_ENABLED"),name:"gs_enable",boxLabel:IRm$.r1("B_ENABLED")},{xtype:"fieldcontainer",anchor:"100%",fieldLabel:IRm$.r1("L_ALT_COLOR"),layout:"hbox",items:[{xtype:"textfield",name:"gs_col",width:60},{xtype:"splitter"},{xtype:"splitbutton",width:30,menu:{showSeparator:!1,items:[{xtype:"colorpicker",listeners:{select:function(e,t){this.down("[name=gs_col]").setValue("#"+t)},scope:e}},"-"]}}]},{xtype:"fieldcontainer",anchor:"100%",fieldLabel:IRm$.r1("L_BASE_BRD_CLR",null,"Base Border"),layout:{type:"hbox",align:"stretch"},items:[{xtype:"textfield",name:"gs_bs_brd_col",width:60},{xtype:"splitter"},{xtype:"splitbutton",width:30,menu:{showSeparator:!1,items:[{xtype:"colorpicker",listeners:{select:function(e,t){this.down("[name=gs_bs_brd_col]").setValue("#"+t)},scope:e}},"-"]}}]},{xtype:"numberfield",fieldLabel:IRm$.r1("B_OPACITY"),name:"gs_opa",width:200,minValue:0,maxValue:1,step:.1,value:.4}]},{xtype:"treepanel",title:IRm$.r1("B_STYLE"),name:"stylelist",preventHeader:!0,flex:1,split:!0,border:1,rootVisible:!1,hideHeaders:!0,autoScroll:!0,store:{xtype:"treestore",fields:["name","text","custom"],root:{expanded:!0,name:"Style",children:[]},folderSort:!1},columns:[{xtype:"treecolumn",text:IRm$.r1("B_TEXT"),flex:1,sortable:!1,dataIndex:"name"}],listeners:{itemclick:function(e,t,a,l,n){var o,s=this,r=t.get("name"),i=s.down("[name=b_r]"),c=s.down("[name=p_h]"),m=s.down("[name=p_d]"),_=(s.down("[name=p_dc]"),s.down("[name=basestyle]")),d=s.__cth?s.__cth.styleinfo:null,h=!1,u=!1;if(d){for(o=0;o<d.length;o++)if(d[o].name==r){h=!0;break}h&&(1==t.get("custom")&&(u=!0),m.setTitle("Edit : "+r),s.editStyleItem.call(s,r)),c.getLayout().setActiveItem(h?1:0),i.setVisible(u&&ig$.$l_<5),_.setVisible(u&&h)}},scope:this},tbar:[{iconCls:"icon-refresh",tooltip:IRm$.r1("L_REFRESH"),handler:function(){this.toolbarHandler("cmd_refresh")},scope:this},"-",{iconCls:"icon-toolbar-add",tooltip:"Add Custom Style",text:IRm$.r1("L_ADD_STYLE"),hidden:ig$.$l_>5,handler:function(){this.toolbarHandler("cmd_add_custom")},scope:this},{iconCls:"icon-toolbar-remove",tooltip:"Remove Style",name:"b_r",hidden:!0,handler:function(){this.toolbarHandler("cmd_remove")},scope:this}]}]},{xtype:"panel",region:"center",layout:"card",name:"p_h",items:[{html:'<div style="padding: 10px">'+IRm$.r1("L_CLICK_STYLE_TO_EDIT")+"</div>"},{xtype:"panel",layout:{type:"vbox",align:"stretch"},name:"p_dc",items:[{xtype:"combobox",name:"basestyle",fieldLabel:IRm$.r1("L_BASE_STYLE"),queryMode:"local",displayField:"name",valueField:"name",editable:!1,autoSelect:!0,hidden:!0,store:{fields:[{name:"name"}]},listeners:{change:function(){this.ignoreBase||this.updateBaseStyle()},scope:this}},{xtype:"tabpanel",title:IRm$.r1("B_EDIT"),name:"p_d",layout:{type:"fit",align:"stretch"},items:[a,t]}]}]}],listeners:{afterrender:function(){"g"==this.styletype&&this.loadGlobalStyle()}}}),IG$.styleWizard.superclass.initComponent.apply(this,arguments)}});

...
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"KPI Indicator",charttype:"kpi",subtype:"kpi",img:"kpi",grp:"scientific"}),IG$.__chartoption.chartext.kpi=function(t){this.owner=t},IG$.__chartoption.chartext.kpi.prototype={drawChart:function(t,a){if(!IG$.__chartoption.chartext.kpi._loaded){var i=this;IG$.getScriptCache(["./custom/custom.kpi.worker.js","./js/modules/funnel.js","./js/modules/solid-gauge.js"],new IG$.callBackObj(this,function(){IG$.__chartoption.chartext.kpi._loaded=1,i.drawChart.call(i,t,a)}))}},updatedisplay:function(t,a,i){}};

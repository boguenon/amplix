...
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"Daum Map",charttype:"daummap",subtype:"daummap",img:"map_daum",grp:"scientific"}),IG$.__chartoption.chartext.daummap=function(a){this.owner=a},IG$.__chartoption.chartext.daummap.prototype={drawChart:function(a,t){var e,m,n=a.container,o=$(n);o.empty(),e=new daum.maps.Map(o[0],{center:new daum.maps.LatLng(37.537123,127.005523),level:3}),this.map=e,o.bind("mousedown",function(a){});var r,p,u,d;if(t&&0<t.geodata.length){for(m=0;m<t.geodata.length;m++)r=0==m?Number(t.geodata[m].lng):Math.min(r,Number(t.geodata[m].lng)),p=0==m?Number(t.geodata[m].lng):Math.max(p,Number(t.geodata[m].lng)),u=0==m?Number(t.geodata[m].lat):Math.min(u,Number(t.geodata[m].lat)),d=0==m?Number(t.geodata[m].lat):Math.max(d,Number(t.geodata[m].lat));0}},updatedisplay:function(a,t,e){}};
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"SGIS Map",charttype:"sgismap",subtype:"sgismap",img:"map_sgis",grp:"scientific"}),IG$.__chartoption.chartext.sgismap=function(a){this.owner=a},IG$.__chartoption.chartext.sgismap.prototype={drawChart:function(a,t){var e,o,n=a.container;$(n).empty(),mapCreate(n),this.sgismap=sgismap;var i,r,m,g,s=197752.5,l=451441;if(t&&0<t.geodata.length){for(e=0;e<t.geodata.length;e++)i=0==e?Number(t.geodata[e].lng):Math.min(i,Number(t.geodata[e].lng)),r=0==e?Number(t.geodata[e].lng):Math.max(r,Number(t.geodata[e].lng)),m=0==e?Number(t.geodata[e].lat):Math.min(m,Number(t.geodata[e].lat)),g=0==e?Number(t.geodata[e].lat):Math.max(g,Number(t.geodata[e].lat));s=(r-i)/2,l=(g-m)/2}addControl("zoomInIcon"),addControl("zoomOutIcon");var p=new OpenLayers.LonLat(s,l);sgismap.setCenter(p,4),setLegendLevel("15"),setLegendColor("green");var c,h,u,N,_,y,b,f=t.colfix,v='<?xml version="1.0" encoding="utf-8"?><kml xmlns="http://www.opengis.net/kml/2.2">';for(v+="<Document>",e=0;e<t.geodata.length;e++){for((c=t.geodata[e]).lat=Number(c.lat),c.lng=Number(c.lng),d=t.data[c.row],c.data=d,o=0;o<f;o++)c.disp=0==o?d[o].text:c.disp+" "+d[o].text;b=Number(c.data[f+0].code),0==isNaN(b)&&(_=isNaN(_)?b:Math.max(_,b),y=isNaN(y)?b:Math.min(y,b)),c.dval=b}for(e=0;e<t.geodata.length;e++){for(v+="<Placemark><name>"+(c=t.geodata[e]).disp+"</name><description>"+c.disp+"</description><MultiGeometry>",v+="<Polygon><outerBoundaryIs><LinearRing><coordinates>",o=0;o<20;o++)h=1e3+c.dval/(_-y)*4e3,theta=6.28*o/20,N=c.lng+Math.cos(theta)*h,u=c.lat+Math.sin(theta)*h,v+=0==o?u+","+N:" "+u+","+N;v+="</coordinates></LinearRing></outerBoundaryIs></Polygon>",v+="</MultiGeometry></Placemark>"}v+="</Document></kml>";var x={item_name:"(n)",item_code:"in_age_001",max:_,min:y,unit:"(n)"};for(e=0;e<t.geodata.length;e++)x[(c=t.geodata[e]).disp]={item_value:c.dval,rank:e};getStatisticsValue(x,v)},updatedisplay:function(a,t,e){this.map.m1.call(this.map)}};
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"Naver Map",charttype:"navermap",subtype:"navermap",img:"map_naver",grp:"scientific"}),IG$.__chartoption.chartext.navermap=function(a){},IG$.__chartoption.chartext.navermap.prototype={drawChart:function(t,n){var r=this;IG$.__chartoption.chartext.navermap_main?(r.dmain&&(r.dmain.dispose(),r.dmain=null),r.dmain=new IG$.__chartoption.chartext.navermap_main(t),r.dmain.drawChart.call(r.dmain,t,n)):IG$.__chartoption.chartext.navermap._loaded||IG$.getScriptCache(["./custom/custom.map.naver.worker.js"],new IG$.callBackObj(this,function(){IG$.__chartoption.chartext.navermap._loaded=1;var a=new IG$.__chartoption.chartext.navermap_main(t);(r.dmain=a).drawChart.call(a,t,n)}))},updatedisplay:function(a,t,n){var r=this;r.dmain&&r.dmain.updatedisplay.call(r.dmain,a,t,n)}};
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"VWorld Map",charttype:"vworldmap",subtype:"vworldmap",img:"map",grp:"scientific"}),IG$.__chartoption.chartext.vworldmap=function(a){},IG$.__chartoption.chartext.vworldmap.prototype={drawChart:function(t,r){var o=this;IG$.__chartoption.chartext.vworldmap_main?(o.dmain&&(o.dmain.dispose(),o.dmain=null),o.dmain=new IG$.__chartoption.chartext.vworldmap_main(t),o.dmain.drawChart.call(o.dmain,t,r)):IG$.__chartoption.chartext.vworldmap._loaded||IG$.getScriptCache(["./custom/custom.map.vworld.worker.js"],new IG$.callBackObj(this,function(){IG$.__chartoption.chartext.vworldmap._loaded=1;var a=new IG$.__chartoption.chartext.vworldmap_main(t);(o.dmain=a).drawChart.call(a,t,r)}))},updatedisplay:function(a,t,r){var o=this;o.dmain&&o.dmain.updatedisplay.call(o.dmain,a,t,r)}};
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"Air bus",charttype:"airbusseat",subtype:"airbusseat",img:"svg_airbus",grp:"scientific"}),IG$.__chartoption.chartext.airbusseat=function(a){this.owner=a},IG$.__chartoption.chartext.airbusseat.prototype={drawChart:function(a,l){var d,t=a.container;this.map=d=new IG$.SVGLoader($(t)),d.load("./data/Airbus_A380_seatmap.svg"),d.l5.bind("svgloaded",function(){var a,t,e,r,s,i,n,o,u,m,h={point:{},measures:[]},p=[];for(key in d.mapid)p.push(key);if(l)for(r=l.colfix,s=l.rowfix,a=0;a<l.data.length;a++)if(e=l.data[a],a<s)for(t=r;t<e.length;t++)n=(i=e[t]).text||i.code,0==a?h.measures.push({text:n,min:null,max:null}):h.measures[t-r].text+=" "+n;else{for(t=0;t<e.length;t++)n=(i=e[t]).text||i.code,t<r?0==t&&(rnd=Math.floor(Math.random()*p.length),n=p[rnd],o=(o=h.point[n])||{mapid:n,data:[]}):(u=r-t,m=Number(n),0==isNaN(m)&&(h.measures[u].min=null==h.measures[u].min?m:Math.min(h.measures[u].min,m),h.measures[u].max=null==h.measures[u].max?m:Math.max(h.measures[u].max,m)),o.data.length>u?o.data[u]=m:o.data.push(m));h.point[o.mapid]=o}d.loadData(h)})},updatedisplay:function(a,t,e){var r=this.map;r.m1.call(r)}};
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"Korea map",charttype:"koreamap",subtype:"koreamap",img:"svg_korea",grp:"scientific"}),IG$.__chartoption.chartext.koreamap=function(a){this.owner=a},IG$.__chartoption.chartext.koreamap.prototype={drawChart:function(a,l){var c,t=a.container;this.map=c=new IG$.SVGLoader($(t)),c.load("./data/korea_location_map3.svg"),c.l5.bind("svgloaded",function(){var a,t,e,r,o,n,i,m,s,p,h={point:{},measures:[]};if(l)for(r=l.colfix,o=l.rowfix,a=0;a<l.data.length;a++)if(e=l.data[a],a<o)for(t=r;t<e.length;t++)i=(n=e[t]).text||n.code,0==a?h.measures.push({text:i,min:null,max:null}):h.measures[t-r].text+=" "+i;else{for(t=0;t<e.length;t++)i=(n=e[t]).text||n.code,t<r?0==t&&(m=(m=h.point[i])||{mapid:i,data:[]}):(s=t-r,p=Number(i),0==isNaN(p)&&(h.measures[s].min=null==h.measures[s].min?p:Math.min(h.measures[s].min,p),h.measures[s].max=null==h.measures[s].max?p:Math.max(h.measures[s].max,p)),m.data.length>s?m.data[s]=p:m.data.push(p));h.point[m.mapid]=m}c.loadData(h)})},updatedisplay:function(a,t,e){var r=this.map;r.m1.call(r)}};
...
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"Pareto",charttype:"pareto",subtype:"pareto",img:"chart_pareto",grp:"quality"}),IG$.__chartoption.chartext.pareto=function(t){},IG$.__chartoption.chartext.pareto.prototype={drawChart:function(t,e){var a,s,i,r=this,o=t.container,n=$(o),h=t.cop,c=e._tabledata,p=e.colfix,d=e.colcnt,l=e.rowfix,x=(e.rowcnt,h.colorset||e.c_cset),u=d-p,m=Math.max(200,n.height()/u),y=50;if(p<1)IG$.ShowError("Parato chart need xaxis item",r);else if(u<1)IG$.ShowError("Parato chart need yaxis item",r);else if(window.echarts){for(r.destroy(),n.empty(),(i=$("<div></div>").appendTo(n)).css({position:"relative",width:"100%"}),n.css({overflowY:"auto"}),a={chart:{renderTo:i[0]},tooltip:{trigger:"axis",axisPointer:{type:"cross"}},grid:[],xAxis:[],yAxis:[],series:[]},s=p;s<d;s++){var f=a.grid.length,g={type:"category",axisTick:{alignWithLabel:!0},axisLabel:{maxStaggerLines:2,formatter:function(t,e){return t}},data:[],gridIndex:f},_={type:"value",name:"value",position:"left",axisLabel:{formatter:h.yaxisformat?function(t,e){var a=h.yaxisformat;return IG$.NumberFormat(a,t)}:null},gridIndex:f},v={type:"value",name:"incremental",offset:0,position:"right",axisLabel:{formatter:h.yaxisformat?function(t,e){var a=h.yaxisformat;return IG$.NumberFormat(a,t)}:null},gridIndex:f},I={name:"value",type:"bar",xAxisIndex:a.xAxis.length,yAxisIndex:a.yAxis.length,data:[]},G={name:"incremental",type:"line",xAxisIndex:a.xAxis.length,yAxisIndex:a.yAxis.length+1,data:[]},w={right:"5%",left:"5%"};1<u&&(w.top=y+"px",w.height=m+"px"),y+=m+50,a.grid.push(w),a.xAxis.push(g),a.yAxis.push(_),a.yAxis.push(v),a.series.push(I),a.series.push(G);var A=0,b=[];$.each(c,function(t,e){var r,o,n;if(t<l)return _.name=e[s].text,v.name=e[s].text,I.name=e[s].text,void(G.name=e[s].text+"(%)");$.each(e,function(t,e){var a,i=e.text||e.code;t<p?r=0==t?i:r+" "+i:t==s&&(a=Number(i),0==isNaN(a)&&(A+=a),o=a,n=A)}),g.data.push(r),I.data.push(o),b.push(n)}),$.each(b,function(t,e){var a=e/A*100;G.data.push(a)})}1<u?i.height(y):i.height(n.height()),IG$.__chartoption&&IG$.__chartoption.chartcolors&&IG$.__chartoption.chartcolors[x]&&(a.color=IG$.__chartoption.chartcolors[x]),r.createChart(a)}else IG$.ShowError("This need apache echarts module!",r)},createChart:function(t){var e=echarts.init(t.chart.renderTo,ig$.echarts_theme||"amplix",{renderer:"canvas"});e.setOption(t),e.on("pieselectchanged",function(t){}),e.on("click",function(t){"series"==t.componentType&&_chartview.procClickEvent({series:{name:t.seriesName,type:t.seriesType}},{point:t.data})}),e.on("brushselected",function(t){}),this.dmain_opt=t,this.dmain=e},updatedisplay:function(t,e,a){var i=this.dmain,r=this.dmain_opt;if(r&&1==r.grid.length)$(i.renderTo).css({width:e,height:a}),i.resize.call(i,{width:e,height:a});else if(i&&(i&&i.destroy&&i.destroy(),i&&i.dispose&&i.dispose(),this.dmain=null),r){var o=r.grid.length,n=Math.max(200,a/o),s=50;$.each(r.grid,function(t,e){e.top=s+"px",e.height=n+"px",s+=n+50}),this.createChart(r)}},destroy:function(){var t=this.dmain;t&&t.destroy&&t.destroy(),t&&t.dispose&&t.dispose(),this.dmain=null,this.dmain_opt=null}};
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"Quality Runchart",charttype:"runchart",subtype:"runchart",img:"chart_runchart",grp:"quality"}),IG$.__chartoption.chartext.runchart=function(t){this.theight=400,this.symbolsize=12},IG$.__chartoption.chartext.runchart.prototype={getStat:function(a,e){var i,r=this,t=a.rpc.ownerCt,n=new IG$._rpc$,o=a.reportoption.getCurrentPivot(),s=a.sheetoption.model,c=[];t.setLoading(!0),i=s.anal_options,c.push({name:"quality_runchart",description:"auto generated",analtype:"proc_cap_index",options:{},input_fields:[]}),s.anal_options=c,n.init(t,{ack:"olapservice",payload:{jobid:a.jobid,option:"pivot",active:""+a.sheetoption.si,pivotresult:"F",analysisresult:"T"},mbody:o,meta_type:"report"},t,function(t){s.anal_options=i,r.drawStatResult.call(r,a,e,t)},function(t){s.anal_options=i}),n.send()},drawChart:function(t,a){var e=this,i=(a._tabledata,a.colfix),r=a.colcnt,n=(a.rowfix,a.rowcnt,r-i);i<1?IG$.ShowError("Parato chart need xaxis item",e):n<1?IG$.ShowError("Parato chart need yaxis item",e):window.echarts?e.getStat(t,a):IG$.ShowError("This need apache echarts module!",e)},drawStatResult:function(t,a,e){var i,f,x=this,r=t.container,n=$(r),g=t.cop,w=a._tabledata,b=a.colfix,o=a.colcnt,G=a.rowfix,I=(a.rowcnt,g.colorset||a.c_cset),s=o-b,T=Math.max(x.theight,n.height()/s),S=0,L=a.statistics,A=e.table_data;for(x.destroy(),n.empty(),(f=$("<div></div>").appendTo(n)).css({position:"relative",width:"100%"}),i=b;i<o;i++)x._charts.push({index:i});n.css({overflowY:"auto"}),$.each(x._charts,function(t,a){var e,i,r,n,o,s=a.index,c=null,h=null;(e=$("<div></div>").appendTo(f)).css({position:"relative",width:"100%"}),(i=$("<div class='quality-runchart-desc'></div>").appendTo(f)).css({position:"relative",width:"100%"}),r={chart:{renderTo:e[0],chartregion:f,chartdesc:i},tooltip:{trigger:"axis",axisPointer:{type:"cross"}},xAxis:[],yAxis:[],series:[]};var l=s-b,p={type:"category",axisTick:{alignWithLabel:!0},axisLabel:{maxStaggerLines:2,formatter:function(t,a){return t}},data:[]},u={type:"value",name:"value",position:"left",axisLabel:{formatter:g.yaxisformat?function(t,a){var e=g.yaxisformat;return IG$.NumberFormat(e,t)}:null}},d={name:"value",type:"line",symbolSize:x.symbolsize,data:[]},m=L[l],_=A[l],v={};$.each(_.rows,function(t,a){v[a[0].text]=a[2]}),e.height(T-50),i.height(50),S+=T,d.markLine={data:[{name:"Average",yAxis:m.average,lineStyle:{color:"#00ff00",width:2}}]},n=m.min,o=m.max,v.ucl&&(d.markLine.data.push({name:"UCL",yAxis:v.ucl.value,lineStyle:{color:"#ff0000",width:3}}),v.ucl.value>o&&(h=v.ucl.value+10)),v.lcl&&(d.markLine.data.push({name:"LCL",yAxis:v.lcl.value,lineStyle:{color:"#ff0000",width:3}}),v.lcl.value<n&&(c=v.lcl.value-10)),u.min=c,u.max=h,r.xAxis.push(p),r.yAxis.push(u),r.series.push(d);$.each(w,function(t,a){var r,n;if(t<G)return u.name=a[s].text,void(d.name=a[s].text);$.each(a,function(t,a){var e,i=a.text||a.code;t<b?r=0==t?i:r+" "+i:t==s&&(e=Number(i),0==isNaN(e)&&0,n=e)}),p.data.push(r),d.data.push(n)}),IG$.__chartoption&&IG$.__chartoption.chartcolors&&IG$.__chartoption.chartcolors[I]&&(r.color=IG$.__chartoption.chartcolors[I]),a.dmain=x.createChart(r),a.dmain_opt=r,i.empty();var y=[];y.push("<ul class='qr_analysis'>"),$.each(_.headers,function(t,a){$.each(a,function(t,a){y.push("<li class='anal-"+a.stylename+"'>"+(a.text||"")+"</li>")})}),$.each(_.rows,function(t,a){y.push("<li><span class='anal-name'>"+(a[0].text||"")+"</span><span class='anal-value'>"+(a[2].formatvalue||a[2].value)+"</span></li>")}),y.push("</ul>"),$(y.join("")).appendTo(i)}),1<s?f.height(S):f.height(n.height())},createChart:function(t){var a=echarts.init(t.chart.renderTo,ig$.echarts_theme||"amplix",{renderer:"canvas"});return a.setOption(t),a.on("pieselectchanged",function(t){}),a.on("click",function(t){"series"==t.componentType&&_chartview.procClickEvent({series:{name:t.seriesName,type:t.seriesType}},{point:t.data})}),a.on("brushselected",function(t){}),a},updatedisplay:function(t,a,e){var i,r=this;if(r._charts){i=r.dmain,dmain_opt=r.dmain_opt;var n=r._charts.length,o=Math.max(r.theight,e/n);r._charts&&1==r._charts.length?(i=r._charts[0].dmain,$(i.renderTo).css({width:a,height:e-50})):$.each(r._charts,function(t,a){var e=a.dmain;a.dmain_opt;e&&$(e.renderTo).css({height:o-50})})}},destroy:function(){var t=this._charts;t&&$.each(t,function(t,a){var e=a.dmain;e&&e.destroy&&e.destroy(),e&&e.dispose&&e.dispose(),a.dmain=null,a.dmain_opt=null}),this._charts=[]}};
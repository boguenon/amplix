...
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"Pareto",charttype:"pareto",subtype:"pareto",img:"chart_pareto",grp:"quality"}),IG$.__chartoption.chartext.pareto=function(t){this.drawChart=function(t,a){var r=t.container;$(r),t.cop,a._tabledata,a.colfix,a.rowfix;colors},this.updatedisplay=function(t,a,r){var o=this;o.dmain&&o.dmain.updatedisplay.call(o.dmain,t,a,r)}};
IG$.__chartoption.charttype=IG$.__chartoption.charttype||[],IG$.__chartoption.charttype.push({label:"Quality Runchart",charttype:"runchart",subtype:"runchart",img:"chart_runchart",grp:"quality"}),IG$.__chartoption.chartext.runchart=function(t){this.drawChart=function(a,r){var n=this;IG$.__chartoption.chartext.pareto_main?(n.dmain&&(n.dmain.dispose(),n.dmain=null),n.dmain=new IG$.__chartoption.chartext.pareto_main(a),n.dmain.drawChart.call(n.dmain,a,r)):IG$.__chartoption.chartext.runchart._loaded||IG$.getScriptCache(["./custom/custom.map.runchart.worker.js"],new IG$.callBackObj(this,function(){IG$.__chartoption.chartext.runchart._loaded=1;var t=new IG$.__chartoption.chartext.pareto_main(a);(n.dmain=t).drawChart.call(t,a,r)}))},this.updatedisplay=function(t,a,r){var n=this;n.dmain&&n.dmain.updatedisplay.call(n.dmain,t,a,r)}};
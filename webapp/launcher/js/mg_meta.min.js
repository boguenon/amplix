...
IG$.MgrManual=$s.extend(IG$.v$pnl,{layout:"fit",_init_app:function(){var e,t,n=this,o=n.down("[name=t_editor]");setTimeout((function(){e=$("#manual_editor_main",o.body.dom),t=$(".manual-editor-area",e);var i=o.getHeight();t.height(i-42);var a=new Quill(t[0],{modules:{toolbar:[[{header:[1,2,3,!1]}],["bold","italic","underline","strike"],[{list:"ordered"},{list:"bullet"}],[{indent:"-1"},{indent:"+1"}],[{color:[]},{background:[]}],[{align:[]}],["image","code-block"],["clean"]]},placeholder:"Compose an epic...",theme:"snow"});n._editor=a}),100),n._load_menu()},_load_menu:function(){var e=this,t=new IG$._rpc$,n="en";"ko_KR"==(window.useLocale||"en_US")&&(n="ko"),e._lang=n,t.init(e,{ack:"manual",payload:{lang:n},mbody:{option:"menu"}},e,(function(t){var n=e.down("[name=menus]"),o={name:"Root",children:t.children||[]};n.store.setRootNode(o),n.store.getRootNode().expand(!0)}),!1),t.send()},_save_menus:function(){var e=this,t=e.down("[name=menus]").getRootNode(),n={name:"root",children:[]},o=e._lang,i=new IG$._rpc$;e._upd_menus(t.childNodes,n.children),i.init(e,{ack:"manual",payload:{option:"save_menu",lang:o},mbody:n,meta_type:"object"},e,(function(e){})),i.send()},_upd_menus:function(e,t){var n=this;e&&$.each(e,(function(e,o){var i={name:o.get("name"),dockey:o.get("dockey"),visible:o.get("visible")};t.push(i),o.childNodes&&o.childNodes.length&&(i.children=[],n._upd_menus(o.childNodes,i.children))}))},save_content:function(){var e,t=this,n=t._editor,o=new IG$._rpc$,i=t._lang;t._sel_content&&(e=n.getContents(),o.init(t,{ack:"manual",payload:{uid:t._sel_content.get("dockey"),lang:i,option:"save"},mbody:e,meta_type:"object"},t,(function(e){}),null),o.send())},_load_content:function(){var e=(t=this)._editor;if(t._sel_content){var t=this,n=new IG$._rpc$,o=t._lang;n.init(t,{ack:"manual",payload:{lang:o,uid:t._sel_content.get("dockey")},mbody:{option:"get"}},t,(function(t){e.setContents(t)}),!1),n.send()}},initComponent:function(){var e=this;$s.apply(e,{items:[{xtype:"panel",layout:"border",split:!0,items:[{xtype:"panel",region:"north",width:350,height:420,layout:"fit",title:"Menu Structures",items:[{xtype:"treepanel",name:"menus",enableDragDrop:!0,enableDD:!0,useArrows:!0,ddGroup:"_I$RD_G_",store:{xtype:"treestore"},columns:[{xtype:"treecolumn",text:IRm$.r1("B_NAME"),dataIndex:"name",flex:1,editor:{xtype:"textfield"}},{xtype:"gridcolumn",dataIndex:"dockey",text:"KEY",editor:{xtype:"textfield"}},{xtype:"checkcolumn",dataIndex:"visible",text:"Visible",width:40},{xtype:"actioncolumn",width:60,items:[{iconCls:"icon-grid-delete",tooltip:IRm$.r1("L_REMOVE"),handler:function(e,t,n,o){o.parentNode.removeChild(o)},scope:this}]}],tbar:[{text:"Save",name:"btn_save",iconCls:"icon-toolbar-save",handler:function(){this._save_menus()},scope:this},{text:"Add",handler:function(){var e,t=this.down("[name=menus]").getSelectionModel().selected,n=0;t&&t.length&&((e=t.items[0]).childNodes&&e.childNodes.length&&(n=e.childNodes.length),e.insertChild(n,{}))},scope:this}],listeners:{cellclick:function(e,t,n,o,i,a,l,d){0==n&&o.childNodes&&o.childNodes.length&&o.expand(!0),this._sel_content=o,this._load_content()},scope:this}}]},{xtype:"panel",region:"center",flex:1,title:"Manual Content Editor",layout:"fit",items:[{name:"t_editor",html:"<div id='manual_editor_main'><div class='manual-editor-area'></div></div>"}],listeners:{resize:function(){var e,t,n=this._editor,o=this.down("[name=t_editor]");if(n){e=$("#manual_editor_main",o.body.dom),t=$(".manual-editor-area",e);var i=o.getHeight();t.height(i-42)}},scope:this},tbar:[{text:"Save",handler:function(){this.save_content()},scope:this},{text:"Refresh",handler:function(){e._sel_content&&this._load_content()},scope:this}]}]}]}),IG$.MgrManual.superclass.initComponent.call(this)},listeners:{afterrender:function(){this._init_app()}}});
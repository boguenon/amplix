...
IG$.MgrManual=$s.extend(IG$.v$pnl,{layout:"fit",_init_app:function(){var e,t,n=this,i=n.down("[name=t_editor]");setTimeout((function(){e=$("#manual_editor_main",i.body.dom),t=$(".manual-editor-area",e);var o=i.getHeight();t.height(o-42);var a=new Quill(t[0],{modules:{toolbar:[[{header:[1,2,3,!1]}],["bold","italic","underline","strike"],[{list:"ordered"},{list:"bullet"}],[{indent:"-1"},{indent:"+1"}],[{color:[]},{background:[]}],[{align:[]}],["image","code-block"],["clean"]]},placeholder:"Compose an epic...",theme:"snow"});n._editor=a}),100),n._load_menu()},_load_menu:function(){var e=this,t=new IG$._rpc$,n="en";"ko_KR"==(window.useLocale||"en_US")&&(n="ko"),e._lang=n,t.init(e,{ack:"manual",payload:{lang:n},mbody:{option:"menu"}},e,(function(t){var n=e.down("[name=menus]"),i={name:"Root",children:t.children||[]};n.store.setRootNode(i),n.store.getRootNode().expand(!0)}),!1),t.send()},_save_menus:function(){var e=this,t=e.down("[name=menus]").getRootNode(),n={name:"root",children:[]},i=e._lang,o=new IG$._rpc$;e._upd_menus(t.childNodes,n.children),o.init(e,{ack:"manual",payload:{option:"save_menu",lang:i},mbody:n,meta_type:"object"},e,(function(e){})),o.send()},_upd_menus:function(e,t){var n=this;e&&$.each(e,(function(e,i){var o={name:i.get("name"),dockey:i.get("dockey"),visible:i.get("visible")};t.push(o),i.childNodes&&i.childNodes.length&&(o.children=[],n._upd_menus(i.childNodes,o.children))}))},save_content:function(){var e,t=this,n=t._editor,i=new IG$._rpc$,o=t._lang;t._sel_content&&(e=n.getContents(),i.init(t,{ack:"manual",payload:{uid:t._sel_content.get("dockey"),lang:o,option:"save"},mbody:e,meta_type:"object"},t,(function(e){}),null),i.send())},_load_content:function(){var e=(t=this)._editor;if(t._sel_content){var t=this,n=new IG$._rpc$,i=t._lang;n.init(t,{ack:"manual",payload:{lang:i,uid:t._sel_content.get("dockey")},mbody:{option:"get"}},t,(function(t){e.setContents(t)}),!1),n.send()}},initComponent:function(){var e=this;$s.apply(e,{items:[{xtype:"panel",layout:"border",split:!0,items:[{xtype:"panel",region:"north",width:350,height:420,layout:"fit",title:"Menu Structures",items:[{xtype:"treepanel",name:"menus",store:{xtype:"treestore"},columns:[{xtype:"treecolumn",text:IRm$.r1("B_NAME"),dataIndex:"name",flex:1,editor:{xtype:"textfield"}},{xtype:"gridcolumn",dataIndex:"dockey",text:"KEY",editor:{xtype:"textfield"}},{xtype:"checkcolumn",dataIndex:"visible",text:"Visible",width:40},{xtype:"gridcolumn",dataIndex:"cls"}],tbar:[{text:"Save",name:"btn_save",iconCls:"icon-toolbar-save",handler:function(){this._save_menus()},scope:this},{text:"Add",handler:function(){var e,t=this.down("[name=menus]").getSelectionModel().selected,n=0;t&&t.length&&((e=t.items[0]).childNodes&&e.childNodes.length&&(n=e.childNodes.length),e.insertChild(n,{}))},scope:this}],listeners:{cellclick:function(e,t,n,i,o,a,l,d){0==n?i.expand(!0):(this._sel_content=i,this._load_content())},scope:this}}]},{xtype:"panel",region:"center",flex:1,title:"Manual Content Editor",layout:"fit",items:[{name:"t_editor",html:"<div id='manual_editor_main'><div class='manual-editor-area'></div></div>"}],listeners:{resize:function(){var e,t,n=this._editor,i=this.down("[name=t_editor]");if(n){e=$("#manual_editor_main",i.body.dom),t=$(".manual-editor-area",e);var o=i.getHeight();t.height(o-42)}},scope:this},tbar:[{text:"Save",handler:function(){this.save_content()},scope:this},{text:"Refresh",handler:function(){e._sel_content&&this._load_content()},scope:this}]}]}]}),IG$.MgrManual.superclass.initComponent.call(this)},listeners:{afterrender:function(){this._init_app()}}});
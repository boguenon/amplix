...
var prettyPrintOne,prettyPrint,IN_GLOBAL_SCOPE=!0;window.PR_SHOULD_USE_CONTINUATION=!0,function(){var e=window,t=["break,continue,do,else,for,if,return,while"],n=[[t,"auto,case,char,const,default,double,enum,extern,float,goto,inline,int,long,register,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"],"catch,class,delete,false,import,new,operator,private,protected,public,this,throw,true,try,typeof"],r=[n,"alignof,align_union,asm,axiom,bool,concept,concept_map,const_cast,constexpr,decltype,delegate,dynamic_cast,explicit,export,friend,generic,late_check,mutable,namespace,nullptr,property,reinterpret_cast,static_assert,static_cast,template,typeid,typename,using,virtual,where"],s=[n,"abstract,assert,boolean,byte,extends,final,finally,implements,import,instanceof,interface,null,native,package,strictfp,super,synchronized,throws,transient"],a=[s,"as,base,by,checked,decimal,delegate,descending,dynamic,event,fixed,foreach,from,group,implicit,in,internal,into,is,let,lock,object,out,override,orderby,params,partial,readonly,ref,sbyte,sealed,stackalloc,string,select,uint,ulong,unchecked,unsafe,ushort,var,virtual,where"],i=[n,"debugger,eval,export,function,get,null,set,undefined,var,with,Infinity,NaN"],l="caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END",o=[t,"and,as,assert,class,def,del,elif,except,exec,finally,from,global,import,in,is,lambda,nonlocal,not,or,pass,print,raise,try,with,yield,False,True,None"],u=[t,"alias,and,begin,case,class,def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo,rescue,retry,self,super,then,true,undef,unless,until,when,yield,BEGIN,END"],c=[t,"as,assert,const,copy,drop,enum,extern,fail,false,fn,impl,let,log,loop,match,mod,move,mut,priv,pub,pure,ref,self,static,struct,true,trait,type,unsafe,use"],p=[t,"case,done,elif,esac,eval,fi,function,in,local,set,then,until"],f=/^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)\b/;function d(e,t,n,r){if(t){var s={sourceCode:t,basePos:e};n(s),r.push.apply(r,s.decorations)}}var h=/\S/;function g(e){for(var t=void 0,n=e.firstChild;n;n=n.nextSibling){var r=n.nodeType;t=1===r?t?e:n:3===r&&h.test(n.nodeValue)?e:t}return t===e?void 0:t}function m(e,t){var n,r={};!function(){for(var s=e.concat(t),a=[],i={},l=0,o=s.length;l<o;++l){var u=s[l],c=u[3];if(c)for(var p=c.length;--p>=0;)r[c.charAt(p)]=u;var f=u[1],d=""+f;i.hasOwnProperty(d)||(a.push(f),i[d]=null)}a.push(/[\0-\uffff]/),n=function(e){for(var t=0,n=!1,r=!1,s=0,a=e.length;s<a;++s){if((f=e[s]).ignoreCase)r=!0;else if(/[a-z]/i.test(f.source.replace(/\\u[0-9a-f]{4}|\\x[0-9a-f]{2}|\\[^ux]/gi,""))){n=!0,r=!1;break}}var i={b:8,t:9,n:10,v:11,f:12,r:13};function l(e){var t=e.charCodeAt(0);if(92!==t)return t;var n=e.charAt(1);return(t=i[n])||("0"<=n&&n<="7"?parseInt(e.substring(1),8):"u"===n||"x"===n?parseInt(e.substring(2),16):e.charCodeAt(1))}function o(e){if(e<32)return(e<16?"\\x0":"\\x")+e.toString(16);var t=String.fromCharCode(e);return"\\"===t||"-"===t||"]"===t||"^"===t?"\\"+t:t}function u(e){var t=e.substring(1,e.length-1).match(new RegExp("\\\\u[0-9A-Fa-f]{4}|\\\\x[0-9A-Fa-f]{2}|\\\\[0-3][0-7]{0,2}|\\\\[0-7]{1,2}|\\\\[\\s\\S]|-|[^-\\\\]","g")),n=[],r="^"===t[0],s=["["];r&&s.push("^");for(var a=r?1:0,i=t.length;a<i;++a){var u=t[a];if(/\\[bdsw]/i.test(u))s.push(u);else{var c,p=l(u);a+2<i&&"-"===t[a+1]?(c=l(t[a+2]),a+=2):c=p,n.push([p,c]),c<65||p>122||(c<65||p>90||n.push([32|Math.max(65,p),32|Math.min(c,90)]),c<97||p>122||n.push([-33&Math.max(97,p),-33&Math.min(c,122)]))}}n.sort((function(e,t){return e[0]-t[0]||t[1]-e[1]}));var f=[],d=[];for(a=0;a<n.length;++a){(h=n[a])[0]<=d[1]+1?d[1]=Math.max(d[1],h[1]):f.push(d=h)}for(a=0;a<f.length;++a){var h=f[a];s.push(o(h[0])),h[1]>h[0]&&(h[1]+1>h[0]&&s.push("-"),s.push(o(h[1])))}return s.push("]"),s.join("")}function c(e){for(var r=e.source.match(new RegExp("(?:\\[(?:[^\\x5C\\x5D]|\\\\[\\s\\S])*\\]|\\\\u[A-Fa-f0-9]{4}|\\\\x[A-Fa-f0-9]{2}|\\\\[0-9]+|\\\\[^ux0-9]|\\(\\?[:!=]|[\\(\\)\\^]|[^\\x5B\\x5C\\(\\)\\^]+)","g")),s=r.length,a=[],i=0,l=0;i<s;++i){if("("===(p=r[i]))++l;else if("\\"===p.charAt(0)){(c=+p.substring(1))&&(c<=l?a[c]=-1:r[i]=o(c))}}for(i=1;i<a.length;++i)-1===a[i]&&(a[i]=++t);for(i=0,l=0;i<s;++i){if("("===(p=r[i]))a[++l]||(r[i]="(?:");else if("\\"===p.charAt(0)){var c;(c=+p.substring(1))&&c<=l&&(r[i]="\\"+a[c])}}for(i=0;i<s;++i)"^"===r[i]&&"^"!==r[i+1]&&(r[i]="");if(e.ignoreCase&&n)for(i=0;i<s;++i){var p,f=(p=r[i]).charAt(0);p.length>=2&&"["===f?r[i]=u(p):"\\"!==f&&(r[i]=p.replace(/[a-zA-Z]/g,(function(e){var t=e.charCodeAt(0);return"["+String.fromCharCode(-33&t,32|t)+"]"})))}return r.join("")}var p=[];for(s=0,a=e.length;s<a;++s){var f;if((f=e[s]).global||f.multiline)throw new Error(""+f);p.push("(?:"+c(f)+")")}return new RegExp(p.join("|"),r?"gi":"g")}(a)}();var s=t.length,a=function(e){for(var i=e.sourceCode,l=e.basePos,o=[l,"pln"],u=0,c=i.match(n)||[],p={},f=0,h=c.length;f<h;++f){var g,m=c[f],v=p[m],y=void 0;if("string"==typeof v)g=!1;else{var b=r[m.charAt(0)];if(b)y=m.match(b[1]),v=b[0];else{for(var x=0;x<s;++x)if(b=t[x],y=m.match(b[1])){v=b[0];break}y||(v="pln")}!(g=v.length>=5&&"lang-"===v.substring(0,5))||y&&"string"==typeof y[1]||(g=!1,v="src"),g||(p[m]=v)}var w=u;if(u+=m.length,g){var C=y[1],N=m.indexOf(C),_=N+C.length;y[2]&&(N=(_=m.length-y[2].length)-C.length);var P=v.substring(5);d(l+w,m.substring(0,N),a,o),d(l+w+N,C,S(P,C),o),d(l+w+_,m.substring(_),a,o)}else o.push(l+w,v)}e.decorations=o};return a}function v(e){var t=[],n=[];e.tripleQuotedStrings?t.push(["str",/^(?:\'\'\'(?:[^\'\\]|\\[\s\S]|\'{1,2}(?=[^\']))*(?:\'\'\'|$)|\"\"\"(?:[^\"\\]|\\[\s\S]|\"{1,2}(?=[^\"]))*(?:\"\"\"|$)|\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$))/,null,"'\""]):e.multiLineStrings?t.push(["str",/^(?:\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$)|\`(?:[^\\\`]|\\[\s\S])*(?:\`|$))/,null,"'\"`"]):t.push(["str",/^(?:\'(?:[^\\\'\r\n]|\\.)*(?:\'|$)|\"(?:[^\\\"\r\n]|\\.)*(?:\"|$))/,null,"\"'"]),e.verbatimStrings&&n.push(["str",/^@\"(?:[^\"]|\"\")*(?:\"|$)/,null]);var r=e.hashComments;r&&(e.cStyleComments?(r>1?t.push(["com",/^#(?:##(?:[^#]|#(?!##))*(?:###|$)|.*)/,null,"#"]):t.push(["com",/^#(?:(?:define|e(?:l|nd)if|else|error|ifn?def|include|line|pragma|undef|warning)\b|[^\r\n]*)/,null,"#"]),n.push(["str",/^<(?:(?:(?:\.\.\/)*|\/?)(?:[\w-]+(?:\/[\w-]+)+)?[\w-]+\.h(?:h|pp|\+\+)?|[a-z]\w*)>/,null])):t.push(["com",/^#[^\r\n]*/,null,"#"])),e.cStyleComments&&(n.push(["com",/^\/\/[^\r\n]*/,null]),n.push(["com",/^\/\*[\s\S]*?(?:\*\/|$)/,null]));var s=e.regexLiterals;if(s){var a=s>1?"":"\n\r",i=a?".":"[\\S\\s]",l="/(?=[^/*"+a+"])(?:[^/\\x5B\\x5C"+a+"]|\\x5C"+i+"|\\x5B(?:[^\\x5C\\x5D"+a+"]|\\x5C"+i+")*(?:\\x5D|$))+/";n.push(["lang-regex",RegExp("^(?:^^\\.?|[+-]|[!=]=?=?|\\#|%=?|&&?=?|\\(|\\*=?|[+\\-]=|->|\\/=?|::?|<<?=?|>>?>?=?|,|;|\\?|@|\\[|~|{|\\^\\^?=?|\\|\\|?=?|break|case|continue|delete|do|else|finally|instanceof|return|throw|try|typeof)\\s*("+l+")")])}var o=e.types;o&&n.push(["typ",o]);var u=(""+e.keywords).replace(/^ | $/g,"");u.length&&n.push(["kwd",new RegExp("^(?:"+u.replace(/[\s,]+/g,"|")+")\\b"),null]),t.push(["pln",/^\s+/,null," \r\n\t "]);var c="^.[^\\s\\w.$@'\"`/\\\\]*";return e.regexLiterals&&(c+="(?!s*/)"),n.push(["lit",/^@[a-z_$][a-z_$@0-9]*/i,null],["typ",/^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/,null],["pln",/^[a-z_$][a-z_$@0-9]*/i,null],["lit",new RegExp("^(?:0x[a-f0-9]+|(?:\\d(?:_\\d+)*\\d*(?:\\.\\d*)?|\\.\\d\\+)(?:e[+\\-]?\\d+)?)[a-z]*","i"),null,"0123456789"],["pln",/^\\[\s\S]?/,null],["pun",new RegExp(c),null]),m(t,n)}var y=v({keywords:[r,a,i,l,o,u,p],hashComments:!0,cStyleComments:!0,multiLineStrings:!0,regexLiterals:!0});function b(e,t,n){for(var r=/(?:^|\s)nocode(?:\s|$)/,s=/\r\n?|\n/,a=e.ownerDocument,i=a.createElement("li");e.firstChild;)i.appendChild(e.firstChild);var l=[i];function o(e){var t=e.nodeType;if(1!=t||r.test(e.className)){if((3==t||4==t)&&n){var i=e.nodeValue,l=i.match(s);if(l){var c=i.substring(0,l.index);e.nodeValue=c;var p=i.substring(l.index+l[0].length);if(p)e.parentNode.insertBefore(a.createTextNode(p),e.nextSibling);u(e),c||e.parentNode.removeChild(e)}}}else if("br"===e.nodeName)u(e),e.parentNode&&e.parentNode.removeChild(e);else for(var f=e.firstChild;f;f=f.nextSibling)o(f)}function u(e){for(;!e.nextSibling;)if(!(e=e.parentNode))return;for(var t,n=function e(t,n){var r=n?t.cloneNode(!1):t,s=t.parentNode;if(s){var a=e(s,1),i=t.nextSibling;a.appendChild(r);for(var l=i;l;l=i)i=l.nextSibling,a.appendChild(l)}return r}(e.nextSibling,0);(t=n.parentNode)&&1===t.nodeType;)n=t;l.push(n)}for(var c=0;c<l.length;++c)o(l[c]);t===(0|t)&&l[0].setAttribute("value",t);var p=a.createElement("ol");p.className="linenums";for(var f=Math.max(0,t-1|0)||0,d=(c=0,l.length);c<d;++c)(i=l[c]).className="L"+(c+f)%10,i.firstChild||i.appendChild(a.createTextNode(" ")),p.appendChild(i);e.appendChild(p)}var x={};function w(t,n){for(var r=n.length;--r>=0;){var s=n[r];x.hasOwnProperty(s)?e.console:x[s]=t}}function S(e,t){return e&&x.hasOwnProperty(e)||(e=/^\s*</.test(t)?"default-markup":"default-code"),x[e]}function C(t){var n,r,s,a,i,l,o,u=t.langExtension;try{var c=(n=t.sourceNode,r=t.pre,s=/(?:^|\s)nocode(?:\s|$)/,a=[],i=0,l=[],o=0,function e(t){var n=t.nodeType;if(1==n){if(s.test(t.className))return;for(var u=t.firstChild;u;u=u.nextSibling)e(u);var c=t.nodeName.toLowerCase();"br"!==c&&"li"!==c||(a[o]="\n",l[o<<1]=i++,l[o++<<1|1]=t)}else if(3==n||4==n){var p=t.nodeValue;p.length&&(p=r?p.replace(/\r\n?/g,"\n"):p.replace(/[ \t\r\n]+/g," "),a[o]=p,l[o<<1]=i,i+=p.length,l[o++<<1|1]=t)}}(n),{sourceCode:a.join("").replace(/\n$/,""),spans:l}),p=c.sourceCode;t.sourceCode=p,t.spans=c.spans,t.basePos=0,S(u,p)(t),function(e){var t=/\bMSIE\s(\d+)/.exec(navigator.userAgent);t=t&&+t[1]<=8;var n,r,s=/\n/g,a=e.sourceCode,i=a.length,l=0,o=e.spans,u=o.length,c=0,p=e.decorations,f=p.length,d=0;for(p[f]=i,r=n=0;r<f;)p[r]!==p[r+2]?(p[n++]=p[r++],p[n++]=p[r++]):r+=2;for(f=n,r=n=0;r<f;){for(var h=p[r],g=p[r+1],m=r+2;m+2<=f&&p[m+1]===g;)m+=2;p[n++]=h,p[n++]=g,r=m}f=p.length=n;var v,y=e.sourceNode;y&&(v=y.style.display,y.style.display="none");try{for(;c<u;){o[c];var b,x=o[c+2]||i,w=p[d+2]||i,S=(m=Math.min(x,w),o[c+1]);if(1!==S.nodeType&&(b=a.substring(l,m))){t&&(b=b.replace(s,"\r")),S.nodeValue=b;var C=S.ownerDocument,N=C.createElement("span");N.className=p[d+1];var _=S.parentNode;_.replaceChild(N,S),N.appendChild(S),l<x&&(o[c+1]=S=C.createTextNode(a.substring(m,x)),_.insertBefore(S,N.nextSibling))}(l=m)>=x&&(c+=2),l>=w&&(d+=2)}}finally{y&&(y.style.display=v)}}(t)}catch(t){e.console}}function N(e,t,n){var r=document.createElement("div");return r.innerHTML="<pre>"+e+"</pre>",r=r.firstChild,n&&b(r,n,!0),C({langExtension:t,numberLines:n,sourceNode:r,pre:1}),r.innerHTML}function _(t,n){var r=n||document.body,s=r.ownerDocument||document;function a(e){return r.getElementsByTagName(e)}for(var i=[a("pre"),a("code"),a("xmp")],l=[],o=0;o<i.length;++o)for(var u=0,c=i[o].length;u<c;++u)l.push(i[o][u]);i=null;var p=Date;p.now||(p={now:function(){return+new Date}});var f=0,d=/\blang(?:uage)?-([\w.]+)(?!\S)/,h=/\bprettyprint\b/,m=/\bprettyprinted\b/,v=/pre|xmp/i,y=/^code$/i,x=/^(?:pre|code|xmp)$/i,w={};!function n(){for(var r=e.PR_SHOULD_USE_CONTINUATION?p.now()+250:1/0;f<l.length&&p.now()<r;f++){for(var a=l[f],i=w,o=a;o=o.previousSibling;){var u=o.nodeType,c=(7===u||8===u)&&o.nodeValue;if(c?!/^\??prettify\b/.test(c):3!==u||/\S/.test(o.nodeValue))break;if(c){i={},c.replace(/\b(\w+)=([\w:.%+-]+)/g,(function(e,t,n){i[t]=n}));break}}var S=a.className;if((i!==w||h.test(S))&&!m.test(S)){for(var N=!1,_=a.parentNode;_;_=_.parentNode){var P=_.tagName;if(x.test(P)&&_.className&&h.test(_.className)){N=!0;break}}if(!N){a.className+=" prettyprinted";var E,L,A=i.lang;if(!A)!(A=S.match(d))&&(E=g(a))&&y.test(E.tagName)&&(A=E.className.match(d)),A&&(A=A[1]);if(v.test(a.tagName))L=1;else{var k=a.currentStyle,R=s.defaultView,T=k?k.whiteSpace:R&&R.getComputedStyle?R.getComputedStyle(a,null).getPropertyValue("white-space"):0;L=T&&"pre"===T.substring(0,3)}var $=i.linenums;($="true"===$||+$)||($=!!($=S.match(/\blinenums\b(?::(\d+))?/))&&(!$[1]||!$[1].length||+$[1])),$&&b(a,$,L),C({langExtension:A,sourceNode:a,numberLines:$,pre:L})}}}f<l.length?setTimeout(n,250):"function"==typeof t&&t()}()}w(y,["default-code"]),w(m([],[["pln",/^[^<?]+/],["dec",/^<!\w[^>]*(?:>|$)/],["com",/^<\!--[\s\S]*?(?:-\->|$)/],["lang-",/^<\?([\s\S]+?)(?:\?>|$)/],["lang-",/^<%([\s\S]+?)(?:%>|$)/],["pun",/^(?:<[%?]|[%?]>)/],["lang-",/^<xmp\b[^>]*>([\s\S]+?)<\/xmp\b[^>]*>/i],["lang-js",/^<script\b[^>]*>([\s\S]*?)(<\/script\b[^>]*>)/i],["lang-css",/^<style\b[^>]*>([\s\S]*?)(<\/style\b[^>]*>)/i],["lang-in.tag",/^(<\/?[a-z][^<>]*>)/i]]),["default-markup","htm","html","mxml","xhtml","xml","xsl"]),w(m([["pln",/^[\s]+/,null," \t\r\n"],["atv",/^(?:\"[^\"]*\"?|\'[^\']*\'?)/,null,"\"'"]],[["tag",/^^<\/?[a-z](?:[\w.:-]*\w)?|\/?>$/i],["atn",/^(?!style[\s=]|on)[a-z](?:[\w:-]*\w)?/i],["lang-uq.val",/^=\s*([^>\'\"\s]*(?:[^>\'\"\s\/]|\/(?=\s)))/],["pun",/^[=<>\/]+/],["lang-js",/^on\w+\s*=\s*\"([^\"]+)\"/i],["lang-js",/^on\w+\s*=\s*\'([^\']+)\'/i],["lang-js",/^on\w+\s*=\s*([^\"\'>\s]+)/i],["lang-css",/^style\s*=\s*\"([^\"]+)\"/i],["lang-css",/^style\s*=\s*\'([^\']+)\'/i],["lang-css",/^style\s*=\s*([^\"\'>\s]+)/i]]),["in.tag"]),w(m([],[["atv",/^[\s\S]+/]]),["uq.val"]),w(v({keywords:r,hashComments:!0,cStyleComments:!0,types:f}),["c","cc","cpp","cxx","cyc","m"]),w(v({keywords:"null,true,false"}),["json"]),w(v({keywords:a,hashComments:!0,cStyleComments:!0,verbatimStrings:!0,types:f}),["cs"]),w(v({keywords:s,cStyleComments:!0}),["java"]),w(v({keywords:p,hashComments:!0,multiLineStrings:!0}),["bash","bsh","csh","sh"]),w(v({keywords:o,hashComments:!0,multiLineStrings:!0,tripleQuotedStrings:!0}),["cv","py","python"]),w(v({keywords:l,hashComments:!0,multiLineStrings:!0,regexLiterals:2}),["perl","pl","pm"]),w(v({keywords:u,hashComments:!0,multiLineStrings:!0,regexLiterals:!0}),["rb","ruby"]),w(v({keywords:i,cStyleComments:!0,regexLiterals:!0}),["javascript","js"]),w(v({keywords:"all,and,by,catch,class,else,extends,false,finally,for,if,in,is,isnt,loop,new,no,not,null,of,off,on,or,return,super,then,throw,true,try,unless,until,when,while,yes",hashComments:3,cStyleComments:!0,multilineStrings:!0,tripleQuotedStrings:!0,regexLiterals:!0}),["coffee"]),w(v({keywords:c,cStyleComments:!0,multilineStrings:!0}),["rc","rs","rust"]),w(m([],[["str",/^[\s\S]+/]]),["regex"]);var P=e.PR={createSimpleLexer:m,registerLangHandler:w,sourceDecorator:v,PR_ATTRIB_NAME:"atn",PR_ATTRIB_VALUE:"atv",PR_COMMENT:"com",PR_DECLARATION:"dec",PR_KEYWORD:"kwd",PR_LITERAL:"lit",PR_NOCODE:"nocode",PR_PLAIN:"pln",PR_PUNCTUATION:"pun",PR_SOURCE:"src",PR_STRING:"str",PR_TAG:"tag",PR_TYPE:"typ",prettyPrintOne:IN_GLOBAL_SCOPE?e.prettyPrintOne=N:prettyPrintOne=N,prettyPrint:prettyPrint=IN_GLOBAL_SCOPE?e.prettyPrint=_:prettyPrint=_};"function"==typeof define&&define.amd&&define("google-code-prettify",[],(function(){return P}))}();

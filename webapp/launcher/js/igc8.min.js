...
window.IG$||(window.IG$={}),IG$.__microloader=function(e){for(var t,c=ig$.bootconfig.boot,a=[];mod=e.shift();){var n=c[mod];if(n&&n.length)for(t=0;t<n.length;t++)a.push(n[t])}IG$.getScriptCache(a,new IG$.callBackObj(this,function(){}),"appnc"==mod)},IG$.getScriptCache=function(e,t,c){var a,o,s=[],i=document.head,d=document.scripts[0],n=[];IG$.___loaded_scr=IG$.___loaded_scr||{},$.each(e,function(e,t){t&&!IG$.___loaded_scr[t]&&n.push(t)}),a=n.length;function l(){s.length==a&&t&&t.execute()}if(c){var r=new Date;o=""+r.getFullYear()+(1+r.getMonth())+r.getDate()+r.getHours()+r.getMinutes()+r.getSeconds()}var p=function(e){var t,c,a=e.shift(),n="script",r=o||ig$.bootconfig.cache;a&&(n=(c=a.indexOf(".css")==a.length-4)?"link":n,IG$.___loaded_scr[a]||(IG$.___loaded_scr[a]=1,"async"in d?(t=document.createElement(n),c?(t.rel="stylesheet",t.type="text/css",t.media="all"):(t.type="text/javascript",t.async=!1),t.onload=function(){s.push(a),l()},t.onerror=function(){throw"dynamic loader : "+this.src},c?t.href=a+"?sc="+r:t.src=a+"?sc="+r,i.appendChild(t),p(e)):d.readyState?(t=document.createElement(n),c?(t.rel="stylesheet",t.type="text/css",t.media="all"):t.type="text/javascript",t.onreadystatechange=function(){"loaded"!=this.readyState&&"complete"!=this.readyState||(t.onreadystatechange=null,d.parentNode.insertBefore(t),s.push(a),l())},c?t.href=a+"?sc="+r:t.src=a+"?sc="+r,p(src)):document.write("<script src='"+a+"' type='text/javascript'><\/script>")))};a?p(n):(a=0,l())},IG$.callBackObj=function(e,t,c){var a=this;a.p1=e,a.p2=t,a.p3=c},IG$.callBackObj.prototype={execute:function(){var e,t,c=this,a=arguments,n=[];if(c.p2){for(e=0;e<a.length;e++)n.push(a[e]);c.p3&&n.push(c.p3),t=c.p2.apply(c.p1||null,n)}return t}},IG$.ready=function(e){IG$._ready$=IG$._ready$||[],IG$._ready$.push(e)};

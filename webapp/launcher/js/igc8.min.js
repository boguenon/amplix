...
window.IG$||(window.IG$={}),IG$.__microloader=function(e){for(var t,c=ig$.bootconfig.boot,n=[];mod=e.shift();){var a=c[mod];if(a&&a.length)for(t=0;t<a.length;t++)n.push(a[t])}IG$.getScriptCache(n,new IG$.callBackObj(this,function(){}),"appnc"==mod)},IG$.getScriptCache=function(e,t,c){var o,s=[],i=document.head,l=document.scripts[0],n=e.length;IG$.___loaded_scr=IG$.___loaded_scr||{},$.each(e,function(e,t){(!t||IG$.___loaded_scr[t])&&n--});function d(){s.length==n&&t&&t.execute()}if(c){var a=new Date;o=""+a.getFullYear()+(1+a.getMonth())+a.getDate()+a.getHours()+a.getMinutes()+a.getSeconds()}var p=function(e){var t,c,n=e.shift(),a="script",r=o||ig$.bootconfig.cache;n&&(a=(c=n.indexOf(".css")==n.length-4)?"link":a,IG$.___loaded_scr[n]||(IG$.___loaded_scr[n]=1,"async"in l?(t=document.createElement(a),c?(t.rel="stylesheet",t.type="text/css",t.media="all"):(t.type="text/javascript",t.async=!1),t.onload=function(){s.push(n),d()},t.onerror=function(){throw"dynamic loader : "+this.src},c?t.href=n+"?sc="+r:t.src=n+"?sc="+r,i.appendChild(t),p(e)):l.readyState?(t=document.createElement(a),c?(t.rel="stylesheet",t.type="text/css",t.media="all"):t.type="text/javascript",t.onreadystatechange=function(){"loaded"!=this.readyState&&"complete"!=this.readyState||(t.onreadystatechange=null,l.parentNode.insertBefore(t),s.push(n),d())},c?t.href=n+"?sc="+r:t.src=n+"?sc="+r,p(src)):document.write("<script src='"+n+"' type='text/javascript'><\/script>")))};n?p(e):(n=0,d())},IG$.callBackObj=function(e,t,c){var n=this;n.p1=e,n.p2=t,n.p3=c},IG$.callBackObj.prototype={execute:function(){var e,t,c=this,n=arguments,a=[];if(c.p2){for(e=0;e<n.length;e++)a.push(n[e]);c.p3&&a.push(c.p3),t=c.p2.apply(c.p1||null,a)}return t}};

...
window.IG$||(window.IG$={}),IG$.__microloader=function(e,t){for(var n,a=ig$.bootconfig.boot,c=[];mod=e.shift();){var r=a[mod];if(r&&r.length)for(n=0;n<r.length;n++)c.push(r[n]);else mod.substr&&".js"==mod.substr(mod.length-".js".length)&&c.push(mod)}IG$.getScriptCache(c,new IG$.callBackObj(this,(function(){t&&t.apply(null),t||"viewer"!=IG$._source||$s.ready((function(){var e=new IG$.amplix_instance({target:$("body")});e.onLoad((function(){})),e.create()}))})),"appnc"==mod)},IG$.getScriptCache=function(e,t,n){var a,c,r=[],i=document.head,o=document.scripts[0],s=[],d={};IG$.___loaded_scr=IG$.___loaded_scr||{},$.each(e,(function(e,t){!t||IG$.___loaded_scr[t]||d[t]||(s.push(t),d[t]=1)})),a=s.length;var l=function(){r.length==a&&t&&t.execute()};if(n){var p=new Date;c=""+p.getFullYear()+(1+p.getMonth())+p.getDate()+p.getHours()+"0000"}var u=function(e){var t,n,a,s=e.shift(),d="script",p=c||ig$.bootconfig.cache;s&&("object"==typeof s&&s.src&&(t=s,s=s.src),d=(a=s.indexOf(".css")==s.length-4)?"link":d,IG$.___loaded_scr[s]||(IG$.___loaded_scr[s]=1,"async"in o?(n=document.createElement(d),a?(n.rel="stylesheet",n.type="text/css",n.media="all"):(n.type="text/javascript",n.async=!1,t&&(t.defer&&(n.defer=t.defer),t.async&&(n.async=t.async))),n.onload=function(){r.push(s),l()},n.onerror=function(){throw"dynamic loader : "+this.src},a?n.href=s+"?sc="+p:s.indexOf("?")>0?n.src=s:n.src=s+"?sc="+p,i.appendChild(n),u(e)):o.readyState?(n=document.createElement(d),a?(n.rel="stylesheet",n.type="text/css",n.media="all"):n.type="text/javascript",n.onreadystatechange=function(){"loaded"!=this.readyState&&"complete"!=this.readyState||(n.onreadystatechange=null,o.parentNode.insertBefore(n),r.push(s),l())},a?n.href=s+"?sc="+p:n.src=s+"?sc="+p,u(e)):document.write("<script src='"+s+"' type='text/javascript'><\/script>")))};a?u(s):(a=0,l())},IG$.callBackObj=function(e,t,n){var a=this;a.p1=e,a.p2=t,a.p3=n},IG$.callBackObj.prototype={execute:function(){var e,t,n=this,a=arguments,c=[];if(n.p2){for(e=0;e<a.length;e++)c.push(a[e]);n.p3&&c.push(n.p3),t=n.p2.apply(n.p1||null,c)}return t}},IG$.ready=function(e){IG$._ready$=IG$._ready$||[],IG$._ready$.push(e)},IG$.amplix_instance=function(e){var t=this;t.config=e,t.target=e.target,IG$.$a_id=IG$.$a_id||0,t.id=""+IG$.$a_id++,IG$._insts$=IG$._insts$||{},IG$._insts$[t.id]=t,t.onLoad=function(e){t._ready$=t._ready$||[],t._ready$.push(e)}},IG$.amplix_instance.prototype={create:function(){IG$.createInstance(this)},$load_init:function(e,t){var n=this;n._ready$&&n._ready$.length&&($.each(n._ready$,(function(a,c){c.apply(n,e,t)})),n._ready$=null)},open_url:function(e,t){if(e.objid||e.uid){var n=this,a=(n.mainPanel,new IG$._rpc$);a.init(n,{ack:"helpcontent",payload:{uid:e.objid||e.uid},mbody:{option:"translate"}},n,(function(e){var a=e&&e.length?e[0]:null,c=n.mainPanel;a&&c.navigateApp.call(c,a.uid,a.type.toLowerCase(),a.name,a.nodepath,!0,a.writable),t&&t.execute()})),a.send(this)}},getComponent:function(e){var t,n=this.mainPanel;return n&&(t=n.getComponent(e)),t}};
window.IG$||(window.IG$={})
/*!
...
var IRm$={locale:[]};window.ig$&&(ig$.padding=ig$.padding||4),IRm$.r1=function(n,e,a){var c;if(!IRm$.currentLocale)for(IRm$.currentLocale=IRm$.locale[0],c=0;c<IRm$.locale.length;c++)if(IRm$.locale[c].name==window.useLocale){IRm$.currentLocale=IRm$.locale[c];break}var o=n;if((o=IRm$.currentLocale&&IRm$.currentLocale.data[n]?1==ig$.vmode?n+"*":IRm$.currentLocale.data[n]:(1==ig$.vmode?"x ":"")+(a||n))&&e)if("string"==typeof e&&(e=[e]),1==e.length)o=o.replace("@",e[0]);else for(c=0;c<e.length;c++)o=o.replace("@"+(c+1),e[c]);return o},IRm$.r2_d=function(n){n&&n.func&&n.func.call(n.scope)},IRm$.r2=function(n,e){var a=null,c=new IG$._rpc$,o=window.useLocale;IRm$.r3(),c.init(a,{ack:"content",payload:{uid:"/SYS_Config/locale/"+o},mbody:{},mts:"ROOT"},a,(function(c){var o,l,t=c;if(t&&t.data){for(l={name:t.name,data:{}},o=0;o<t.data.length;o++)l.data[t.data[o].name]=t.data[o].value;IRm$.locale.push(l)}if(!1===e)n&&n.func&&n.func.call(n.scope);else{var i=new IG$._rpc$;i.init(a,{ack:"content",payload:{uid:"/SYS_Config/ui_config"},mbody:{},mts:window.m$mts||"ROOT"},a,(function(e){e.config&&$.each(e.config,(function(n,e){"report_script"==n||"sheet_toolbar"==n||"application_title"==n||"application_title_html"==n?ig$[n]=IG$._decodeVal(e):("helper"==n&&$.each(e,(function(n,e){e.value=IG$._decodeVal(e.value)})),ig$[n]=e)})),n&&n.func&&n.func.call(n.scope)}),(function(){n&&n.func&&n.func.call(n.scope)})),i.send(1)}}),(function(){n&&n.func&&n.func.call(n.scope)})),c.send(1)},IRm$.r3=function(){var n=new IG$._rpc$;n.init(null,{ack:"collaborate",payload:{cmd:"request_channel",istest:"T"},mbody:{},mts:"ROOT"},null,(function(n){$("#robo_wrap").show()}),(function(){$("#robo_wrap").hide()})),n.showerror=!1,n.send(1)};

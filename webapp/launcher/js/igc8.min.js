...
IG$.chkSess=function(i,e){var n,o=this;IG$._g$a||(n=IG$._parse_url().params.mts);var s=function(){var n=new IG$._rpc$;n.init(o,{ack:"loginstatus",payload:{},mbody:{lang:useLocale,app:loadingApp}},o,(function(e){e.token,e.uid;var n=e.redirect;i?(window.$sso_try_count=0,i.call()):n&&n.length>0&&(window.$sso_try_count=0,window.location.replace(n))}),(function(i){return e&&e.call(),!1})),n.send()};if(n&&n.length){var t=new IG$._rpc$;t.init(o,{ack:"security",payload:{mts:n||""},mbody:{}},o,(function(i){var e=i.p1,n=i.p2;e&&n?(IG$.rsaPublicKeyModules=e,IG$.rsaPublicKeyExpoenent=n,IG$._g$a=i.mts,s()):s()}),(function(){s()})),t.send()}else s()},IG$._parse_url=function(i){var e,n,o,s=i||$(location).attr("href"),t=[],a={},r={};return e=s,s.indexOf("#")>-1&&(n=s.substring(s.lastIndexOf("#")+1),e=s=s.substring(0,s.lastIndexOf("#")),t=n.split("&"),$.each(t,(function(i,e){var n,o;e&&e.indexOf("=")>0&&(n=e.substring(0,e.indexOf("=")),o=e.substring(e.indexOf("=")+1),r[n]=o)}))),s&&s.indexOf("?")>0&&(e=s.substring(0,s.indexOf("?")),t=(s=s.substring(s.indexOf("?")+1)).split("&"),$.each(t,(function(i,e){var n,o;e.indexOf("=")>0&&(n=e.substring(0,e.indexOf("=")),o=e.substring(e.indexOf("=")+1),a[n]=o)}))),e&&e.indexOf(".")>-1&&(o=e.substring(e.lastIndexOf(".")+1)),{doctype:o,url:e,params:a,params_tag:r}},IG$._unstrip_url=function(i){var e=i.url,n=0;return i.params&&$.each(i.params,(function(i,o){e+=0==n?"?":"&",e+=i+"="+(o||""),n++})),i.params_tag&&(n=0,$.each(i.params_tag,(function(i,o){e+=0==n?"#":"&",e+=i+"="+(o||""),n++}))),e},IG$.doStartSession=function(i,e,n,o,s){n&&n.show();var t=$("#il_err");t.hide();var a=new IG$._rpc$;a.init(this,{ack:"security",payload:{mts:o},mbody:{}},this,(function(t){var a,r;a=t.p1,r=t.p2,a&&r?(IG$.rsaPublicKeyModules=a,IG$.rsaPublicKeyExpoenent=r,IG$._g$a=t.mts,setTimeout((function(){IG$.pLoginRSA(i,e,n,o,s)}),10)):(alert("Error while get security key"),n&&n.hide())}),(function(i){var e=i.errorcode,o=i.errormsg;if(n&&n.hide(),"0x6d00"==e)return t.unbind("click"),t.bind("click",(function(){t.hide()})),t.show(),$(".igc-errorinfo-msg",t).html(o),!1})),a.send()},IG$.pLoginRSA=function(i,e,n,o,s){var t=IG$.encryptKey([i,e]),a=$("#il_err");a.hide();var r=new IG$._rpc$;r.init(this,{ack:"login",payload:{userid:t[0],passwd:t[1]},mbody:{lang:useLocale,app:loadingApp,theme:ig$.theme_id,session_expire:""+(ig$.session_expire||0),mts:o||""}},this,(function(i){var e;n&&n.hide(),i.token,i.uid,(e=i.redirect)&&e.length>0?window.location.replace(e):alert("System Error:: Application is not defined on configuration!")}),(function(i){var e=i.errormsg,o=i.errorcode;return n&&n.hide(),"0x6d00"==o?(a.unbind("click"),a.bind("click",(function(){a.hide()})),a.show(),$(".igc-errorinfo-msg",a).html(e),s&&s.execute(),!1):s?(s.execute(),!1):void 0})),r.send()},IG$.chkSvrInfo=function(i){var e=new IG$._rpc$;e._rmethod="GET",e.init(this,{get_params:{sreq:"version"}},this,(function(e,n){ig$.appInfo=ig$.appInfo||{},ig$.appInfo.appversion=ig$.appInfo.appversion$||e.version||"0.0",ig$.appInfo.apprelease=ig$.appInfo.apprelease$||e.release||"0.00",ig$.appInfo.licensed=e.licensed||"xxx",i&&i.call()}),(function(e){return ig$.appInfo=ig$.appInfo||{},ig$.appInfo.appversion="_._",ig$.appInfo.apprelease="_._.___",ig$.appInfo.licensed="",i&&i.call(),!1})),e.send()},IG$.createLoginPanel=function(i,e,n){var o,s,t,a=$("<div id='loginWindow' class='loginWindow'></div>"),r=$("<div class='login-container'></div>").appendTo(a),l=ig$.lang,p=ig$.themes;if(window.bowser.msie&&(a.css({width:"100%",height:"100%"}),ig$.appbg)){var d=$("<img src='./images/"+ig$.appbg+"' class='background'/>");d.css({width:"100%",height:"100%",position:"absolute",top:0,left:0}),r.append(d)}if(l)for(o=0;o<l.length;o++)if(l[o].code==useLocale){s=l[o];break}if(t=["<div class='login-mc bounceInDown animated'>","<div class='login-ic'>","<img class='login-logo' src='./images/logo_7186.png'>","<div id='login_locale'><div class='locale_button'><span>Language</span>","<select id='b_loc'>"],l)for(o=0;o<l.length;o++)t.push("<option value='"+l[o].code+"'"+(useLocale==l[o].code?" selected":"")+">"+l[o].disp+"</option>");if(t.push("</select></div></div>"),p){for(t.push("<div id='login_theme'><div class='locale_button'><span>Theme</span>"),t.push("<select id='b_theme'>"),o=0;o<p.length;o++)t.push("<option value='"+p[o].code+"'"+(ig$.theme_id==p[o].code?" selected":"")+">"+p[o].disp+"</option>");t.push("</select></div></div>")}t.push("<form name='login_form' id='login_form' rel='nofollow' target='temp' action=''>"),t.push(" <ul>"),t.push("   <li>"),t.push("\t<div id='user_lbl' class='login-lbl'>"+(s&&s.l1?s.l1:"User ID")+"</div>"),t.push("\t<input id='userid' type='text' name='userid' value='"+(i||"")+"'>"),t.push("   </li>"),t.push("   <li>"),t.push("\t<div id='pass_lbl' class='login-lbl'>"+(s&&s.l2?s.l2:"Password")+"</div>"),t.push("\t<input id='userpassword' type='password' name='userpassword' value='"+(e||"")+"'>"),t.push("   </li>"),t.push("   <li>"),t.push("\t<div class='login-lbl'>&nbsp;</div>"),t.push("\t<input id='login_btn' type='button' value='"+(s&&s.l3?s.l3:"Login")+"'>"),t.push("   </li>"),t.push(" </ul>"),t.push("</form>"),t.push("<div id='license'>Licensed to: "+(ig$.appInfo?ig$.appInfo.licensed||"xxx":"...")+"</div>"),t.push("</div>"),t.push("</div>"),loginForm=$(t.join("")).appendTo(r).addClass("loginForm");$("<div class='legal'><table border='0' cellpadding='0' cellspacing='0'>  <tr>\t<td width='78'>&nbsp;</td>\t<td width='*' valign='top'><div align='left'>\t  <p class='style2'>"+ig$.copy+"</p>\t  <p class='style1'><span class='style4'>For support please contact</span>\t  <a href='https://amplixbi.com' target='_new'>amplixbi.com</a></p>\t</div></td>  </tr></table></div>").appendTo(r);var c=$("<div class='build'><div align='right'><span class='style6'>Build Id: <span id='app_release'"+(ig$.appInfo&&ig$.appInfo.apprelease)+"</span></span></div></div>").appendTo(r);$("<div id='il_err' class='igc-alert-cnt'><div class='igc-alert-bg'></div><div class='igc-alert-body'><div class='igc-alert igc-alert-error'><a class='close'>x</a><h4 class='alert-heading'></h4><span class='igc-errorinfo-msg'></span></div></div></div>").appendTo(r).hide();var u=$("<div id='login-progress' class='login-progress'></div>").css({position:"absolute",width:"100%",height:"100%",top:0,left:0,right:0,bottom:0}).hide().appendTo(r);return window.IG$.cLogin&&window.IG$.cLogin(a),$(document.body).append(a),IG$.chkSvrInfo((function(){$("#app_release",c).text(ig$.appInfo.apprelease),$("#license",a).text("Licensed to: "+(ig$.appInfo.licensed||"xxx"))})),setTimeout((function(){i?$("#userpassword").focus():$("#userid").focus()}),200),$("#userpassword").bind("focus",(function(){$("#userpassword").select()})),$("#userid").bind("focus",(function(){$("#userid").select()})),$("#userpassword").bind("mouseup",(function(){setTimeout((function(){$("#userpassword").select()}),80)})),$("#userid").bind("mouseup",(function(){setTimeout((function(){$("#userid").select()}),80)})),!1!==n&&($("#b_loc").bind("change",(function(i){var e,n=$("#b_loc"),o=$("option:selected",n).val(),s=$(location).attr("href");o&&o!=window.useLocale&&($.removeCookie("lang"),$.cookie("lang",o,{path:"/"}),"html"==(e=IG$._parse_url(s)).doctype?e.params_tag.lang=o:e.params.lang=o,e.params_tag.source="app",s=IG$._unstrip_url(e),u.show(),setTimeout((function(){window.location.replace(s),"html"==e.doctype&&window.location.reload()}),100))})),$("#b_theme").bind("change",(function(i){var e=$("#b_theme"),n=$("option:selected",e).val(),o=$(location).attr("href");n!=ig$.theme_id&&($.removeCookie("theme"),$.cookie("theme",n,{path:"/"}),urlinfo=IG$._parse_url(o),"html"==urlinfo.doctype?urlinfo.params_tag.theme=n:urlinfo.params.theme=n,urlinfo.params_tag.source="app",o=IG$._unstrip_url(urlinfo),u.show(),setTimeout((function(){window.location.replace(o),"html"==urlinfo.doctype&&window.location.reload()}),100))})),$("#login_btn").bind("click",(function(i){i.preventDefault(),i.stopPropagation();var e=$("#userid").val(),n=$("#userpassword").val();return $("#userpassword").val(""),$(this).blur(),e?n?(IG$.dlgLogin.getKeyPair.call(IG$.dlgLogin,e,n,u,window.m$mts),!1):(IG$.ShowError(IRm$.r1("L_BLANK_PASSWORD")),!1):(IG$.ShowError(IRm$.r1("L_BLANK_USERID")),!1)})),$("#userpassword").bind("keypress",(function(i){if(13==i.keyCode){var e=$("#userid").val(),n=$("#userpassword").val();return $("#userpassword").val(""),$(this).blur(),e?n?(IG$.dlgLogin.getKeyPair.call(IG$.dlgLogin,e,n,u,window.m$mts),!1):(IG$.ShowError(IRm$.r1("L_BLANK_PASSWORD")),!1):(IG$.ShowError(IRm$.r1("L_BLANK_USERID")),!1)}return!0}))),a},IG$.showLogin=function(i,e){$("#idv-mnu-pnl").hide(),IG$.dlgLogin&&(IG$.dlgLogin.callback=new IG$.callBackObj(this,(function(){IG$.dlgLogin.tl=-1,IG$.showLoginProc()}))),window.hist&&window.hist.addHistory(""),IG$._popupDlgs&&($.each(IG$._popupDlgs,(function(i,e){try{e&&e.close&&e.close()}catch(i){}})),IG$._popupDlgs=[]);var n=$("#loginWindow"),o=window.bowser;$("#license",n).html("Licensed to: "+(ig$.appInfo?ig$.appInfo.licensed||"xxx":"...")),n.css({zIndex:99}),o.msie&&n.css({position:"absolute",top:0,left:0,right:0,bottom:0,width:"100%",height:"100%",margin:0,padding:0}),n.show()},IG$.showLogout=function(i){IG$.msgint>-1&&(clearInterval(IG$.msgint),IG$.msgint=-1),IG$.confirmMessages(IRm$.r1("B_CONFIRM"),IRm$.r1("L_T_LOUT"),(function(e){if("yes"==e){var n=new IG$._rpc$;n.init(null,{ack:"logout",payload:{},mbody:{}},null,(function(i){}),(function(){return!0})),n.send(),IG$.showLogin(i,1)}}))};

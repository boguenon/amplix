...
var IRm$={locale:[],r1:function(e,n,a){var c;if(!IRm$.currentLocale)for(IRm$.currentLocale=IRm$.locale[0],c=0;c<IRm$.locale.length;c++)if(IRm$.locale[c].name==window.useLocale){IRm$.currentLocale=IRm$.locale[c];break}var o=e;if((o=IRm$.currentLocale&&IRm$.currentLocale.data[e]?1==ig$.vmode?e+"*":IRm$.currentLocale.data[e]:(1==ig$.vmode?"x ":"")+(a||e))&&n)if("string"==typeof n&&(n=[n]),1==n.length)o=o.replace("@",n[0]);else for(c=0;c<n.length;c++)o=o.replace("@"+(c+1),n[c]);return o},r2_d:function(e){e&&e.func&&e.func.call(e.scope)},r2:function(e,n){var a=null,c=new IG$._rpc$,o=window.useLocale;IRm$.r3(),c.init(a,{ack:"content",payload:{uid:"/SYS_Config/locale/"+o},mbody:{},mts:"ROOT"},a,(function(c){var o,l,t=c;if(t&&t.data){for(l={name:t.name,data:{}},o=0;o<t.data.length;o++)l.data[t.data[o].name]=t.data[o].value;IRm$.locale.push(l)}if(!1===n)e&&e.func&&e.func.call(e.scope);else{var r=new IG$._rpc$;r.init(a,{ack:"content",payload:{uid:"/SYS_Config/ui_config"},mbody:{},mts:window.m$mts||"ROOT"},a,(function(n){n.config&&$.each(n.config,(function(e,n){"report_script"==e||"sheet_toolbar"==e||"application_title"==e||"application_title_html"==e?ig$[e]=IG$._decodeVal(n):("helper"==e&&$.each(n,(function(e,n){n.value=IG$._decodeVal(n.value)})),ig$[e]=n)})),e&&e.func&&e.func.call(e.scope)}),(function(){e&&e.func&&e.func.call(e.scope)})),r.send(1)}}),(function(){e&&e.func&&e.func.call(e.scope)})),c.send(1)},r3:function(){var e=new IG$._rpc$;e.init(null,{ack:"collaborate",payload:{cmd:"request_channel",istest:"T"},mbody:{},mts:"ROOT"},null,(function(e){$("#robo_wrap").show()}),(function(){$("#robo_wrap").hide()})),e.showerror=!1,e.send(1)}};

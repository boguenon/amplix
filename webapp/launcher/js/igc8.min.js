...
window.IG$||(window.IG$={}),IG$.getScriptCache=function(e,t){function i(){o.length==c&&t&&t.execute()}var o=[],s=document.head,r=document.scripts[0],c=e.length,p=function(e){var t,c,n=e.shift(),a="script";n&&(a=(c=n.indexOf(".css")==n.length-4)?"link":a,"async"in r?(t=document.createElement(a),c?(t.rel="stylesheet",t.type="text/css",t.media="all"):(t.type="text/javascript",t.async=!1),t.onload=function(){o.push(n),i()},t.onerror=function(){throw"dynamic loader : "+this.src},c?t.href=n+"?sc="+ig$.bootconfig.cache:t.src=n+"?sc="+ig$.bootconfig.cache,s.appendChild(t),p(e)):r.readyState?(t=document.createElement(a),c?(t.rel="stylesheet",t.type="text/css",t.media="all"):t.type="text/javascript",t.onreadystatechange=function(){"loaded"!=this.readyState&&"complete"!=this.readyState||(t.onreadystatechange=null,r.parentNode.insertBefore(t),o.push(n),i())},c?t.href=n+"?sc="+ig$.bootconfig.cache:t.src=n+"?sc="+ig$.bootconfig.cache,p(src)):document.write("<script src='"+n+"' type='text/javascript'><\/script>"))};p(e)},IG$.callBackObj=function(e,t,c){var n=this;n.p1=e,n.p2=t,n.p3=c},IG$.callBackObj.prototype={execute:function(){var e,t,c=this,n=arguments,a=[];if(c.p2){for(e=0;e<n.length;e++)a.push(n[e]);c.p3&&a.push(c.p3),t=c.p2.apply(c.p1||null,a)}return t}};

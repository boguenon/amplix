...
window.IG$||(window.IG$={}),IG$.__microloader=function(t){for(var e,c=ig$.bootconfig.boot,n=[];mod=t.shift();){var a=c[mod];if(a&&a.length)for(e=0;e<a.length;e++)n.push(a[e])}IG$.getScriptCache(n,new IG$.callBackObj(this,function(){}),"appnc"==mod)},IG$.getScriptCache=function(t,e,c){function o(){i.length==n&&e&&e.execute()}var s,i=[],p=document.head,l=document.scripts[0],n=t.length;if(c){var a=new Date;s=""+a.getFullYear()+(1+a.getMonth())+a.getDate()+a.getHours()+a.getMinutes()+a.getSeconds()}var h=function(t){var e,c,n=t.shift(),a="script",r=s||ig$.bootconfig.cache;n&&(a=(c=n.indexOf(".css")==n.length-4)?"link":a,"async"in l?(e=document.createElement(a),c?(e.rel="stylesheet",e.type="text/css",e.media="all"):(e.type="text/javascript",e.async=!1),e.onload=function(){i.push(n),o()},e.onerror=function(){throw"dynamic loader : "+this.src},c?e.href=n+"?sc="+r:e.src=n+"?sc="+r,p.appendChild(e),h(t)):l.readyState?(e=document.createElement(a),c?(e.rel="stylesheet",e.type="text/css",e.media="all"):e.type="text/javascript",e.onreadystatechange=function(){"loaded"!=this.readyState&&"complete"!=this.readyState||(e.onreadystatechange=null,l.parentNode.insertBefore(e),i.push(n),o())},c?e.href=n+"?sc="+r:e.src=n+"?sc="+r,h(src)):document.write("<script src='"+n+"' type='text/javascript'><\/script>"))};h(t)},IG$.callBackObj=function(t,e,c){var n=this;n.p1=t,n.p2=e,n.p3=c},IG$.callBackObj.prototype={execute:function(){var t,e,c=this,n=arguments,a=[];if(c.p2){for(t=0;t<n.length;t++)a.push(n[t]);c.p3&&a.push(c.p3),e=c.p2.apply(c.p1||null,a)}return e}};

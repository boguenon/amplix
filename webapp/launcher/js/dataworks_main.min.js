...
IG$.procMenuCommand=function(e,a,_){var r,n,c,s,i,I,t=a.toLowerCase(),M={},D="igcm",l=e.mainPanel||null;switch(a){case"CMD_PASSWORD_CHANGE":r=new IG$.passwordMgr({instance:me.instance}),IG$.checkLogin(null,r);break;case"CMD_PREF":r=new IG$.userpref({instance:me.instance}),IG$.checkLogin(null,r);break;case"CMD_MAKE_WORKSPACE":r=new IG$.makeItem({instance:me.instance,itemtype:"Folder",parentnodepath:"/",parentuid:"/"}),IG$.checkLogin(null,r);break;case"CMD_SW_APP":r=new IG$.workspace_switcher({instance:me.instance}),IG$.checkLogin(null,r);break;case"CMD_SERVER_CONFIG":break;case"CMD_HELP_MGR":i="helpManage",s=t,c=IRm$.r1("I_HELP_MGR");break;case"CMD_LOCALE":i="resourcemgr",s=t,c=IRm$.r1("I_LOC_MGR");break;case"CMD_DLOCALE":i="resourcemgr",s=t,M.dicmode=1,c=IRm$.r1("I_DLOC_MGR");break;case"CMD_META_IMP":i="metaImport",s=t,c=IRm$.r1("I_META_IMP");break;case"CMD_META_EDIT":i="MetaEditorPanel",s=t,c=IRm$.r1("I_META_EDIT"),M.uid=_.uid;break;case"CMD_META_MIG":i="mgr_deploy",s=t,c=IRm$.r1("I_META_MIG");break;case"CMD_RELATION_VIEW":s=t,i="relationMgr",c=IRm$.r1("L_RELATION_VIEW");break;case"CMD_TABLE_REGISTER":s=t,i="tableManager",c=IRm$.r1("L_MGR_DATABASE"),D="igcn";break;case"CMD_LOOKUP":s=t,i="systemlookup",c=IRm$.r1("L_S_LK");break;case"CMD_CONNECT_DB":s=t,i="mgrdb_config",c=IRm$.r1("L_REG_DATABASE");break;case"CMD_ABOUT":r=new IG$.aboutApp,IG$.checkLogin(null,r);break;case"CMD_USER_MANAGER":s=t,i="mgrUser",c=IRm$.r1("L_MGR_USER");break;case"CMD_SYS_CONFIG":s=t,i="mgrSysCfg",c=IRm$.r1("L_SYS_CONFIG");break;case"CMD_ASSIST_ROBO":s=t,i="mgrColab",c=IRm$.r1("L_ASSIST_ROBO");break;case"CMD_VAR":case"CMD_BD_CONFIG":s=t,i="hadoop_config",D="igc9",c=IRm$.r1("I_BD_CONFIG");break;case"CMD_DBD_MGR":s=t,i="mgr_dashboard",c=IRm$.r1("I_MGR_DBD");break;case"CMD_FEATURES":s=t,i="mgrFeatures";break;case"CMD_REPORT_STYLE":s=t,M.title=IRm$.r1("T_GLOBAL_REPORT_STYLE"),M.styletype="g",i="styleWizard";break;case"CMD_RSN":r=new IG$.rsn_editor({instance:me.instance}),IG$.checkLogin(null,r);break;case"CMD_SYSMON":i="sysmon",s=t,M.title=IRm$.r1("L_SYS_LOG");break;case"CMD_SYSRES":i="sys_resource",s=t;break;case"CMD_SCHEDULE":s=t,i="scheduler",c=IRm$.r1("I_SCHEDULE");break;case"CMD_SCH_PROG":s=t,i="sch_prog",c=IRm$.r1("I_SCHEDULE_MOD"),M.mod_type=_,"single_sign_on"==_&&(c="SingleSignOn");break;case"CMD_CHART_DSGN":s=t,i="chart_dsgn",c="Chart Coder";break;case"CMD_HOME":IG$.changeApp(e,0);break;case"CMD_DATASET":case"CMD_TABPANEL":IG$.changeApp(e,2);break;case"CMD_COMPETITION":IG$.changeApp(e,1);break;case"CMD_DISCUSSION":IG$.changeApp(e,3);break;case"CMD_WORKS":IG$.changeApp(e,4);break;case"CMD_BROWSER":var m=e.viewport.down("[name=mexplorer]");m&&!m.isVisible()&&IG$.changeApp(e,1);break;case"CMD_WIZARD":case"CMD_APP_WIZARD":var o,C=$(document),R=C.width(),E=C.height();!IG$.app_wizard&&IG$.ltW&&(IG$.app_wizard=new IG$.dlgSmartWizard({instance:e})),(o=IG$.app_wizard)&&(o.setSize(.8*R,.8*E),IG$.showDlg(null,o));break;case"CMD_SYNC_USER":s=t,M.uid=_,i="sync_user",c=IRm$.r1("T_SYNC_USER");break;case"CMD_MN_MENUS":IG$.changeApp(e,4,_);break;case"CMD_HD_BFLOW":case"CMD_MONG_DATA":I="CMD_HD_BFLOW"==a?"BigData":"MongoData",l&&l.navigateApp.call(l,null,I.toLowerCase(),I,null,null,!0);break;case"CMD_HD_MAPR":s=t,i="relationMgr",M._cmode=2,c=IRm$.r1("L_HD_BFLOW");break;case"CMD_ML_BAYES":var b=IG$._app_module_.bayesnet;if(i=b.name,D=b.modetype,c=c||b.opt.itemtype,b.opt)for(k in b.opt)M[k]=b.opt[k];break;case"CMD_D_MENU":s=t,i="dashboardmenu",c=t;break;case"CMD_REVISION":s=t,M.uid=_,i="mgrRevision",c=IRm$.r1("T_REVISION");break;case"CMD_TRASHBIN":s=t,M.uid=_,i="mgr_trashbin",c=IRm$.r1("L_TRASHBIN");break;case"CMD_MG_DISCO":s=t,M.uid=_,i="mg_disco",D="mg_disco",c=IRm$.r1("T_MIG_DISCO");break;case"CMD_MG_UPGRADE":itemuid=t,M.uid=_,i="mg_meta",D="mg_meta",c=IRm$.r1("T_MIG_META_UPGRADE");break;case"CMD_NEW_REPORT":s=t,i="ReportView",c="Report",(M=M||{}).writable=!0,M.opt_editmode=!0;break;case"CMD_NEW_SQL_REPORT":s=t,i="SQLReportView",c="SQLReport",(M=M||{}).writable=!0,M.opt_editmode=!0;break;case"CMD_NEW_DASHBOARD":s=t,i="DashboardEdit",D="igc7",c="Dashboard";break;case"CMD_MANUAL_AUTH":s=t,i="MgrManual",D="mg_meta",c=IRm$.r1("T_MGR_MANUAL");break;case"CMD_NEW_BOBJECT":return void IG$.create_meta(e);case"CMD_APP_HELP":var G="en";return"ko_KR"==window.useLocale&&(G="ko"),void window.open("../manual/"+G+"/","_blank")}if(i&&e.mainPanel){var d=e.mainPanel.getComponent.call(e.mainPanel,s);if(d)e.mainPanel.setActiveTab.call(e.mainPanel,d),"cmd_revision"==t&&d.loadUID.call(d,_);else if(M.instance=e,IG$[i]?(n=new IG$[i](M),c||(c=n.title)):(scripts=ig$.bootconfig.scmap[D],IG$.getScriptCache(scripts,new IG$.callBackObj(this,(function(){if(IG$[i])if(n=new IG$[i](M),c||(c=n.title),n.id=s,n.address=s,n.title=IG$.getTabTitle(c),1==n.isWindow)IG$.checkLogin(null,n);else{var a=e.mainPanel.add.call(e.mainPanel,n);e.mainPanel.setActiveTab.call(e.mainPanel,a)}else IG$.ShowError(IRm$.r1("L_ERR_L_MOD"))})))),n)if(n.id=s,n.address=s,n.title=IG$.getTabTitle(c),1==n.isWindow)IG$.checkLogin(null,n);else{var A=e.mainPanel.add.call(e.mainPanel,n);e.mainPanel.setActiveTab.call(e.mainPanel,A)}}};
IG$._dseditor=function(e){var t=this;t.opt=e,t.render=e.render,t.uid=e.uid,t._init()},IG$._dseditor.prototype={_init:function(){var e=this;$("#dataset_form",e.render).steps({bodyTag:"fieldset",onStepChanging:function(e,t,a){return!0},onStepChanged:function(e,t,a){},onFinishing:function(e,t){return!0},onFinished:function(e,t){}}),e.uid&&e.loadContent()},show:function(){this.render&&this.render.show()},hide:function(){this.render&&this.render.hide()},loadContent:function(){var e=this,t=new IG$._rpc$;t.init(e,{ack:"content",payload:{uid:e.uid,revision:e.revision},mbody:{option:"content"}},e,(function(e){var t=this;t._mc=e.content||{},t.loadJoins(),t.loadUserDB(!0)})),t.send()},loadJoins:function(){var e,t,a,n=this._mc.joins,l=[];if(n&&n.length)for(a=0;a<n.length;a++)(t={stable:(e=n[a]).source?e.source.tableuid:null,sfield:e.source?e.source.uid:null,stablename:e.source?e.source.tablename:null,stablelabel:e.source?e.source.tablelabel:null,sfieldname:e.source?e.source.name:null,ttable:e.target?e.target.tableuid:null,tfield:e.target?e.target.uid:null,ttablename:e.target?e.target.tablename:null,ttablelabel:e.target?e.target.tablelabel:null,tfieldname:e.target?e.target.name:null,oprel:e.join}).sdesc=(t.stablelabel||t.stablename)+"."+t.sfieldname,t.tdesc=(t.ttablelabel||t.ttablename)+"."+t.tfieldname,l.push(t)},loadUserDB:function(e){var t=this,a=new IG$._rpc$,n=t.bobj_datasource?t.bobj_datasource.uid:null;a.init(t,{ack:"userdb",payload:{address:"/Connections",option:"list"},mbody:{}},t,(function(t){var a,l,i=this,s=t.children,r=[];if(s&&s.length){for(a=0;a<s.length;a++)s[a].attributes&&"T"==s[a].attributes.attrb1&&!s[a].scid&&(r.push(s[a]),n&&n==s[a].uid&&(l=s[a]));if(i.bobj_uid)return i._mc.datasource=l||null,void i._startapp();var o;if(r.length){if(i._mc.datasource)for(a=0;a<r.length;a++)if(r[a].uid==i._mc.datasource.uid){o=r[a];break}if(!o&&i._mc.datasource)return void IG$.ShowError(IRm$.r1("E_DS_NOT_ALLOW_UPLOAD"),i);if(!e||e&&!i._mc.datasource_selected)return dlg=new IG$.dlg_select_ds({instance:i.instance,datasource:i._mc.datasource,callback:new IG$.callBackObj(i,(function(e){i._mc.datasource=e?{uid:e.data.uid,name:e.data.name}:null,i._mc.datasource||IG$.alertmsg(ig$.appname,"File upload will be on temporary filespaces!",null,i,1,"info",null,null,null,0),i._startapp()}))}),void IG$.checkLogin(i,dlg);i._startapp()}else e||(IG$.alertmsg(ig$.appname,"File upload will be on temporary filespaces!",null,i,1,"info",null,null,null,0),i._mc.datasource=null),i._startapp()}else e&&i._startapp()}),!1),a.send()},_startapp:function(){var e=this,t=$("#ds_files",e.render);$.each(e._mc.datafiles,(function(e,a){var n=['<li class="list-group-item" title="'+a.nodepath+'">','    <a href="#">'+a.filename+"</a>",'    <small class="text-muted"><i class="fa fa-clock-o">'+a.sheetname+"</i></small>","</li>"];tdiv=$(n.join("")).appendTo(t)})),e._set_ds(),e.uid?e.getTbls():e.uploadFile()},_set_ds:function(){this._mc},getTbls:function(){var e=this,t=new IG$._rpc$;t.init(e,{ack:"content",payload:{uid:e.uid},mbody:{subfolder:"T"}},e,(function(t){var a,n,l=t&&t.children?t.children:null,i=$("#m1",e.render),s=$("m1f",e.render),r=[];if(l)for(n=0;n<l.length;n++)a=l[n],r.push(a);$.each(r,(function(t,a){var n,l=['<li class="list-group-item" title="'+a.nodepath+'">','    <a href="#">'+a.name+"</a>",'    <small class="text-muted"><i class="fa fa-clock-o">'+a.sheetname+"</i></small>","</li>"];n=$(l.join("")).appendTo(i),$("a",n).bind("click",(function(t){t.preventDefault(),t.stopPropagation(),e.load_fields(a)}))})),s.empty(),r.length&&e.load_fields(r[0])})),t.send()},load_fields:function(e){var t=this,a=new IG$._rpc$,n=e.uid;n&&(a.init(t,{ack:"content",payload:{uid:n},mbody:{subfolder:"T"}},t,(function(e){var a=e&&e.children?e.children:null,n=$("#m1f",t.render);$.each(a,(function(e,t){t.pname=t.attributes&&t.attributes.attrb3?t.attributes.attrb3:""})),a.sort((function(e,t){return e.pname&&t.pname&&"column_"==e.pname.substring(0,7)&&"column_"==t.pname.substring(0,7)?parseInt(e.pname.substring(7))-parseInt(t.pname.substring(7)):e.pname?1:t.pname?-1:0})),$.each(a,(function(e,t){var a=['<li class="list-group-item" title="'+t.nodepath+'">','    <a href="#">'+t.name+"</a>",'    <small class="text-muted"><i class="fa fa-clock-o">'+t.sheetname+"</i></small>","</li>"];$(a.join("")).appendTo(n)}))})),a.send())}};
...
ig$.mainmenu={mainmenu:[{rcs:"L_HOME",type:"column",icon:"fa fa-th-large",template:"html/dw_intro.jsp",handler:function(){IG$.procMenuCommand("CMD_HOME")}},{rcs:"L_COMPETITION",type:"column",icon:"fa fa-diamond",template:"html/dw_competition.jsp",handler:function(){IG$.procMenuCommand("CMD_COMPETITION")}},{rcs:"L_DATASETS",type:"column",icon:"fa fa-bar-chart-o",template:"html/dw_dataset.jsp",handler:function(){IG$.procMenuCommand("CMD_DATASET")}},{rcs:"L_DISCUSSIONS",type:"column",icon:"fa fa-magic",template:"html/dw_discussion.jsp",info:!0,handler:function(){IG$.procMenuCommand("CMD_DISCUSSION")}},{rcs:"L_WORKS",type:"column",icon:"fa fa-star",template:"html/dw_works.jsp",handler:function(){IG$.procMenuCommand("CMD_WORKS")}},{rcs:"L_CREATE",type:"column",cls:"special_link",icon:"fa fa-database",handler:function(){IG$.procMenuCommand("CMD_BROWSER")}}]};

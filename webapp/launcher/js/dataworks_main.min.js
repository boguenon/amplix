...
IG$.MainPanel=$s.extend($s.panel,{margin:"0 0 0 0",resizeTabs:!0,minTabWidth:100,enableTabScroll:!0,activeTab:0,layout:{type:"card",deferredRender:!1},deferredRender:!1,hidemode:"offset",tabPosition:"top",removePanelHeader:!0,plain:!1,minTabWidth:void 0,maxTabWidth:void 0,___tabseq:0,customAddTab:function(e,t){var i=this,a=i.getComponent(e);a?(IG$.changeApp(2),i.setActiveTab(a)):(IG$.changeApp(2),t.id=e,a=i.add(t),i.setActiveTab(a))},navigateApp:function(e,t,i,a,n,s,o,l){var c,d=t+"_"+(e||this.___tabseq++),r=this.getComponent(d);if(r){if(IG$.changeApp(2),this.setActiveTab(r),l&&r.applyOption)r.applyOption.call(r,l);else if("dashboard"==t){this.getComponent("dashboardedit_"+e)&&r.uid&&r.uid.length>0&&r.procRunDashboard.call(r)}}else{var p=new IG$.callBackObj(this,(function(){this.navigateApp(e,t,i,a,n,s,o,l)})),m=IG$.createAppPanel(this.instance,e,t,i,a,s,o||null,p);if(m){if(m.address=a,m.title=IG$.getTabTitle(i),o)for(c in o)m[c]=o[c];if(l)for(c in l)m[c]=l[c];if(1==m.isWindow)n=!1,m.title=IG$.getTabTitle(i)+" ("+IRm$.r1("D_"+t.toUpperCase())+")",IG$.ps[m.address]||(IG$.ps[m.address]=m,m.on("close",(function(){delete IG$.ps[m.address]})),m.show());else{IG$.changeApp(2),m.id=d,this.selectedIndex=this.selectedIndex<0?0:this.selectedIndex;var g=this.add(m);this.setActiveTab(g)}}else n=!1}1==n&&e&&t&&(lastHist="&p1="+t+"&p2="+e,setTimeout((function(){hist.addHistory(lastHist)}),10))},initRecentVisit:function(){var e,t,i=this,a=$("#mbutton1"),n=($("#idv_recitems"),$("#welcome"));i.mviewer={mode:"recent",mrecenttext:a.text()},a.unbind("click"),a.bind("click",(function(){i.loadRecentVisit()}));e=[{title:"Step by Step",cls:"getting_started",handler:function(){IG$.procMenuCommand(instance,"CMD_APP_WIZARD")}},{title:"Navigator",cls:"navigator",handler:function(){var e;((e=i.down("[name=mexplorer]"))&&!e.isVisible()||instance.m_explorer&&ig$.app_tmpl&&ig$.app_tmpl.mainview&&ig$.app_tmpl.mainview.navitree&&!1!==ig$.app_tmpl.mainview.navitree.hidden)&&IG$.changeApp(1)}},{title:"About",cls:"about_app",handler:function(){IG$.procMenuCommand(instance,"CMD_ABOUT")}}],(t=$("#pg_links",n)).empty(),$.each(e,(function(e,i){if(!i.hidden){var a=$("<div class='intro-pg-column'><div class='intro-figure'><div class='image' title='"+i.title+"'><span class='"+i.cls+"'></span></div><div class='intro-figure-caption'><span class='intro-links'>"+i.title+"</span></div></div></div>");a.appendTo(t),a.length>0&&i.handler&&($(".image",a).bind("click",(function(){i.handler()})),$(".intro-links",a).bind("click",(function(){i.handler()}))),i.el=a}})),i.__pg_linksitems=e,i.updateLoginInfo(),i.loadRecentVisit()},initAdminMenu:function(){var e,t=IG$.dmgrmenu.body.dom,i=$(".ig-mgr-body",t),a=$(".ig-mgr-panel-close",t),n=ig$.mainmenu.mainmenu;i.empty(),a.bind("click",(function(){IG$.procMenuCommand(instance,"CMD_HOME")})),n&&$.each(n,(function(t,a){e=$("<ul class='ig-mgr-group'></ul>").appendTo(i),a.tul=e,a.tul.hide(),a.menus&&$.each(a.menus,(function(t,i){var a=$("<li class='ig-mgr-group-item "+(i.acls||"")+" animate-box fadeInLeft animated'><div class='ig-mgr-title'><span class='icon'></span><h3>"+(IRm$.r1(i.rcs)||i.text)+"</h3></div><ul class='ig-mgr-menu'></ul></li>").appendTo(e),n=$(".ig-mgr-menu",a);$.each(i.items,(function(e,t){$("<li class='ig-mgr-menu-item "+(t.acls||"")+"'>"+(IRm$.r1(t.rcs)||t.text)+"</li>").appendTo(n).bind("click",(function(){t.handler?t.handler.call(this):"logout"==t.cmd?IG$.showLogout(instance,new IG$.callBackObj(this,(function(){IG$.showLoginProc(instance)}))):t.cmd&&IG$.procMenuCommand(instance,t.cmd)}))}))}))}))},updateLoginInfo:function(){var e,t,i,a,n,s,o,l=this.instance,c=$("#last_login"),d=(l.viewport,l.dlgLogin?l.dlgLogin.logininfo:null);$("#home_app_title").html(ig$.home_app_title||IRm$.r1("L_HOME_APP_TITLE")),$("#home_app_desc").html(ig$.home_app_desc||IRm$.r1("L_HOME_APP_DESC")),$("#mbutton1").html(IRm$.r1("L_T_RECENT_VISIT")),IG$.update_vars(l),c&&c.length>0&&d&&l.dlgLogin.lastLogin&&(s=$(".last_login_time",c),o=$(".last_login_host",c),n=$(".cur_login_host",c),i=$(".cur_login_user_id",c),a=$(".cur_login_user_nm",c),e=l.dlgLogin.lastLogin.lastaccesstime,i.text(d.userid),a.text(d.username),e&&(t=IG$.formatDate(e),s.text(t),o.text(l.dlgLogin.lastLogin.lastaccessaddr),n.text(l.dlgLogin.lastLogin.accessaddr)))},loadRecentVisit:function(){var e=this,t=($("#idv_recitems"),new IG$._rpc$);t.init(e,{ack:"helpcontent",payload:{},mbody:{option:"bookmarks"}},e,e.rs_loadContent,null,null),t.send()},rs_loadContent:function(e){var t,i,a=$("#idv_recitems"),n=$("#idv_recitems_ds"),s=[],o={},l=this.instance;if(a.empty(),n.empty(),a){for(t=0;t<e.length;t++)"Report"!=(i=e[t]).type&&"DataSet"!=i.type||(o[i.uid]?o[i.uid].fatype="F"==i.fatype?i.fatype:o[i.uid].fatype:(o[i.uid]=i,s.push(i)));s.sort((function(e,t){var i=0;return e.type!=t.type&&(i=e.type>t.type?1:-1),i})),this.shortcuts={},$.each(s,(function(e,t){var i,s,o=t.type.toUpperCase(),c=t.fab_mdateprd,d=t.fab_mdatefmt;c<60?d=c+" sec":c<3600?d=Math.floor(c/60)+" min":c<86400?d=Math.floor(c/3600)+" hour":c<864e3&&(d=Math.floor(c/86400)+" days"),"REPORT"==o?(i=['<li class="list-group-item" title="'+t.nodepath+'">','    <a href="#">'+t.name+"</a>"+("F"==t.fatype?"<span class='ig-fa-mark'></span>":""),'    <small class="text-muted"><i class="fa fa-clock-o"></i> '+d+"</small>","</li>"],s=$(i.join("")).appendTo(a)):"DATASET"==o&&(i=['<div class="timeline-item">','    <div class="row">','        <div class="col-xs-12 content no-top-border" style="min-height:initial">','            <p class="m-b-xs"><a href=""><strong>'+t.name+'</strong></a> <small class="text-navy"><i class="fa fa-clock-o"></i> '+d+"</small></p>",t.description?"            <p>"+t.description+"</p>":"","        </div>","    </div>","</div>"],s=$(i.join("")).appendTo(n)),$("a",s).bind("click",(function(e){e.preventDefault(),e.stopPropagation(),"REPORT"==o?IG$.changeApp(l,6,t):"DATASET"==o&&IG$.changeApp(l,8,t)}))}))}},deferredRender:!0,onAdd:function(e,t){$s.tabpanel.prototype.onAdd.call(this,e,t)},initComponent:function(){var e=this,t=e.instance,i=([].concat(e.dockedItems||[]),e.activeTab||(e.activeTab=0));e.tabPosition;e.layout={owner:e,type:"card",deferredRender:e.deferredRender,itemCls:e.itemCls,activeItem:i},t.mainPanelTabBar=new $s.tabbar({xtype:"tabbar",ui:e.ui,dock:"top",id:"ig-tabbar",cls:"ig-main-tabbar",flex:1,orientation:"horizontal",plain:!0,cardLayout:e.layout,tabPanel:e,padding:0,margin:0,bodyPadding:0,listeners:{tabclick:function(e,t,i){IG$.changeApp(2)}}}),e.tabBar=t.mainPanelTabBar,IG$.MainPanel.superclass.initComponent.call(this),e.setActiveTab=function(t){IG$.changeApp(2),$s.tabpanel.prototype.setActiveTab.call(e,t)},e.getActiveTab=$s.tabpanel.prototype.getActiveTab,e.getTabBar=$s.tabpanel.prototype.getTabBar,e.onItemEnable=$s.tabpanel.prototype.onItemEnable,e.onItemDisable=$s.tabpanel.prototype.onItemDisable,e.onRemove=function(i,a){if($s.tabpanel.prototype.onRemove.call(e,i,a),0==e.items.length){t.m_explorer;IG$.changeApp(IG$.__atab)}},i&&e.tabBar.setActiveTab(i.tab,!0)},listeners:{beforeadd:function(e,t,i,a){var n,s=this,o=s.getTabBar(),l=ig$.maxtapcount||0;l>0&&s.items.length>=l&&(n=s.items.items[0],s.remove(n),o&&o.$ex&&n.tab&&void 0!==n.tab.tabid&&o.$ex.removeOption(n.tab.tabid))}}});

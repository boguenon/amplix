...
var $MI=function(e){this.mbase=e,this.cdef=null,this.jdbc_template={mysql:{name:"MySQL",driver:"com.mysql.jdbc.Driver",jdbc:"jdbc:mysql://db_host:db_port/db_name",validatesql:"SELECT 1"},oracle:{name:"Oracle Thin Driver",driver:"oracle.jdbc.OracleDriver",jdbc:"jdbc:oracle:thin:@db_host:db_port:db_name",validatesql:"SELECT 1 FROM DUAL"},mssql:{name:"Microsoft MSSQL Server JDBC Driver",driver:"com.microsoft.sqlserver.jdbc.SQLServerDriver",jdbc:"jdbc:microsoft:sqlserver://db_host:db_port;databaseName=db_name;integratedSecurity=true;",validatesql:"SELECT 1"},postgres:{name:"PostgreSQL",driver:"org.postgresql.Driver",jdbc:"jdbc:postgresql://db_host:db_port/db_name",validatesql:"SELECT 1"}}};$MI.prototype={setLoading:function(e,a){var r=$("#loading"),t=$("#progressbar",r),s=$("#progress_gauge",t);1==e?(s.css({width:(a||100)+"%"}),r.show()):(s.css({width:"100%"}),setTimeout(function(){r.fadeOut()},200))},updateJdbcUrl:function(){var t,s=this,e=$("#db_type").val(),a="",r=this.jdbc_template[e];r&&($("#db_jdbc_driver").val(r.driver),$("#db_validatesql").val(r.validatesql),t=r.jdbc,$.each(["db_host","db_port","db_name"],function(e,a){var r=$("#"+a);s.clearError(r),-1<t.indexOf(a)&&(r.val()?t=t.replace(a,r.val()):s.setError(r))}),a=t),$("#db_jdbc_url").val(a)},getInstallStat:function(){var e=this,a=new IG$._rpc$;e.setLoading(!0),a.init(e,{ack:"sysinfo",payload:{},mbody:{}},e,e.rs_getInstallStat,function(e){e.errorcode;IG$.ShowErrorMessage(e),$("#app_home").html("<span style='color:#ff0000'>Not defined</span>")}),a.send()},rs_getInstallStat:function(e){var a,r=e,o=$("#sel_modules");this.cdef=e;var t;r.info.version.split("."),r.serverversion&&r.serverversion.split(".");if(r.needlogin||r.serverversion)return $(".error-desc",$("#d_error_01")).html("For security reasons this script will only work with a new and unmodified AmplixBI installation. You should either re-extract the files from the download package or consult the complete instruction."),$("#btn_start_01").remove(),void $("#d_error_01").show();if(!r.app_path)return $(".error-desc",$("#d_error_01")).html("APP_HOME location does not specified or configured with wrong place. Please check instruction and try again!"),void $("#d_error_01").show();if(o.empty(),r.modules&&$.each(r.modules,function(e,a){var r,t,s="module_"+e,d=["<tr>",'<td><input type="checkbox" id="'+s+'"></input></td>','<td><label for="'+s+'"><span class="module_name">'+a.name+'</span><br/><span class="module_desc">'+a.desc+"</span></label></td>","</tr>"];r=$(d.join("")).appendTo(o),(t=$("#"+s,r)).bind("change",function(e){a.selected=t.prop("checked")})}),$("#dpage_01").hide(),$("#dpage_02").show(),$("#dpage_03").hide(),$("#main-area").scrollTop(0),r.meta_databases){for(a=r.meta_databases.length-1;0<=a;a--)if("IGCBASE"==r.meta_databases[a].name){t=r.meta_databases[a];break}t&&(r.dbtype=t.dataBaseType)}$("#app_home").html("<span style='color:#0000ff'>"+r.app_path+"</span>"),$("#s_version").html(r.info.version),r.dbconnection&&$("#db_type").val(r.dbtype)},updateCnt:function(e){var t=this,s=t.cdef,d=s.meta_databases[0],o=!0;return $.each(e,function(e,a){var r=$("#"+a);if(t.clearError(r),!r.val())return t.setError(r),o=!1;switch(a){case"s2adminpwd":s.adminpwd=r.val();break;case"s2adminpwd_confirm":s.adminpwd!=r.val()&&(t.setError(r),o=!1);break;case"db_type":d.dataBaseType=r.val();break;case"db_jdbc_driver":d.jdbcDriver=r.val();break;case"db_jdbc_url":d.jdbcUrl=r.val();break;case"db_name":d.schemaname=r.val();break;case"db_user":case"md_user":d.userID=r.val();break;case"db_passwd":case"md_password":d.password=r.val();break;case"db_validatesql":d.validateSQL=r.val()}}),o},setError:function(e){$($(e.parent()).parent()).addClass("form-error")},clearError:function(e){$($(e.parent()).parent()).removeClass("form-error")},checkDatabaseCon:function(e){var a,r=this,t=r.cdef,s=new IG$._rpc$,d=["db_type","db_host","db_port","db_jdbc_driver","db_jdbc_url","db_validatesql"],o="db_con_status";if(e?(d=d.concat(e),o="db_con_status2"):d=d.concat(["db_user","db_passwd"]),clearMessage(),t.meta_databases=[{}],0!=r.updateCnt(d)){if(e)switch((a=t.meta_databases[0]).dataBaseType){case"mysql":case"postgres":case"mssql":-1<a.jdbcUrl.indexOf($("#db_name").val())&&(a.jdbcUrl=a.jdbcUrl.replace($("#db_name").val(),$("#md_owner").val()))}r.setLoading(!0),$("#db_con_status").empty(),$("#db_con_status").hide(),s.init(r,{ack:"checkdbinfo",meta_type:"config_info",payload:{},mbody:t},r,function(e){$("#"+o).html("Success on database connection!"),$("#"+o).fadeIn()},function(e){this.setLoading(!1),IG$.ShowErrorMessage(e),$("#"+o).html("<span style='color:#ff0000'>Error on database connection!</span>"),$("#"+o).fadeIn()}),s.send()}},doUpdate:function(){var e,a=this,r=a.cdef,t=new IG$._rpc$,s=$("#md_user"),d=$("#md_password");if(md_owner=$("#md_owner"),clearMessage(),r.meta_databases=[{}],0!=a.updateCnt(["db_type","db_host","db_name","db_port","db_user","db_passwd"])&&0!=a.updateCnt(["db_jdbc_driver","db_jdbc_url","db_validatesql","s2adminpwd","s2adminpwd_confirm"])){for(a.clearError(md_owner),a.clearError(s),a.clearError(d),e=0;e<r.modules.length;e++)if(r.modules[e].selected){if(!md_owner.val())return void a.setError(md_owner);if(!s.val())return void a.setError(s);if(!d.val())return void a.setError(d);r.modules[e].schemaname=md_owner.val(),r.modules[e].db_user=s.val(),r.modules[e].db_passwd=d.val()}a.setLoading(!0),t.init(a,{ack:"updateconfig",meta_type:"config_info",payload:{},mbody:r},a,a.rs_doUpdate,function(e){this.setLoading(!1),IG$.ShowErrorMessage(e)}),t.stoploading=!1,t.send()}},rs_doUpdate:function(e){var a=e.step;this.totalsteps=a,this.curstep=0,this.processUpdate()},processUpdate:function(){var d=this,o=d.cdef;d.setLoading(!0,0),$.ajax({url:ig$.servlet,type:"POST",contentType:"application/json; charset=UTF-8",data:JSON.stringify({ack:"security",payload:{},mbody:{},uniquekey:IG$.getUniqueKey()}),dataType:"json",timeout:3e5,error:function(){alert("Error while connecting server")},success:function(e,a,r){var t=e.result,s=e.errorcode;t?(p1=t.p1,p2=t.p2,p1&&p2?(IG$.rsaPublicKeyModules=p1,IG$.rsaPublicKeyExpoenent=p2,setTimeout(function(){var e=IG$.encryptKey([o.adminpwd]);d.encpwd=e,d.processUpdate_secure.call(d,e)},10)):(d.setLoading(!1),alert("Error while get secure key value. Please try again later!"))):s&&(d.setLoading(!1),IG$.ShowErrorMessage(e))}})},processUpdate_secure:function(e){var d=this,a=this.cdef,r=(new IG$._rpc$,0<d.totalsteps?d.curstep/d.totalsteps*100:0);d.setLoading(!0,r),$.ajax({url:ig$.servlet,type:"POST",contentType:"application/json; charset=UTF-8",data:JSON.stringify({ack:"procupdate",payload:{step:""+d.curstep++,apu:e[0]},mbody:a,meta_type:"config_info",uniquekey:IG$.getUniqueKey()}),dataType:"json",timeout:3e5,error:function(){alert("Error while connecting server")},success:function(e,a,r){var t=e.result,s=e.errorcode;t?d.rs_processUpdate.call(d,t):s&&(d.setLoading(!1),IG$.ShowErrorMessage(e))}})},rs_processUpdate:function(e){var a=this;a.curstep<a.totalsteps?a.processUpdate_secure(a.encpwd):a.rs_updateComplete()},rs_updateComplete:function(e){this.setLoading(!1),$("#dpage_01").hide(),$("#dpage_02").hide(),$("#dpage_03").show(),$("#main-area").scrollTop(0)}};
var m$p={metadb:{}};function callback(n,t,e){this.thisobj=n,this.success=t,this.execute=function(n){this.success.call(this.thisobj,n,e)}}function showMessage(n,t,e,i){var o=$("#d_error_01"),a=$("#d_error_02");o.html(n),o.fadeIn(),a.html(n),a.fadeIn()}function clearMessage(){var n=$("#d_error_01"),t=$("#d_error_02");n.fadeOut(),t.fadeOut()}function goMain(){var n=ig$.mainlink+"/";document.location.href=n}function doUpdate(){var n=ig$.mi,t=new IG$.callBackObj(n,n.doUpdate);$("#main-area").scrollTop(2e4),showMessage("Continue to update the server?","Confirm",!0,t)}IG$.ShowErrorMessage=function(n,t){var e=n.detail;showMessage(n.errormsg+"<br/>"+(e?"\n"+e:"")+"<br/>"+n.errorcode,"Error! ["+n.errorcode+"]",!0,null)},IG$.ShowConErr=function(n){showMessage("Error while connecting to server","Error!",!0,null)};var ig$=window.ig$||{};function init_events(){var n,t=window.location.pathname.split("/"),e=[];for(n=0;n<t.length&&"install"!=t[n];n++)e.push(t[n]);ig$.mainlink=e.join("/"),ig$.servlet=ig$.mainlink+"/servlet/ircp",ig$.mi=new $MI,$.each(["01","02"],function(n,e){$("#tab_"+e).bind("click",function(n){n.stopPropagation(),n.preventDefault(),$.each(["01","02"],function(n,t){$("#tab_"+t)[t==e?"addClass":"removeClass"]("selected"),$("#tab_content_"+t)[t==e?"show":"hide"]()})})});var i=$("#db_type");i.empty(),$.each(ig$.mi.jdbc_template,function(n,t){$("<option value='"+n+"'>"+t.name+"</option>").appendTo(i)}),$("#btn_start_form").bind("click",function(n){n.stopPropagation(),n.preventDefault(),ig$.mi.getInstallStat()}),$("#btn_back_inst").bind("click",function(n){n.stopPropagation(),n.preventDefault(),$("#dpage_01").show(),$("#dpage_02").hide(),$("#main-area").scrollTop(0)}),$("#btn_start_install").bind("click",function(n){n.stopPropagation(),n.preventDefault(),ig$.mi.doUpdate()}),$("#btn_check_dburl").bind("click",function(n){n.stopPropagation(),n.preventDefault(),ig$.mi.updateJdbcUrl()}),$("#btn_check_con").bind("click",function(n){n.stopPropagation(),n.preventDefault(),ig$.mi.checkDatabaseCon()}),$("#btn_check_con2").bind("click",function(n){n.stopPropagation(),n.preventDefault(),ig$.mi.checkDatabaseCon(["md_user","md_password"])}),$("#btn_start").bind("click",function(n){n.stopPropagation(),n.preventDefault(),goMain()}),ig$.mi.setLoading(!1)}$(document).ready(function(){init_events()});

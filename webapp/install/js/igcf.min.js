...
IG$._berr=0,IG$.ShowErrorMessage=function(e,n,t){var r=e.errorcode,i=e.errormsg,s=e.detail||null,a=e.stacktrace||null,o=!1;switch(r){case"0x7500":case"0x6d00":o=!0}0==o&&(s||a||t)?IG$.alertmsg(ig$.appname,i+"<br/>\n\n"+(s||""),null,n,1,"error",null,{errdesc:i,errmsg:s,errstack:a,params:t},null,1):IG$.alertmsg(ig$.appname,i+"\n\n"+(s||""),null,n,1,"error",null,null,null,1)},IG$._dofilter=function(e,n,t,r){var i=e.down("[name="+n+"]")||e,s=r?r.getValue():i.down("[name=_filter]").getValue();s?i.store.addFilter({dataIndex:t,operator:"like",value:s}):i.store.removeFilter({dataIndex:t,operator:"like"})},IG$.ShowError=function(e,n){IG$.alertmsg(ig$.appname,e,null,n,1,"error",null,null,null,1)},IG$.ShowConnectionError=function(e){IG$.alertmsg(ig$.appname,IRm$.r1("M_ERR_CONNECT"),null,e,1,"error",null,null,null,1)},IG$.showDlg=function(e,n){IG$._popupDlgs=IG$._popupDlgs||[],IG$._popupDlgs.push(n),n.show()},IG$.checkLogin=function(n,t,r){var e=new IG$._rpc$;n&&n.setLoading&&n.setLoading(!0),e.checklogin=!0,IG$._popupDlgs=IG$._popupDlgs||[],e.init(n,{ack:"ping",payload:{},mbody:{}},n,function(e){n&&n.setLoading&&n.setLoading(!1),t&&(IG$._popupDlgs.push(t),t.show()),r&&r.call(n)}),e.send()},IG$.alertmsg=function(e,n,r,i,t,s,a,o,c,l){if(2==t&&(c=1),l&&IG$._berr)return IG$._berr.err.push({mtype:s,stack:a,parent:i,a1:o}),void $(".cnt",IG$._berr.h).text(IG$._berr.err.length).show();var p,u,m,g,h,_,I,f,v,b=$("body"),k=$("<div class='igc-alert-cnt'>"+(t?"<div class='igc-alert-bg'></div>":"")+"<div class='igc-alert-body'></div></div>").appendTo(b),G=$(".igc-alert-body",k),w=IRm$.r1("M_UNKNOWN"),y="",x="",R=window.bowser;switch(l&&(IG$._berr={h:k,err:[{mtype:s,stack:a,parent:i,a1:o}]}),s=s||"warning"){case"error":w=IRm$.r1("M_ERROR");break;case"warning":w=IRm$.r1("M_WARNING");break;case"info":w=IRm$.r1("M_INFO");break;case"success":w=IRm$.r1("M_SUCCESS")}if(o){if(o.params){for(g in o.params)y&&(y+="\n"),y+=g+": "+o.params[g];y+="\n\n",o.errstack&&(y+="stacktrace :"+o.errstack+"\n")}else y="stacktrace : "+o.errstack+"\n";if(R){for(_ in R)"function"!=typeof R[_]&&(x+=_+": "+R[_]+"\n");y=x+"\n\n"+y,o.binfo=x}}p=$("<div class='igc-alert'><a class='close'>&#215;</a><div class='detail' style='display: none'>"+IRm$.r1("M_DETAIL")+"</div><div class='cnt' style='display:none'></div><h4 class='alert-heading'>"+w+"</h4><span>"+n+"</span></div>").appendTo(G),u=$(".close",p)[c?"hide":"show"](),m=$(".detail",p),y&&m.show(),p.addClass("igc-alert-"+s),m.bind("click",function(e){e.preventDefault(),e.stopImmediatePropagation(),(h=new IG$.ErrorDialog({messagecontent:o,renderTo:k[0]})).setPosition((k.width()-(h.width||h.$width))/2,(k.height()-(h.height||h.$height))/2),h.show()}),u.bind("click",function(e){e.preventDefault(),e.stopImmediatePropagation(),h&&h.close(),k.fadeOut(function(){r&&r.call(i),k.remove(),l&&(IG$._berr=0)})}),c?(v=[],6==c||14==c?(v.push({text:IRm$.r1("B_YES"),bseq:2,dlg:"yes"}),v.push({text:IRm$.r1("B_NO"),bseq:4,dlg:"no"}),14==c&&v.push({text:IRm$.r1("B_CANCEL"),bseq:8,dlg:"cancel"})):1!=c&&9!=c||(v.push({text:IRm$.r1("B_OK"),bseq:1,dlg:"ok"}),9==c&&v.push({text:IRm$.r1("B_CANCEL"),bseq:8,dlg:"cancel"})),I=$("<div class='igc-alert-buttons'><ul></ul></div>").appendTo(p),f=$("ul",I),$.each(v,function(e,n){var t=$("<li></li>").appendTo(f);d=$("<div class='igc-button'>"+n.text+"</div>").appendTo(t),d.bind("click",function(e){e.preventDefault(),e.stopImmediatePropagation(),h&&h.close(),k.fadeOut(function(){r&&r.call(i,n.dlg),k.remove(),l&&(IG$._berr=0)})})})):p.bind("click",function(e){e.preventDefault(),e.stopImmediatePropagation(),h&&h.close(),k.fadeOut(function(){r&&r.call(i),k.remove(),l&&(IG$._berr=0)})}),t||(k.addClass("igc-no-modal"),setTimeout(function(){h&&h.close(),k.fadeOut(function(){r&&r.call(i),k.remove(),l&&(IG$._berr=0)})},1500))},IG$.confirmMessages=function(e,n,t,r,i,s){IG$.alertmsg(e||IRm$.r1("L_SAVE_CHANGES"),n||IRm$.r1("L_SAVE_C_MSG"),t,i,1,"info",null,null,s||6)},IG$.checkLock=function(t,r){var e=new IG$._rpc$;e.init(t,{ack:"helpcontent",payload:{uid:t.uid},mbody:{option:"lock",detail:"check"}},t,function(e){var n;e?new IG$.LockWindow({lparam:e,callback:new IG$.callBackObj(t,function(e){r.call(t,e)})}).show(t):((n=new IG$._rpc$).init(t,{ack:"helpcontent",payload:{uid:t.uid},mbody:{option:"lock",detail:"set"}},t,function(e){},!1),n.send())},!1),e.send()},window.$s&&(IG$.v$pnl=$s.extend($s.panel,{frameHeader:!1,initComponent:function(){this.on("destroy",function(e,n){e.__dx=!0}),IG$.v$pnl.superclass.initComponent.call(this)},destroy:function(){var e=this;e.__dx=!0,setTimeout(function(){IG$.v$pnl.superclass.destroy.call(e)},10)},setLoading:function(e,n,t){var r=this,i={};return clearTimeout(r.__etimer),r.rendered&&0==e&&(r.__etimer=setTimeout(function(){r.customLoad&&!0!==t&&r.customLoad(!1),r.loadMask&&r.loadMask.destroy(),r.rendermask=null,r.loadMask=null},100)),r.rendered&&!1!==e&&(IG$.isObject(e)?IG$.apply(i,e):IG$.isString(e)&&(i.msg=e),i.dom=$(r.el.dom),(i.target=r).loadMask||(r.loadMask=new IG$._mask(i),r.loadMask.show())),r.loadMask}}),IG$.LockWindow=$s.extend($s.window,{modal:!0,region:"center",layout:"fit",closable:!1,resizable:!1,width:300,autoHeight:!0,callback:null,_closedlg:function(e){this.callback&&this.callback.execute(e),this.close()},initComponent:function(){var n=this;n.title=IRm$.r1("M_LOCK_TITLE"),$s.apply(this,{defaults:{bodyStyle:"padding:10px"},items:[{xtype:"displayfield",name:"txtlock",padding:10,value:""}],buttons:[{text:IRm$.r1("B_UNLOCK"),handler:function(){var e=new IG$._rpc$;e.init(n,{ack:"helpcontent",payload:{uid:n.uid},mbody:{option:"lock",detail:"unlock"}},n,function(e){n._closedlg("unlock")},!1),e.send()},scope:this},{text:IRm$.r1("B_CLOSE"),handler:function(){this._closedlg("close")},scope:this}],listeners:{afterrender:function(e){var n=this.down("[name=txtlock]"),t=this.lparam||{};this.uid=t.uid,n.setValue(IRm$.r1("M_LOCK_MSG",[t.username+"("+t.userid+")",IG$.formatDate(t.date)]))}}}),IG$.LockWindow.superclass.initComponent.apply(this,arguments)}}),IG$.ErrorDialog=$s.extend($s.panel,{modal:!0,layout:"fit",closable:!1,resizable:!1,callback:null,width:600,height:550,_cerr:0,showError:function(e){var n,t="";if(e.params){for(n in e.params)t&&(t+="\n"),t+=n+": "+e.params[n];t+="\n\n"}var r,i=this.down("[name=m_msg]"),s=$(i.body.dom);s.empty(),r=$("<div class='ing-error-dlg'></div>").appendTo(s),IG$._berr&&1<IG$._berr.err.length&&$("<div class='ing-error-cnt'>("+(this._cerr+1)+"/"+IG$._berr.err.length+" messages)</div>").appendTo(r),r.append("<div class='ing-error-desc'>"+(e.errcode||"")+":"+e.errdesc+"</div>"),r.append("<div class='ing-error-msg'>"+(e.errmsg||"")+"</div>"),$("<div class='ing-error-stack'></div>").appendTo(r).text(e.errstack||""),$("<div class='ing-error-stack'></div>").appendTo(r).text(t||""),$("<div class='ing-error-stack'></div>").appendTo(r).text(e.binfo||""),this.cboard=$("<textarea class='ing-error-cboard'></textarea>").appendTo(r).hide()},initComponent:function(){var s=this;$s.apply(this,{title:"Server Message",items:[{xtype:"container",name:"m_msg",border:0,layout:"fit",listeners:{afterrender:function(e){var n=s.messagecontent;s.showError(n)}}}],buttons:[{text:IRm$.r1("B_CLIPBOARD"),handler:function(){s.cboard.show();function t(e){var n,t="",r="",t=(e.errdesc||"no description")+"\n";if(e.params){for(n in e.params)r&&(r+="\n"),r+=n+": "+e.params[n];r+="\n\n"}else r="stacktrace : "+(e.errstack||"")+"\n";return t+=r}var r=[];IG$._berr&&IG$._berr.err.length?$.each(IG$._berr.err,function(e,n){r.push(t(n.messagecontent))}):r.push(t(s.messagecontent));var e="",n=window.bowser;if(n){for(bk in n)"function"!=typeof n[bk]&&(e+=bk+": "+n[bk]+"\n");r.push(e)}s.cboard.text(r.join("\n\n")),s.cboard.select();try{var i=document.execCommand("copy")?"successful":"unsuccessful";console.log("Copying text command was "+i)}catch(e){console.log("Oops, unable to copy")}},scope:this},"-",{text:IRm$.r1("B_PREVIOUS"),hidden:!(IG$._berr&&1<IG$._berr.err.length),handler:function(){var e=IG$._berr.err,n=(e.length,-1<this._cerr-1?e[this._cerr--]:null);n&&this.showError(n.messagecontent)},scope:this},{text:IRm$.r1("B_NEXT"),hidden:!(IG$._berr&&1<IG$._berr.err.length),handler:function(){var e=IG$._berr.err,n=e.length,t=this._cerr+1<n?e[this._cerr++]:null;t&&this.showError(t.messagecontent)},scope:this},"-",{text:IRm$.r1("B_CLOSE"),handler:function(){this.close()},scope:this}]}),IG$.ErrorDialog.superclass.initComponent.apply(this,arguments)}})),IG$._scrshot=function(e,n,t,r){var i,s,a,o,c,l=$("body"),d=l.width(),p=l.height(),u=IG$.__scrs=IG$.__scrs||{};u._close_timer&&clearTimeout(u._close_timer),u._close_timer=-1,t?(u.container||(u.container=$("<div class='igc-screenshot-cont'><div class='igc-screenshot-img'></div></div>").appendTo($("body")),u.img=$(".igc-screenshot-img",u.container),u.container.bind("click",function(){clearTimeout(u._close_timer),u._close_timer=-1,u.container.hide()}),u._w=u.container.width(),u._h=u.container.height(),$("body").bind("click",function(){u.container.hide()})),u.container.show(),s=n.indexOf(":"),n.substring(0,s),i=n.substring(s+1),u.__curuid!=i&&(a=$(e).offset(),u._curuid=i,u.img.css({backgroundImage:"url('"+ig$.servlet+"?sreq=screenshot&uid="+i+"&uniquekey="+IG$.getUniqueKey()+"')"}),(c=a.top)+u._h>p&&(c=a.top-u._h),(o=a.left+$(e).width())+u._w>d&&(o=a.left-u._w),u.container[0].style.top=c+"px",u.container[0].style.left=o+"px"),u._close_timer=setTimeout(function(){u.container&&u.container.hide()},2e3)):r?u.container&&u.container.hide():u._close_timer=setTimeout(function(){u.container&&u.container.hide()},2e3)},IG$.m2ER=function(){},IG$._mask=function(e){var n,t,r=this;r.owner=e.target,r.mask=$("<div class='igc-loading'></div>"),$("<div class='igc-loading-mask'></div>").appendTo(r.mask),n=$("<table class='igc-loading-body'><tr><td></td></tr></table>").appendTo(r.mask),t=$("<div class='igc-loading-box'><table><tr><td><div class='igc-loading-proc'><div class='spinner'><div class='rect1'></div><div class='rect2'></div><div class='rect3'></div><div class='rect4'></div><div class='rect5'></div></div></div></td><td><span class='igc-loading-msg'></span></td></tr></table></div>").appendTo($("td",n)),$(".igc-loading-msg",t).append(e.msg||ig$.loading_msg),r.owner.rendermask=r.mask,e.dom?e.dom.append(r.mask):r.owner._el.dom.append(r.mask)},IG$._mask.prototype={show:function(){this.mask.show()},destroy:function(){this.mask&&(this.mask.remove(),this.mask=null)}};

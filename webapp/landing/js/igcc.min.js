!function(e,i){"undefined"!=typeof module&&module.exports?module.exports=i():"function"==typeof define&&define.amd?define(i):this.bowser=i()}(0,function(){var f=!0;function e(o){function e(e){var i=o.match(e);return i&&1<i.length&&i[1]||""}var i,s,r,n=e(/(ipod|iphone|ipad)/i).toLowerCase(),a=!/like android/i.test(o)&&/android/i.test(o),t=/CrOS/.test(o),d=e(/edge\/(\d+(\.\d+)?)/i),m=e(/version\/(\d+(\.\d+)?)/i),v=/tablet/i.test(o),b=!v&&/[^-]mobi/i.test(o);/opera|opr/i.test(o)?i={name:"Opera",opera:f,version:m||e(/(?:opera|opr)[\s\/](\d+(\.\d+)?)/i)}:/yabrowser/i.test(o)?i={name:"Yandex Browser",yandexbrowser:f,version:m||e(/(?:yabrowser)[\s\/](\d+(\.\d+)?)/i)}:/windows phone/i.test(o)?(i={name:"Windows Phone",windowsphone:f},d?(i.msedge=f,i.version=d):(i.msie=f,i.version=e(/iemobile\/(\d+(\.\d+)?)/i))):/msie|trident/i.test(o)?i={name:"Internet Explorer",msie:f,version:e(/(?:msie |rv:)(\d+(\.\d+)?)/i)}:t?i={name:"Chrome",chromeBook:f,chrome:f,version:e(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)}:/chrome.+? edge/i.test(o)?i={name:"Microsoft Edge",msedge:f,version:d}:/chrome|crios|crmo/i.test(o)?i={name:"Chrome",chrome:f,version:e(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)}:n?(i={name:"iphone"==n?"iPhone":"ipad"==n?"iPad":"iPod"},m&&(i.version=m)):/sailfish/i.test(o)?i={name:"Sailfish",sailfish:f,version:e(/sailfish\s?browser\/(\d+(\.\d+)?)/i)}:/seamonkey\//i.test(o)?i={name:"SeaMonkey",seamonkey:f,version:e(/seamonkey\/(\d+(\.\d+)?)/i)}:/firefox|iceweasel/i.test(o)?(i={name:"Firefox",firefox:f,mozilla:f,version:e(/(?:firefox|iceweasel)[ \/](\d+(\.\d+)?)/i)},/\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(o)&&(i.firefoxos=f)):/silk/i.test(o)?i={name:"Amazon Silk",silk:f,version:e(/silk\/(\d+(\.\d+)?)/i)}:a?i={name:"Android",version:m}:/phantom/i.test(o)?i={name:"PhantomJS",phantom:f,version:e(/phantomjs\/(\d+(\.\d+)?)/i)}:/blackberry|\bbb\d+/i.test(o)||/rim\stablet/i.test(o)?i={name:"BlackBerry",blackberry:f,version:m||e(/blackberry[\d]+\/(\d+(\.\d+)?)/i)}:/(web|hpw)os/i.test(o)?(i={name:"WebOS",webos:f,version:m||e(/w(?:eb)?osbrowser\/(\d+(\.\d+)?)/i)},/touchpad\//i.test(o)&&(i.touchpad=f)):i=/bada/i.test(o)?{name:"Bada",bada:f,version:e(/dolfin\/(\d+(\.\d+)?)/i)}:/tizen/i.test(o)?{name:"Tizen",tizen:f,version:e(/(?:tizen\s?)?browser\/(\d+(\.\d+)?)/i)||m}:/safari/i.test(o)?{name:"Safari",safari:f,version:m}:{name:e(/^(.*)\/(.*) /),version:(s=/^(.*)\/(.*) /,r=o.match(s),r&&1<r.length&&r[2]||"")},!i.msedge&&/(apple)?webkit/i.test(o)?(i.name=i.name||"Webkit",i.webkit=f,!i.version&&m&&(i.version=m)):!i.opera&&/gecko\//i.test(o)&&(i.name=i.name||"Gecko",i.gecko=f,i.version=i.version||e(/gecko\/(\d+(\.\d+)?)/i)),i.msedge||!a&&!i.silk?n&&(i[n]=f,i.ios=f):i.android=f;var l="";i.windowsphone?l=e(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i):n?l=(l=e(/os (\d+([_\s]\d+)*) like mac os x/i)).replace(/[_\s]/g,"."):a?l=e(/android[ \/-](\d+(\.\d+)*)/i):i.webos?l=e(/(?:web|hpw)os\/(\d+(\.\d+)*)/i):i.blackberry?l=e(/rim\stablet\sos\s(\d+(\.\d+)*)/i):i.bada?l=e(/bada\/(\d+(\.\d+)*)/i):i.tizen&&(l=e(/tizen[\/\s](\d+(\.\d+)*)/i)),l&&(i.osversion=l);var c=l.split(".")[0];return v||"ipad"==n||a&&(3==c||4==c&&!b)||i.silk?i.tablet=f:(b||"iphone"==n||"ipod"==n||a||i.blackberry||i.webos||i.bada)&&(i.mobile=f),i.msedge||i.msie&&10<=i.version||i.yandexbrowser&&15<=i.version||i.chrome&&20<=i.version||i.firefox&&20<=i.version||i.safari&&6<=i.version||i.opera&&10<=i.version||i.ios&&i.osversion&&6<=i.osversion.split(".")[0]||i.blackberry&&10.1<=i.version?i.a=f:i.msie&&i.version<10||i.chrome&&i.version<20||i.firefox&&i.version<20||i.safari&&i.version<6||i.opera&&i.version<10||i.ios&&i.osversion&&i.osversion.split(".")[0]<6?i.c=f:i.x=f,i}var s=e("undefined"!=typeof navigator?navigator.userAgent:"");return s.test=function(e){for(var i=0;i<e.length;++i){var o=e[i];if("string"==typeof o&&o in s)return!0}return!1},s._detect=e,s});
...
var IRm$={locale:[],r1:function(a,e){var c;if(!IRm$.currentLocale)for(IRm$.currentLocale=IRm$.locale[0],c=0;c<IRm$.locale.length;c++)if(IRm$.locale[c].name==window.useLocale){IRm$.currentLocale=IRm$.locale[c];break}var n=a;if((n=IRm$.currentLocale&&IRm$.currentLocale.data[a]?1==ig$.vmode?a+"*":IRm$.currentLocale.data[a]:(1==ig$.vmode?"x ":"")+a)&&e)if("string"==typeof e&&(e=[e]),1==e.length)n=n.replace("@",e[0]);else for(c=0;c<e.length;c++)n=n.replace("@"+(c+1),e[c]);return n},r2_d:function(a){a&&a.func&&a.func.call(a.scope)},r2:function(l){var a=new IG$._rpc$,e=window.useLocale;a.init(null,{ack:"content",payload:{uid:"/SYS_Config/locale/"+e},mbody:{},mts:"ROOT"},null,function(a){var e,c,n=a;if(n&&n.data){for(c={name:n.name,data:{}},e=0;e<n.data.length;e++)c.data[n.data[e].name]=n.data[e].value;IRm$.locale.push(c)}l&&l.func&&l.func.call(l.scope)},function(){l&&l.func&&l.func.call(l.scope)}),a.send()}};
IG$.chkSess=function(n,s){$.ajax({url:ig$.servlet,data:JSON.stringify({ack:"loginstatus",payload:{},mbody:{lang:useLocale,app:loadingApp},uniquekey:IG$.getUniqueKey()}),type:"POST",contentType:"application/json; charset=UTF-8",dataType:"json",timeout:3e4,async:!0,beforeSend:function(e,i){},cache:!1,crossDomain:!1,processData:!0,error:function(){alert("Error while connecting server"),s&&s.call()},success:function(e){var i=e.result;if(e.errorcode)s&&s.call();else{i.token,i.uid;var o=i.redirect;n?n.call():o&&0<o.length&&window.location.replace(o)}}})},IG$.doStartSession=function(t,r,l,c,d){l&&l.show();var p=$("#il_err");p.hide(),$.ajax({url:ig$.servlet,type:"POST",data:JSON.stringify({ack:"security",payload:{mts:c},mbody:{},uniquekey:IG$.getUniqueKey()}),dataType:"json",timeout:3e4,async:!0,contentType:"application/json; charset=UTF-8",beforeSend:function(e,i){},cache:!1,crossDomain:!1,processData:!0,timeout:3e5,error:function(){l.hide(),alert("Error while connecting server")},success:function(e){var i,o,n=e.errorcode?null:e.result;if(n)i=n.p1,o=n.p2,i&&o?(IG$.rsaPublicKeyModules=i,IG$.rsaPublicKeyExpoenent=o,IG$._g$a=n.mts,setTimeout(function(){IG$.pLoginRSA(t,r,l,c,d)},10)):(alert("Error while get security key"),l&&l.hide());else{var s=e.errorcode,a=e.errormsg;s&&(l&&l.hide(),"0x6d00"==s?(p.unbind("click"),p.bind("click",function(){p.hide()}),p.show(),$(".igc-errorinfo-msg",p).html(a)):IG$.ShowErrorMessage(e,null))}}})},IG$.pLoginRSA=function(e,i,a,o,t){var n=IG$.encryptKey([e,i]),r=$("#il_err");r.hide(),$.ajax({url:ig$.servlet,data:JSON.stringify({ack:"login",payload:{userid:n[0],passwd:n[1]},mbody:{lang:useLocale,app:loadingApp,session_expire:""+(ig$.session_expire||0),mts:o||""},uniquekey:IG$.getUniqueKey()}),type:"POST",dataType:"json",timeout:3e4,async:!0,contentType:"application/json; charset=UTF-8",beforeSend:function(e,i){},cache:!1,crossDomain:!1,processData:!0,timeout:3e5,error:function(){a&&a.hide(),alert("Error while connecting server")},success:function(e){var i,o=e.result,n=e.errorcode;if(a&&a.hide(),o)o.token,o.uid,(i=o.redirect)&&0<i.length?window.location.replace(i):alert("System Error:: Application is not defined on config.xml");else if(n){var s=e.errormsg;"0x6d00"==n?(r.unbind("click"),r.bind("click",function(){r.hide()}),r.show(),$(".igc-errorinfo-msg",r).html(s),t&&t.execute()):t?t.execute():IG$.ShowErrorMessage(e,null)}}})},IG$.chkSvrInfo=function(i){ig$.appInfo?i&&i.call():$.ajax({url:ig$.servlet,data:{sreq:"version",uniquekey:IG$.getUniqueKey()},dataType:"json",type:"GET",timeout:3e4,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",beforeSend:function(e,i){},cache:!1,crossDomain:!1,processData:!0,error:function(){ig$.appInfo={appversion:"_._",apprelease:"_._.___"},i&&i.call()},success:function(e){ig$.appInfo={appversion:e.version||"0.0",apprelease:e.release||"0.0.000"},i&&i.call()}})},IG$.createLoginPanel=function(e,i,o){var n,s,a=$("<div id='loginWindow' class='loginWindow'></div>"),t=ig$.lang;if(window.bowser.msie&&(a.css({width:"100%",height:"100%"}),ig$.appbg)){var r=$("<img src='./images/"+ig$.appbg+"' class='background'/>");r.css({width:"100%",height:"100%",position:"absolute",top:0,left:0}),a.append(r)}if(t)for(n=0;n<t.length;n++)if(t[n].code==useLocale){s=t[n];break}var l="<div class='login-mc bounceInDown animated'><div class='login-ic'><img class='login-logo' src='./images/logo_7186.png'><div id='user_lbl'>"+(s&&s.l1?s.l1:"User ID")+"</div><div id='pass_lbl'>"+(s&&s.l2?s.l2:"Password")+"</div><form name='login_form' id='login_form' rel='nofollow' target='temp' action=''>    <input id='userid' type='text' name='userid' value='"+(e||"")+"'>    <input id='userpassword' type='password' name='userpassword' value='"+(i||"")+"'>    <input id='login_btn' type='button' value='"+(s&&s.l3?s.l3:"Login")+"'></form><div id='login_locale'><div class='locale_button'><span>Language</span><select id='b_loc'>";if(t)for(n=0;n<t.length;n++)l+="<option value='"+t[n].code+"'"+(useLocale==t[n].code?" selected":"")+">"+t[n].disp+"</option>";l+="</select></div></div><div id='license'>Licensed to: MPLIX</div>",l+="</div>",l+="</div>",$(l).appendTo(a).addClass("loginForm");$("<div class='legal'><table width='494' border='0' cellpadding='0' cellspacing='0'>  <tr>    <td width='78'>&nbsp;</td>    <td width='416' valign='top'><div align='left'>      <p class='style2'>"+ig$.copy+"</p>      <p class='style1'><span class='style4'>For support please contact</span>      <a href='"+ig$.companydomain+"' target='_new'>"+ig$.companydomain+"</a></p>    </div></td>  </tr></table></div>").appendTo(a);var c=$("<div class='build'><div align='right'><span class='style6'>Build Id: <span id='app_release'"+(ig$.appInfo&&ig$.appInfo.apprelease)+"</span></span></div></div>").appendTo(a),d=($("<div id='il_err' class='igc-errorinfo'><div class='igc-errorinfo-msg'></div></div>").appendTo(a),$("<div id='login-progress' class='login-progress'></div>").css({position:"absolute",width:"100%",height:"100%",top:0,left:0,right:0,bottom:0}).hide().appendTo(a));return window.IG$.cLogin&&window.IG$.cLogin(a),$(document.body).append(a),IG$.chkSvrInfo(function(){$("#app_release",c).text(ig$.appInfo.apprelease)}),setTimeout(function(){e?$("#userpassword").focus():$("#userid").focus()},200),$("#userpassword").bind("focus",function(){$("#userpassword").select()}),$("#userid").bind("focus",function(){$("#userid").select()}),$("#userpassword").bind("mouseup",function(){setTimeout(function(){$("#userpassword").select()},80)}),$("#userid").bind("mouseup",function(){setTimeout(function(){$("#userid").select()},80)}),!1!==o&&($("#b_loc").bind("change",function(e){var i,o,n,s=$("#b_loc"),a=$("option:selected",s).val(),t=$(location).attr("href"),r={},l=!1;if(a&&a!=window.useLocale){if($.removeCookie("lang"),$.cookie("lang",a,{path:"/"}),-1<t.indexOf("?")){for(i=t.substring(0,t.indexOf("?")),r=(o=t.substring(t.indexOf("?")+1)).split("&"),n=0;n<r.length;n++)if("lang="==r[n].substring(0,5)){r[n]=r[n].substring(0,5)+a,l=!0;break}o=r.join("&"),t=i+"?"+o}1==l&&(d.show(),setTimeout(function(){window.location.replace(t)},100))}}),$("#login_btn").bind("click",function(e){e.preventDefault(),e.stopPropagation();var i=$("#userid").val(),o=$("#userpassword").val();return $("#userpassword").val(""),IG$.dlgLogin.getKeyPair.call(IG$.dlgLogin,i,o,d,window.m$mts),!1}),$("#userpassword").bind("keypress",function(e){if(13!=e.keyCode)return!0;var i=$("#userid").val(),o=$("#userpassword").val();return $("#userpassword").val(""),IG$.dlgLogin.getKeyPair.call(IG$.dlgLogin,i,o,d,window.m$mts),!1})),a},IG$.showLogin=function(e,i){$("#idv-mnu-pnl").hide(),IG$.dlgLogin&&(IG$.dlgLogin.callback=new IG$.callBackObj(this,function(){IG$.dlgLogin.tl=-1,IG$.showLoginProc()})),window.hist&&window.hist.addHistory(""),IG$._popupDlgs&&($.each(IG$._popupDlgs,function(e,i){try{i&&i.close&&i.close()}catch(e){}}),IG$._popupDlgs=[]);var o=$("#loginWindow"),n=window.bowser;o.css({zIndex:99}),n.msie&&o.css({position:"absolute",top:0,left:0,right:0,bottom:0,width:"100%",height:"100%",margin:0,padding:0}),o.show()},IG$.showLogout=function(o){-1<IG$.msgint&&(clearInterval(IG$.msgint),IG$.msgint=-1),IG$.confirmMessages(IRm$.r1("B_CONFIRM"),IRm$.r1("L_T_LOUT"),function(e){if("yes"==e){var i=new IG$._rpc$;i.init(null,{ack:"logout",payload:{},mbody:{}},null,function(e){},function(){return!0}),i.send(),IG$.showLogin(o,1)}})};
IG$.sessionUtils=function(e){},IG$.sessionUtils.prototype={doStartSession:function(){var e=IG$.dlgLogin,i=$("#loginform"),t=i.items.items[0].getValue(),n=i.items.items[1].getValue();e.initProcLogin.call(e,t,n)},getKeyPairFunc:function(s,e,a){s&&s.show(),$.ajax({url:ig$.servlet,data:JSON.stringify({ack:"security",payload:{mts:e||""},mbody:{},uniquekey:IG$.getUniqueKey()}),type:"POST",dataType:"json",timeout:3e4,async:!0,contentType:"application/json; charset=UTF-8",beforeSend:function(e,i){},cache:!1,crossDomain:!1,processData:!0,timeout:3e5,error:function(){a&&a.execute(),alert("Error while connecting server")},success:function(e){var i=e.errorcode,t=e.result;if(i){s&&s.hide();var n=e.errormsg;a&&a.execute(),alert(n)}else t&&(p1=t.p1,p2=t.p2,p1&&p2?(IG$.rsaPublicKeyModules=p1,IG$.rsaPublicKeyExpoenent=p2,IG$._g$a=t.mts,a&&a.execute(1)):s&&(a&&a.execute(),s.hide(),alert("Error while get secure key value. Please try again later!")))}})},getKeyPair:function(i,t,n,s,a,o){var l=this;l.getKeyPairFunc(n,s,new IG$.callBackObj(l,function(e){e&&setTimeout(function(){l.initProcLogin.call(l,i,t,n,s,a,o)},10)}))},initProcLogin:function(e,i,t,n,s,a){var o=this,l=new IG$._rpc$,r=IG$.encryptKey([e,i]);l.init(o,{ack:"login",payload:{userid:r[0],passwd:r[1],sso_module:a},mbody:{lang:useLocale,mts:n||"",app:"",session_expire:""+ig$.session_expire||"0"}},o,o.rdoStartSession,function(e){s&&s.execute(e),t&&t.hide()},t),l.send()},rdoStartSession:function(e,i){var t=this,n=e,s=n.token,a=n.uid,o=!1,l=n;IG$._g$a||(IG$._g$a=e.mts),window.IG$.dlgLogin&&(IG$.dlgLogin.lastLogin=l,IG$.mainPanel&&IG$.mainPanel.updateLoginInfo&&IG$.mainPanel.updateLoginInfo.call(IG$.mainPanel)),i&&i.hide(),t.uuid&&0<t.uuid.length&&a&&t.uuid!=a&&(o=!0),t.uuid=a,""!=s&&""!=t.uuid&&t.closeLoginProc.call(t,o)},closeLoginProc:function(e){this.getUserDetail(e)},finalLoginProc:function(){var e=this,i=e.logininfo.l3.substring(1),t=$("#mechanlevel");t&&t[0]&&setTimeout(function(){switch(i){case"1":t.attr("title","Your license is limited using all features."),t.animate({width:45},2e3),t.bind("click",function(){window.open("http://www.amplixbi.com/","_new")});break;case"2":t.attr("title","Your license is limited using all features."),t.animate({width:60},2e3),t.css({backgroundColor:"#0000ff"}),t.bind("click",function(){window.open("http://www.amplixbi.com/","_new")});break;case"3":case"4":t.attr("title","Currently using full feature and unlimited version."),t.animate({width:100},2e3),t.css({backgroundColor:"#00ff00"})}},200),e.callback&&setTimeout(function(){e.callback.execute()},100)},getUserDetail:function(e){var i=this,t=new IG$._rpc$;t.init(i,{ack:"usercontent",payload:{address:"/user"},mbody:{option:"_gi_",uid:i.uuid,tmpl:IG$.__ep?"sys_print_mode":IG$.__ep_||""}},i,i.rs_getUserDetail,null,[e]),t.send()},rs_getUserDetail:function(e,i){var t=this,n=i[0],s=new IG$._c$session(e.userdetail);t.logininfo=s,t.jS2=t.logininfo.hasDuty("admins","A"),t.desktopsetting=e.desktopinfo,ig$.features=s.features,$.cookie("lui",s.userid,{expires:7,path:"/"}),IG$.$loadApp(s.tmpl,s.fm),1==n&&(IG$.showHideAllWindow(!0),$("#win-mask").css({display:"none"}),IG$.mainPanel&&IG$.mainPanel.initRecentVisit.call(IG$.mainPanel)),IG$.mainPanel&&IG$.mainPanel.updateLoginInfo.call(IG$.mainPanel),t.finalLoginProc.call(t)}},IG$._c$session=function(e){var t,i,n,s,a,o=this,l=[];if(n=e,o.sid=n.sid,o.gid=n.gid,o.userid=n.id,o.username=n.name,o.l3=n.l3,o.l4="Y"==n.l4,o.auth=[],o.authmap={},o.features={},o.pdffonts=[],o.mts=n.mts,o.mts_name=n.mts_name,o.tmpl={},o.dfrm=n.dfrm,IG$.calendar_locale.c1disp=n.c1disp,IG$.calendar_locale.c1format=n.c1format,IG$.calendar_locale.c2disp=n.c2disp,IG$.calendar_locale.c2format=n.c2format,o.dfrm&&0<o.dfrm.indexOf(" ")?o.dfrm_short=o.dfrm.substring(0,o.dfrm.indexOf(" ")):o.dfrm_short="yyyy-mm-dd",n.a2&&!ig$.theme_id&&(ig$.theme_id=n.a2),(s=n.template)&&s.view)for(child=s.view,o.tmpl.mainview={},i=0;i<child.length;i++)(a=child[i]).html&&(a.html=IG$.replaceAll(a.html,"$APP_NAME",ig$.appname),a.html=IG$.replaceAll(a.html,"$APP_COPY",ig$.copy)),o.tmpl.mainview[a.name]=a;for(n.duties=n.duties||[],o.auth=n.duties,i=0;i<n.duties.length;i++)o.authmap[n.duties[i].name.toLowerCase()]=n;if(t=!!o.authmap.admins,n.features)for(i in n.features)o.features[i]=!0===n.features[i].hide;if(n.fonts)for(i=0;i<n.fonts.length;i++)o.pdffonts.push(n.fonts[i]+";");if(ig$.fmcss&&ig$.fmcss.remove(),l.push("<style type='text/css'>"),$.each(o.features,function(e,i){"ig_mngr"==e||"ig_ft"==e?t||l.push("."+e+" { display: none; }"):1==i&&l.push("."+e+" { display: none; }")}),l.push("</style>"),ig$.fmcss=$(l.join("")).appendTo($("head")),o.themes=[],n.themes){for(i=0;i<n.themes.length;i++)o.themes.push({name:n.themes[i]});if(window.app_themes)try{window.app_themes(o.themes)}catch(e){}}},IG$._c$session.prototype={hasDuty:function(e,i){var t;for(t=0;t<this.auth.length;t++)if((!i||i&&this.auth[t].dutytype==i)&&this.auth[t].name.toLowerCase()==e)return!0;return!1}},IG$.dlgLogin=new IG$.sessionUtils;
...
function doRegister(){var s=$("div.login-progress").show(),a=$("#il_err").hide();(new IG$.sessionUtils).getKeyPairFunc(s,null,new IG$.callBackObj(this,function(){var e=$("[name=username]").val(),t=$("[name=password]").val(),i=$("#div_form"),o=$("#div_success"),r=IG$.encryptKey([e,t]),n=$(".igc-errorinfo-msg",a);setTimeout(function(){var e=new IG$._rpc$;e.servlet$="../servlet/amprpc",e.init(this,{ack:"register",payload:{},mbody:{username:""+r[0],password:""+r[1],email:$("[name=useremail]").val(),policy_check:""+$("#policy_check").val(),product:cloud_prod}},this,function(e){s.hide(),i.hide(),o.show();var t=e.skey;secure_key=t,setTimeout(function(){document.location.href="./validate.jsp?vkey="+t},5e3)},function(e){if(e){var t=e.errormsg;n.html(t),a.fadeIn()}return s.fadeOut(),!1}),e.send()},100)}))}function init_register(){var t=$("#form_register"),e=($("div.login-progress").hide(),document.getElementById("password")),i=document.getElementById("confirm_password");function o(){return e.value.length<6?(e.setCustomValidity("Woops, password should be more then 6 character"+e.value.length),!1):(e.setCustomValidity(""),e.value!=i.value?(i.setCustomValidity("Whoops, these don't match"),!1):(i.setCustomValidity(""),!0))}e.onkeyup=o,i.onkeyup=o,t.on("submit",function(e){e.preventDefault(),e.stopImmediatePropagation(),!1!==t[0].checkValidity()&&o()&&doRegister()}),$("#btn_validate").bind("click",function(e){e.preventDefault(),e.stopImmediatePropagation(),secure_key&&(document.location.href="./validate.jsp?vkey="+secure_key)})}function init_login(){var o=$("div.login-progress").hide(),r=$("#form_login");r.submit(function(e){e.preventDefault();var t=$("#userid"),i=$("#userpassword");!1!==r[0].checkValidity()&&IG$.doStartSession(t.val(),i.val(),o,mts)})}function doValidateSecureCode(){var o=$("#email"),r=$("#vcode");bg.show(),setTimeout(function(){var e=new IG$._rpc$,t=$("#div_form"),i=$("#div_success");e.servlet$="../servlet/amprpc",e.init(this,{ack:"validate_regcode",payload:{},mbody:{email:o.val(),vcode:r.val()}},this,function(e){bg.hide(),t.hide(),i.show()},function(e){if(e){var t=e.errormsg;msgdiv.html(t),il_err.fadeIn()}return bg.fadeOut(),!1}),e.send()},100)}function init_validate(){var t=$("#form_login");window.bg=$("div.login-progress").hide(),t.submit(function(e){e.preventDefault(),!1!==t[0].checkValidity()&&doValidateSecureCode()})}function doResetPassword(){var i=$("div.login-progress").show(),e=$("#div_chkpwd"),o=$("#il_err",e).hide(),r=$(".igc-errorinfo-msg",o),n=(e=$("#div_chkpwd"),$("#div_reset"),$("#useremail").val());setTimeout(function(){var e=new IG$._rpc$;e.servlet$="../servlet/amprpc",e.init(this,{ack:"resetpassword",payload:{},mbody:{email:n}},this,function(e){i.hide();var t=$("#form_chkpwd_vkey");$("#vkey",t).val(e.vkey),$("#vkey_email",t).val(n),t[0].submit()},function(e){if(e){var t=e.errormsg;r.html(t),o.fadeIn()}return i.fadeOut(),!1}),e.send()},100)}function doValidateResetCode(){var i=$("div.login-progress").show(),e=$("#div_reset"),o=$("#il_err",e).hide(),r=$(".igc-errorinfo-msg",o);setTimeout(function(){var e=new IG$._rpc$;e.servlet$="../servlet/amprpc",e.init(this,{ack:"val_pwd_code",payload:{},mbody:{vkey:$("#vkey").val(),secure_code:$("#secure_code").val()}},this,function(e){e.vcode?document.location.href="./chpw.jsp":(r.html("Unknown error on return data"),o.fadeIn(),i.fadeOut())},function(e){if(e){var t=e.errormsg;r.html(t),o.fadeIn(),"0x0602"!=e.errorcode&&"0x0601"!=e.errorcode||setTimeout(function(){document.location.href="./forgot_password.jsp"},3e3)}return i.fadeOut(),!1}),e.send()},100)}function init_forgot_password(){$("div.login-progress").hide();var t=$("#form_chkpwd"),i=$("#form_reset"),e=$("#btn_resend_code");t.submit(function(e){e.preventDefault();$("#useremail");!1!==t[0].checkValidity()&&doResetPassword()}),i.submit(function(e){e.preventDefault(),!1!==i[0].checkValidity()&&doValidateResetCode()}),e.bind("click",function(e){e.preventDefault(),document.location.href="./forgot_password.jsp"})}function changePassword(){var n=$("div.login-progress").show(),e=$("#div_form"),s=$("#il_err",e).hide();$(".igc-errorinfo-msg",s);(new IG$.sessionUtils).getKeyPairFunc(n,null,new IG$.callBackObj(this,function(){var e=$("[name=password]").val(),t=$("#div_form"),i=$("#div_success"),o=IG$.encryptKey([e]),r=$(".igc-errorinfo-msg",s);setTimeout(function(){var e=new IG$._rpc$;e.servlet$="../servlet/amprpc",e.init(this,{ack:"change_password",payload:{},mbody:{password:""+o[0]}},this,function(e){n.hide(),t.hide(),i.show(),setTimeout(function(){document.location.href="./login.jsp"},5e3)},function(e){if(e){var t=e.errormsg;r.html(t),s.fadeIn()}return n.fadeOut(),!1}),e.send()},100)}))}function init_chpw(){$("div.login-progress").hide();var t=$("#form_chkpwd"),e=document.getElementById("password"),i=document.getElementById("confirm_password");function o(){return e.value.length<6?(e.setCustomValidity("Woops, password should be more then 6 character"+e.value.length),!1):(e.setCustomValidity(""),e.value!=i.value?(i.setCustomValidity("Whoops, these don't match"),!1):(i.setCustomValidity(""),!0))}e.onkeyup=o,i.onkeyup=o,t.submit(function(e){e.preventDefault();$("#useremail");return!1===t[0].checkValidity()||(!o()||(changePassword(),!1))})}